 ...
 *         &lt;element name="bicatalogObjectType" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
public class GetCatalog {
    ...
    protected List<String> bicatalogObjectType;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the bicatalogObjectType property.
     * <p/>
     * <p/>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bicatalogObjectType property.
     * <p/>
     * <p/>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBicatalogObjectType().add(newItem);
     * </pre>
     * <p/>
     * <p/>
     * <p/>
     ...
     * {@link String }
     */
    public List<String> getBicatalogObjectType() {
        if (bicatalogObjectType == null) {
            bicatalogObjectType = new ArrayList<String>();
        }
        return this.bicatalogObjectType;
    }
