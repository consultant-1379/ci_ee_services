 ...
 * generated in the com.ericsson.eniq.events.server.services.soap.network.kpi.lte.ran.EniqEventsLTERanKpi package. 
...
public class ObjectFactory {
    ...
    private final static QName _QaaWSHeaderSerializedSession_QNAME = new QName("EniqEventsLTENetworkRanKpi", "serializedSession");
    private final static QName _QaaWSHeaderSessionID_QNAME = new QName("EniqEventsLTENetworkRanKpi", "sessionID");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ericsson.eniq.events.server.services.soap.network.kpi.lte.ran.EniqEventsLTERanKpi
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "EniqEventsLTENetworkRanKpi", name = "serializedSession", scope = QaaWSHeader.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "EniqEventsLTENetworkRanKpi", name = "sessionID", scope = QaaWSHeader.class)
