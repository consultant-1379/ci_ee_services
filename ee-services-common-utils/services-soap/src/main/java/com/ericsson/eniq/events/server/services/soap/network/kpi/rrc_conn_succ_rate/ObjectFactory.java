 ...
 * generated in the com.ericsson.eniq.events.server.services.soap.network.kpi.rrc_conn_succ_rate package. 
...
public class ObjectFactory {
    ...
    private final static QName _QaaWSHeaderSerializedSession_QNAME = new QName("ENIQ_Events_Rrc_Conn_Succ_Rate", "serializedSession");
    private final static QName _QaaWSHeaderSessionID_QNAME = new QName("ENIQ_Events_Rrc_Conn_Succ_Rate", "sessionID");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ericsson.eniq.events.server.services.soap.network.kpi.rrc_conn_succ_rate
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "ENIQ_Events_Rrc_Conn_Succ_Rate", name = "serializedSession", scope = QaaWSHeader.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "ENIQ_Events_Rrc_Conn_Succ_Rate", name = "sessionID", scope = QaaWSHeader.class)
