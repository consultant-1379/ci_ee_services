...
public class QaaWSHeader {
    ...
    @XmlElementRef(name = "sessionID", namespace = "EniqEventsServicesNetworkRNCCellQuery", type = JAXBElement.class)
    protected JAXBElement<String> sessionID;
    @XmlElementRef(name = "serializedSession", namespace = "EniqEventsServicesNetworkRNCCellQuery", type = JAXBElement.class)
