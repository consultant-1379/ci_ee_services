...
public class QaaWSHeader {
    ...
    @XmlElementRef(name = "sessionID", namespace = "ENIQ_Events_Rrc_Conn_Succ_Rate", type = JAXBElement.class)
    protected JAXBElement<String> sessionID;
    @XmlElementRef(name = "serializedSession", namespace = "ENIQ_Events_Rrc_Conn_Succ_Rate", type = JAXBElement.class)
