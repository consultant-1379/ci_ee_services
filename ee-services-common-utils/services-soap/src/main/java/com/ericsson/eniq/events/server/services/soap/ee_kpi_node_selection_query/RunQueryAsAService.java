 ...
 *         &lt;element name="Enter_value_s__for__RNC_Name_" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="Enter_value_s__for__UCell_Name_" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
public class RunQueryAsAService {
    ...
    protected List<String> enterValueSForRNCName;
    @XmlElement(name = "Enter_value_s__for__UCell_Name_", nillable = true)
    protected List<String> enterValueSForUCellName;
     ...
     * {@link String }
     */
    public List<String> getEnterValueSForRNCName() {
        if (enterValueSForRNCName == null) {
            enterValueSForRNCName = new ArrayList<String>();
        }
     ...
     * {@link String }
     */
    public List<String> getEnterValueSForUCellName() {
        if (enterValueSForUCellName == null) {
            enterValueSForUCellName = new ArrayList<String>();
        }
