...
public class QaaWSHeader {
    ...
    @XmlElementRef(name = "sessionID", namespace = "EniqEventsLTENetworkRanKpi", type = JAXBElement.class)
    protected JAXBElement<String> sessionID;
    @XmlElementRef(name = "serializedSession", namespace = "EniqEventsLTENetworkRanKpi", type = JAXBElement.class)
