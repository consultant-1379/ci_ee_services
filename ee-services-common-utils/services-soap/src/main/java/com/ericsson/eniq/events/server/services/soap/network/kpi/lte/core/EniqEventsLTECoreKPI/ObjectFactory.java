 ...
 * generated in the com.ericsson.eniq.events.server.services.soap.network.kpi.lte.core.EniqEventsLTECoreKPI package. 
...
public class ObjectFactory {
    ...
    private final static QName _QaaWSHeaderSerializedSession_QNAME = new QName("EniqEventsLTENetworkCoreKPI", "serializedSession");
    private final static QName _QaaWSHeaderSessionID_QNAME = new QName("EniqEventsLTENetworkCoreKPI", "sessionID");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ericsson.eniq.events.server.services.soap.network.kpi.lte.core.EniqEventsLTECoreKPI
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "EniqEventsLTENetworkCoreKPI", name = "serializedSession", scope = QaaWSHeader.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "EniqEventsLTENetworkCoreKPI", name = "sessionID", scope = QaaWSHeader.class)
