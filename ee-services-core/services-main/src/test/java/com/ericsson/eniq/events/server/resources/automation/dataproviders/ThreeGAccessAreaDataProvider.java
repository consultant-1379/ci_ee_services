 ...
 *
 */
public class ThreeGAccessAreaDataProvider {

    public static Object[] provideTestData() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(TYPE_PARAM, TYPE_CELL).add(NODE_PARAM, SAMPLE_3G_ACCESS_AREA_NODE_PARAM)
    ...
    public static Object[] provideTestDataWithCauseCodes() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(TYPE_PARAM, TYPE_CELL).add(NODE_PARAM, SAMPLE_3G_ACCESS_AREA_NODE_PARAM)
                .add(TIME_QUERY_PARAM, FIVE_MINUTES).add(CAUSE_CODE_ID_LIST, "0", "0,1")
