...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.DC_Z_ALARM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.ERR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.INFO;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.IS_LTE_VIEW;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_PARAM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_DT;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_ERR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_SUC;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_SUM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_TOTAL;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_ALL_ERR_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_ALL_SUC_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_DTPDP_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_DT_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_ERR_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_LTE_ERR_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_LTE_SUC_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_LTE_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_NON_LTE_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAW_TIMERANGE_VIEW;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.SELECT_BOTH_LATEST_ERR_AND_SUC_TABLES;
import static com.ericsson.eniq.events.server.common.TechPackData.DC_Z_ALARM_INFO_RAW;
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_GSM_CFA;
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_GSM_CFA_ERR_RAW;
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_LTE;
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_LTE_ERR_RAW;
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_LTE_SUC_RAW;
...
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_SGEH_ERR_RAW;
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_SGEH_RAW;
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_SGEH_SUC_RAW;
import static com.ericsson.eniq.events.server.test.common.ApplicationTestConstants.EVENT_E_LTE_ERR_RAW_TIMERANGE;
import static com.ericsson.eniq.events.server.test.common.ApplicationTestConstants.EVENT_E_RAN_CFA_RAW;
import static com.ericsson.eniq.events.server.test.common.ApplicationTestConstants.EVENT_E_SGEH_ERR_RAW_TIMERANGE;
...
public class RawTableFetcherTest extends BaseJMockUnitTest {
    private static final String EVENT_E_GSN_DTPDP_RAW = "EVENT_E_GSN_DTPDP_RAW";

    private static final String EVENT_E_GSN_DT_RAW = "EVENT_E_GSN_DT_RAW";
    ...
    public void testFetchRawTablesForTechPackAndKey() throws ParseException {
        ...
        final List<String> result = objToTest.fetchRawTablesForTechPackAndKey(mockedFormattedDateTimeRange,
                EVENT_E_GSM_CFA, ERR);
        assertThat(result, is(listOfTables));
    }
    ...
    public void testFetchRawTablesForTechPackForDC_Z_ALARM_INFO() throws ParseException {
        ...
        final List<String> result = objToTest.fetchRawTablesForTechPackAndKey(mockedFormattedDateTimeRange, DC_Z_ALARM,
                INFO);
        assertThat(result, is(listOfTables));
    }
    ...
    public void testgetViewNamesForTemplateKey() {
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_DT, RAW_DTPDP_TABLES),
                is(new String[] { EVENT_E_GSN_DTPDP_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_DT, RAW_DT_TABLES),
                is(new String[] { EVENT_E_GSN_DT_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_ERR, RAW_NON_LTE_TABLES),
                is(new String[] { EVENT_E_SGEH_ERR_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_SUM, RAW_TABLES),
                is(new String[] { EVENT_E_SGEH_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_TOTAL, RAW_TABLES),
                is(new String[] { EVENT_E_SGEH_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_ERR, RAW_ALL_ERR_TABLES), is(new String[] {
                EVENT_E_SGEH_ERR_RAW, EVENT_E_LTE_ERR_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_SUC, RAW_ALL_SUC_TABLES), is(new String[] {
                EVENT_E_SGEH_SUC_RAW, EVENT_E_LTE_SUC_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_ERR, RAW_LTE_TABLES),
                is(new String[] { EVENT_E_LTE_ERR_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_ERR, RAW_ERR_TABLES),
                is(new String[] { EVENT_E_SGEH_ERR_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_SUC, RAW_ALL_SUC_TABLES), is(new String[] {
                EVENT_E_SGEH_SUC_RAW, EVENT_E_LTE_SUC_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_ERR, RAW_LTE_ERR_TABLES),
                is(new String[] { EVENT_E_LTE_ERR_RAW }));
        assertThat(objToTest.getViewNamesForTemplateKey(KEY_TYPE_SUC, RAW_LTE_SUC_TABLES),
                is(new String[] { EVENT_E_LTE_SUC_RAW }));
    }
    ...
    private void expectCallOnEngineGetTableNames(final String[] viewNames, final List<String> listOfTables)
            throws ParseException {
        mockery.checking(new Expectations() {
            {
                one(mockedRmiEngineUtils).getTableNames(
                        new Timestamp(DateTimeRange.getUTCDateTimeWithSeconds(startDateTime).getTime()),
    ...
    @Test
    public void testgetRAWTablesForRawAllTablesGoesToDatabaseForLatestTablesWhenRMIFailsAndFirstQueryOnDatabaseReturnsNothing()
            throws Exception {
    ...
    @Test
    public void testgetRAWTablesForRawLteTablesGoesToDatabaseForLatestTablesWhenRMIFailsAndFirstQueryOnDatabaseReturnsNothing()
            throws Exception {
        final List<String> emptyList = new ArrayList<String>();
