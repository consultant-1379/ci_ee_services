...
/**
 * Transformations for result set data for various JSON
 * response encodings and other export formats.
 *
 * @author edeccox
 * @author eavidat
 * @author ehaoswa
...
public final class ResultSetTransformerFactory {
     ...
     */
    public static ResultSetTransformer<String> getJSONGridDataTransformer(final String timestampFrom,
            final String timestampTo, final String timeColumn, final String tzOffset) {
    ...
    /**
     * Gets the json chart data transformer for charting the Groups Most Frequent Signalling Graph. It is specific
     * because the transformer needs to tell the JSONUtils to calculate the Y_AXIS_MAX and MIN differently - this is
     * the only graph that returns values that are not used by the UI to plot the graph (they are used for the
     * toggle to grid)
     *
     ...
     */
    public static ResultSetTransformer<String> getGroupsMostFreqSignalJSONChartDataTransformer(
            final String dateTimeFrom, final String dateTimeTo, final String timeColumn, final String tzOffset) {
        return new ResultSetTransformer<String>() {

            @Override
            public String transform(final ResultSet rs) throws SQLException {
                return JSONUtils.toGroupsMostFreqSignalJSONChartDataObject(rs, dateTimeFrom, dateTimeTo, timeColumn,
                        tzOffset);
            }

            @Override
            public String transform(final List<ResultSet> results) throws SQLException {
                return JSONUtils.toGroupsMostFreqSignalJSONChartDataObject(results, dateTimeFrom, dateTimeTo,
                        timeColumn, tzOffset);
            }
        };
    }
     ...
     * @param timestampFrom the timestamp from
     * @param timestampTo   the timestamp to
     * @param list          of time column indexes
     * @return the JSON grid data transformer
     */
    public static ResultSetTransformer<String> getJSONGridDataTransformer(final String timestampFrom,
            final String timestampTo, final List<Integer> timeColumns, final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
    ...
    public static ResultSetTransformer<String> getJSONGridDataTransformerForAppendingRows(final String timestampFrom,
            final String timestampTo, final List<Integer> timeColumns, final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
            ...
            @Override
            public String transform(final List<ResultSet> results) throws SQLException {
                return JSONUtils.toJSONGridDataObjectAppendRows(results, timestampFrom, timestampTo, timeColumns,
                        tzOffset);
            }
        };
    }
     ...
     * @return the JSON chart data transformer
     */
    public static ResultSetTransformer<String> getJSONChartDataTransformer(final String xaxis,
            final String secondYaxis, final String dateTimeFrom, final String dateTimeTo, final String timeColumn,
            final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
                return JSONUtils.toJSONChartDataObject(rs, xaxis, secondYaxis, dateTimeFrom, dateTimeTo, timeColumn,
                        tzOffset);
            }

            @Override
            public String transform(final List<ResultSet> results) throws SQLException {
                return JSONUtils.toJSONChartDataObject(results, xaxis, secondYaxis, dateTimeFrom, dateTimeTo,
                        timeColumn, tzOffset);
            }
        };
    }
     ...
     * @return the JSON chart data transformer
     */
    public static ResultSetTransformer<String> getJSONChartDataTransformerWithAppendedRows(final String xaxis,
            final String secondYaxis, final String dateTimeFrom, final String dateTimeTo, final String timeColumn,
            final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
                return JSONUtils.toJSONChartDataObjectWithAppendedRows(rs, xaxis, secondYaxis, dateTimeFrom,
                        dateTimeTo, timeColumn, tzOffset);
            }

            @Override
            public String transform(final List<ResultSet> results) throws SQLException {
                return JSONUtils.toJSONChartDataObjectWithAppendedRows(results, xaxis, secondYaxis, dateTimeFrom,
                        dateTimeTo, timeColumn, tzOffset);
            }
        };
    }
     ...
     * @param xaxis       the xaxis
     * @param secondYaxis the second yaxis
     * @param kpiTimeList the kpi time list
     * @return the JSONKPI chart data transformer
     */
    public static ResultSetTransformer<String> getJSONSamplingChartDataTransformer(final String xaxis,
            final String secondYaxis, final String[] chartTimeList, final String dateTimeFrom, final String dateTimeTo,
            final String timeColumn, final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
                return JSONUtils.toJSONSamplingChartDataObject(rs, xaxis, secondYaxis, chartTimeList, dateTimeFrom,
                        dateTimeTo, timeColumn, tzOffset);
            }

            @Override
            public String transform(final List<ResultSet> results) throws SQLException {
                return JSONUtils.toJSONSamplingChartDataObject(xaxis, secondYaxis, chartTimeList, dateTimeFrom,
                        dateTimeTo, timeColumn, tzOffset, results);
            }
        };
    }
     ...
     * @return the JSONKPI chart data transformer
     */
    public static ResultSetTransformer<String> getJSONSamplingChartDataTransformerWithCalculator(final String xaxis,
            final String secondYaxis, final String[] chartTimeList, final String timeColumn, final String tzOffset,
            final Calculator calc) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
                return JSONUtils.toJSONSamplingChartDataObjectWithCalculator(rs, xaxis, secondYaxis, chartTimeList,
                        timeColumn, tzOffset, calc);
            }

            @Override
            public String transform(final List<ResultSet> results) throws SQLException {
                return JSONUtils.toJSONSamplingChartDataObjectWithCalculator(xaxis, secondYaxis, chartTimeList,
                        timeColumn, tzOffset, results, calc);
            }
        };
    }
     ...
     */
    public static ResultSetTransformer<String> getJSONLiveLoadTransformer(final String liveLoadType,
     ...
     */
    public static ResultSetTransformer<String> getJSONMetadataUITransformer(final String servicesUrl,
     ...
     * @return the CSV transformer
     */
    public static ResultSetTransformer<String> getCSVStreamTransformer(final List<Integer> timeColumnIndexes,
            final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
    ...
    /**
     * Gets the csv transformer which includes extraction of the Sub Cause Code Help Text, based on Cause Code ID.
     * Added for TR HN63122.
     *
     * @return the CSV transformer
     */
    public static ResultSetTransformer<String> getCSVStreamTransformerForCauseCode(final String timeColumn,
            final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
     ...
     * @return the JSON chart data transformer
     */
    public static ResultSetTransformer<String> getJSONChartDataTransformerForSUBBIBusy(final String busyKey,
            final String dateTimeFrom, final String dateTimeTo, final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
     ...
     * @return the JSON chart data transformer
     */
    public static ResultSetTransformer<String> getJSONChartDataTransformerForSUBBIBusyWithAppendedRows(
            final String busyKey, final String dateTimeFrom, final String dateTimeTo, final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
                return JSONUtils.toJSONChartDataObjectForSubBIBusyWithAppendedRows(rs, busyKey, dateTimeFrom,
                        dateTimeTo, tzOffset);
            }

            @Override
            public String transform(final List<ResultSet> results) throws SQLException {
                return JSONUtils.toJSONChartDataObjectForSubBIBusyWithAppendedRows(results, busyKey, dateTimeFrom,
                        dateTimeTo, tzOffset);
            }
        };
    }
     ...
     * @return the JSON chart data transformer
     */
    public static ResultSetTransformer<String> getJSONGridDataTransformerForSUBBIBusyDay(final String dateFrom,
            final String dateTo, final String timeColumn, final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
    ...
    /**
     * Gets the raw table names.
     * Put non-null raw table names into a list.
     *
     ...
     * @return the JSON grid data transformer
     */
    public static ResultSetTransformer<String> getCauseCodeHelpTextTransformer(final String timestampFrom,
            final String timestampTo, final String timeColumn, final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
                return JSONCauseCodeUtils.toJSONGridDataObjectForCauseCode(rs, timestampFrom, timestampTo, timeColumn,
                        tzOffset);
            }
     ...
     * @return the JSON grid data transformer
     */
    public static ResultSetTransformer<String> getRoamingHelpTextTransformer(final String timestampFrom,
            final String timestampTo, final String tzOffset) {
        return new ResultSetTransformer<String>() {
            @Override
            public String transform(final ResultSet rs) throws SQLException {
                return null;
    ...
    public static ResultSetTransformer<UserPreferencesType> getUserPreferencesTransformer() {
        return new ResultSetTransformer<UserPreferencesType>() {
            ...
            public UserPreferencesType transform(final ResultSet rs) throws SQLException {
                return rs.next() ? new UserPreferencesType(rs.getString(USERNAME_COLUMN), rs.getInt(VERSION_COLUMN),
                        readClob(rs, SETTINGS_COLUMN).toString()) : null;
            }
