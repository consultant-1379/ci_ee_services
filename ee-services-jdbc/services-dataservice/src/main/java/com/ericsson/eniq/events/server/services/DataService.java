...
public interface DataService {
     ...
     *
     * @param query       The SQ LQuery to execute.
     * @param servicesUrl Services Base URI
     * @param handsetPath REST path for Handset resource
     ...
     * @param liveLoadType The Node type i.e. BSC, CELL or APN.
     *                     If set, the livesearch type in the returned JSON is set to this, of not set 'data' is used.
     * @param callbackId   The UI callback ID, must be set.
     ...
     */
    String getLiveLoad(final String query, final String liveLoadType, final String callbackId, String pagingLimit,
            String pagingIndex);
     ...
     * @return ExtGWT LiveSearch JSON results.
     */
    String getLiveLoadForAPN(final String query, final Map<String, QueryParameter> queryParams,
            final String liveLoadType, final String callbackId, String pagingLimit, String pagingIndex);
     ...
     *
     * @param groupDefName The Group Type name e.g. APN, IMSI or TAC
     ...
     * Grid data variant.
     *
     * @param requestID            for cancelling
     * @param query
     * @param mapRequestParameters the map request parameters
     * @param timeColumn           the timezone column
     * @param tzOffset             the timezone offset
     * @return JSON encoded result
     */
    String getGridData(final String requestID, final String query,
            final Map<String, QueryParameter> mapRequestParameters, final String timeColumn, final String tzOffset);

    /**
     * Grid data variant.
     *
     * @param requestID  for cancelling
     * @param query      SQL query with no parameters
     * @param timeColumn the timezone column
     * @param tzOffset   the timezone offset
     * @return JSON encoded result
     */
     ...
     * @return JSON encoded result
     */
    String getGridData(final String requestID, final String query, final Map<String, QueryParameter> queryParameters,
     ...
     */
    String getGridDataAsCSV(final String query, final Map<String, QueryParameter> mapRequestParameters,
     ...
     * @param timeColumn           the timezone column
     * @param tzOffset             the timezone offset
     * @param loadBalancingPolicy  the load balancing policy
     * @return the grid data as csv
     */
    String getGridDataAsCSV(final String query, final Map<String, QueryParameter> mapRequestParameters,
            final String timeColumn, final String tzOffset, final LoadBalancingPolicy loadBalancingPolicy);
     ...
     * @param query           SQL query to be prepared
     * @param queryParameters named parameter map
     * @param xaxis           indicate the number of column will be the xaxis
     * @param secondYaxis     indicate the number column will be the second yaxis
     * @param timeColumn      the timezone column
     * @param tzOffset        the timezone offset
     * @return JSON encoded data result
     * @see QueryParameter
     */
    String getChartData(final String requestID, final String query, final Map<String, QueryParameter> queryParameters,
     ...
     * @param timeColumn               the timezone column
     * @param tzOffset                 the timezone offset
     * @param loadBalancingPolicyToUse the load balancing policy to use
     * @return JSON encoded data result
     * @see QueryParameter
     */
    String getChartData(final String requestID, final String query, final Map<String, QueryParameter> queryParameters,
    ...
    /**
     * Get data for charting the Groups Most Frequent Signalling Graph. It needs a specific method because the transformer
     * needs to tell the JSONUtils to calculate the Y_AXIS_MAX and MIN
     *
     * @param requestID       for cancelling
     * @param query           SQL query to be prepared
     * @param queryParameters named parameter map
     ...
     * @see QueryParameter
     */
    String getGroupsMostFreqSignalChartData(final String requestID, final String query,
     ...
     * <p/>
     * TODO: this should replace all the other getXXData methods - use transformers
     * instead to influence the output format.
     *
     * @param requestID   for cancelling
     * @param query       the query
     * @param parameters  the parameters
     * @param transformer - transforms result set to string representation (CSV, JSON etc.)
     ...
     * @param chartDateTime            the chart date time
     * @param timeColumn               the timezone column
     * @param tzOffset                 the timezone offset
     ...
     */
    String getSamplingChartData(final String requestID, final String query,
     ...
     * @return the sampling chart data
     */
    String getSamplingChartData(final String requestID, final List<String> query,
            final Map<String, QueryParameter> queryParameters, final String[] chartDateTime, final String xaxis,
            final String secondYaxis, final String timeColumn, final String tzOffset,
            final LoadBalancingPolicy loadBalancingPolicyToUse);
    ...
    /**
     * Get data for subBI - busy data (hour or day).
     ...
     * @see QueryParameter
     */
    String getSubBIBusyData(final String requestID, final String query,
            final Map<String, QueryParameter> queryParameters, final LoadBalancingPolicy loadBalancingPolicyToUse,
            final String busyKey, final String tzOffset);

    /**
     * Get data for subBI - busy day data.
     * The idea is to manipulate result set when there is no event for particular day in the database
     *
     * @param requestID                for cancelling
     * @param query                    SQL query to be prepared
     * @param queryParameters          named parameter map
     ...
     * @see QueryParameter
     */
    String getSubBIBusyDayGridData(final String requestID, final String query,
            final Map<String, QueryParameter> queryParameters, final String timeColumn,
            final LoadBalancingPolicy loadBalancingPolicyToUse, final String tzOffset);

    /**
     * Get the RAT values and descriptions as specified in the database
     *
     * @param query query to run against database
    ...
    /**
     * Modified variant of standard "getGridData" for TR HN63122. Executes a query and transforms
     * the result to a string representation, and extracts the relevant Sub Cause Code Help text
     * from a concatenated list of all Sub Cause Code Help texts returned by the DB, based on
     * Cause Code ID.
     *
     * @param requestID            for cancelling
     * @param query                SQL query to be prepared
     ...
     * @return JSON encoded result
     */
    String getGridDataForCauseCode(final String requestID, String query,
            Map<String, QueryParameter> mapRequestParameters, String timeColumn, String tzOffset);
    ...
    /**
     * @param requestId           for cancelling request
     * @param query               to be executed
     * @param queryParameters
     * @param timeColumnIndexes   list of column needs to be converted to local time
     * @param tzOffset
     * @param loadBalancingPolicy
     * @return
     */
    String getGridData(String requestId, String query, Map<String, QueryParameter> queryParameters,
            List<Integer> timeColumnIndexes, String tzOffset, LoadBalancingPolicy loadBalancingPolicy);

    /**
     * This method will append row data from the list of result set generated for list of queries passes
     * as parameter.
     * The queries should generate result set with identical column order and data type
     *
     * @param requestId           for cancelling request
     * @param list                of queries to be executed
     * @param queryParameters
     * @param timeColumnIndexes   list of column needs to be converted to local time
     * @param tzOffset
     * @param loadBalancingPolicy
     * @return
     */
    String getGridDataWithAppendedRows(String requestId, List<String> queries,
            Map<String, QueryParameter> queryParameters, List<Integer> timeColumnIndexes, String tzOffset,
    ...
    /**
     * @param requestID           request ID for query
     * @param query               the SQL query to execute
     * @param queryParameters     the queryParameters to input into the SQL query
     * @param tzOffset            time zone offset provided by user
     * @param loadBalancingPolicy the load balancing policy to use when selecting a database connection for use
     ...
     * @return
     */
    String getChartDataWithAppendedRows(String requestId, List<String> query,
            Map<String, QueryParameter> queryParameters, String xaxis, String secondYaxis, String timeColumn,
            String tzOffset, LoadBalancingPolicy loadBalancingPolicy);
     ...
     * @return
     */
    String getSubBIBusyDataWithAppendedRows(String requestID, List<String> query,
            Map<String, QueryParameter> queryParameters, LoadBalancingPolicy loadBalancingPolicy, String busyKey,
            String tzOffset);
     ...
     * @return
     */
    String getChartDataWithAppendedRowsRoaming(String requestId, List<String> query,
            Map<String, QueryParameter> queryParameters, String xaxis, String secondYaxis, String tzOffset,
            LoadBalancingPolicy loadBalancingPolicy);

    /**
     * Fetch data
     * The standard transformer is used (ie the transformer originally called the grid transformer)
     *
     * @param requestId           request id for cancelling request
     * @param query               SQL query to execute
     * @param queryParameters     parameters for SQL query
     * @param tzOffset
     * @param loadBalancingPolicy
     * @return
     */
     ...
     * @param queryParams parameters for SQL insert/update statement
     */
     ...
     * @param queryParams parameters for SQL query
