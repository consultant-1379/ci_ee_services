 ...
 *
 */
public class MssEventAnalysisWithPreparedTablesForAllNodesTypesTest extends
    ...
    public void testGetSummaryDataByTime_MSC_30_minutes() throws Exception {
        ...
        DummyUriInfoImpl.setUriInfoMss(map, mssEventAnalysisResource);
        final String json = mssEventAnalysisResource.getData();
        final List<MssMscEventAnalysisSummaryResult> summaryResult = new ResultTranslator<MssMscEventAnalysisSummaryResult>()
                .translateResult(json, MssMscEventAnalysisSummaryResult.class);
    ...
    /*@Test
    public void testGetSummaryDataByTime_ImsiGroup30_Minutes() throws Exception {
        createNPopulateGroupSummaryTables();
        final MultivaluedMap<String, String> map = new MultivaluedMapImpl();
        map.putSingle(KEY_PARAM, KEY_TYPE_SUM);
        map.putSingle(DISPLAY_PARAM, GRID);
    ...
    public void testGetDetailedData_IMSI_30min_MsOriginating() throws Exception {
        ...
        final String json = mssEventAnalysisResource.getData();
        final List<MssEventAnalysisDetailedResult> detailedResult = getTranslator().translateResult(json,
    ...
    private void createNPopulateSucTempTablesVoice(final Connection connection1) throws Exception {
        ...
        columnsToCreateInVoiceTables.add(TAC);
        columnsToCreateInVoiceTables.add(EVENT_ID);
        createTemporaryTableOnSpecificConnectionMss(connection1, TEMP_EVENT_E_MSS_VOICE_CDR_SUC_RAW,
                columnsToCreateInVoiceTables);
    ...
    private void createNPopulateSucTempTablesLocServices(final Connection connection1) throws Exception {
        ...
        columnsToCreateInLocServiceTables.add(TAC);
        columnsToCreateInLocServiceTables.add(EVENT_ID);
        createTemporaryTableOnSpecificConnectionMss(connection1, TEMP_EVENT_E_MSS_LOC_SERVICE_CDR_SUC_RAW,
                columnsToCreateInLocServiceTables);
    ...
    private void createNPopulateSucTempTablesSms(final Connection connection1) throws Exception {
        ...
        columnsToCreateInVoiceTables.add(TAC);
        columnsToCreateInVoiceTables.add(EVENT_ID);
        createTemporaryTableOnSpecificConnectionMss(connection1, TEMP_EVENT_E_MSS_SMS_CDR_SUC_RAW,
                columnsToCreateInVoiceTables);
    ...
    private void populateLocationServiceTables(final Connection connection1) throws Exception {
        ...
        insertRowOnSpecificConnection(connection1, TEMP_EVENT_E_MSS_LOC_SERVICE_CDR_ERR_RAW,
                valuesForLocServiceRawTables);
    ...
    private void populateSucLocationServiceTables(final Connection connection1) throws Exception {
        ...
        setupRawTableValues(valuesForLocServiceRawTables, TEST_VALUE_TAC, 6);
        setUpControllerCellValidValues(valuesForLocServiceRawTables);
        insertRowOnSpecificConnection(connection1, TEMP_EVENT_E_MSS_LOC_SERVICE_CDR_SUC_RAW,
                valuesForLocServiceRawTables);
    ...
    private void insertRowIntoICCTable(final Connection connection1, final String table, final int internalCauseCode,
            final String iccDesc) throws SQLException {
    ...
    private void insertRowIntoProtocolTable(final Connection connection1, final String table, final int protocolID,
            final String protocolName) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void insertRowIntoRanapTable(final Connection connection1, final String table, final int ranapCode,
            final String ranapDesc) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void insertRowIntoBssmapTable(final Connection connection1, final String table, final int bssmapCode,
            final String bssmapDesc) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void insertRowIntoFaultCodeTable(final Connection connection1, final String table, final int faultCode,
            final String faultCodeDesc, final String advice) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void insertRowIntoRatTable(final Connection connection1, final String table, final int causeProtoType,
            final String cptDesc) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void populateICCTable(final Connection connection1) throws SQLException {
        insertRowIntoICCTable(connection1, TEMP_DIM_E_MSS_INTERNAL_CAUSE_CODE, TEST_VALUE_INTERNAL_CAUSE_CODE,
                "Requested facility not subscribed");
    }

    private void populateProtocolTable(final Connection connection1) throws SQLException {
        insertRowIntoProtocolTable(connection1, TEMP_DIM_E_MSS_PROTOCOL_CODE, TEST_VALUE_EXTERNAL_PROTOCOL_ID,
                TEST_VALUE_EXTERNAL_PROTOCOL_NAME);
    }
    ...
    private void populateFaultCodeTable(final Connection connection1) throws SQLException {
        insertRowIntoFaultCodeTable(connection1, TEMP_DIM_E_MSS_FAULT_CODE, TEST_VALUE_FAULT_CODE,
                "Release message received with cause= no circuit available and diagnostic with CCBS not possible.",
                "advice");
    ...
    private void populateEventSrcTable(final Connection connection1) throws SQLException {
        insertRowIntoEventSrcTable(connection1, TEMP_DIM_E_MSS_EVNTSRC, TEST_VALUE_MSS_EVNTSRC,
                TEST_VALUE_MSS_EVNTSRC_ID);
    }

    private void insertRowIntoEventSrcTable(final Connection connection1, final String table, final String eventSrc,
            final long evntSrcId) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void populateHier321Table(final Connection connection1) throws SQLException {
        insertRowIntoHier321Table(connection1, TEMP_DIM_E_SGEH_HIER321, RAT_FOR_GSM, TEST_VALUE_MSS_CELL_NAME,
                TEST_VALUE_MSS_CONTROLLER_NAME, ERICSSON, TEST_VALUE_MSS_HIER3_ID, TEST_VALUE_MSS_HIER321_ID);
    }

    private void insertRowIntoHier321Table(final Connection connection1, final String table, final int rat,
            final String cell, final String controller, final String vendor, final long hier3Id, final long hier321Id)
            throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void populateEventTypeTable(final Connection connection1) throws SQLException {
        ...
        insertRowIntoEventTypeTable(connection1, TEMP_DIM_E_MSS_EVENTTYPE, MSS_CALL_FORWARDING_EVENT_ID,
                CALL_FORWARDING);
        insertRowIntoEventTypeTable(connection1, TEMP_DIM_E_MSS_EVENTTYPE, MSS_ROAMING_CALL_EVENT_ID,
                ROAMING_CALL_FORWARDING);
        insertRowIntoEventTypeTable(connection1, TEMP_DIM_E_MSS_EVENTTYPE, MSS_LOCATION_SERVICE_EVENT_ID,
                LOCATION_SERVICES);
        insertRowIntoEventTypeTable(connection1, TEMP_DIM_E_MSS_EVENTTYPE, MSS_SMS_MS_ORIGINATING_EVENT_ID,
                MS_ORIGINATING_SMS_MSC);
        insertRowIntoEventTypeTable(connection1, TEMP_DIM_E_MSS_EVENTTYPE, MSS_SMS_MS_TERMINATING_EVENT_ID,
                MS_TERMINATING_SMS_MSC);
    }

    private void insertRowIntoEventTypeTable(final Connection connection1, final String table, final String evntId,
            final String evntDesc) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void populateTacTable(final Connection connection1) throws SQLException {
        insertRowIntoTacTable(connection1, TEMP_DIM_E_SGEH_TAC, TEST_VALUE_TAC, "Jixiangjia Group Co Ltd",
    ...
    private void insertRowIntoTacTable(final Connection connection1, final String table, final String tac,
            final String manuf, final String marketingName) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void populateLcsclienttypeTable(final Connection connection1) throws SQLException {
        insertRowIntoLcsclienttypeTable(connection1, TEMP_DIM_E_MSS_LCS_CLIENT_TYPE, TEST_VALUE_LCS_CLIENT_TYPE,
                "valueAddedServices");
    }

    private void insertRowIntoLcsclienttypeTable(final Connection connection1, final String table,
            final int lcsClientType, final String lcsClientTypeDesc) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void insertRowIntoTypelocationreqTable(final Connection connection1, final String table,
            final int typeLocReq, final String typeLocReqDesc) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void populateUnSucPosReasonTable(final Connection connection1) throws SQLException {
        insertRowIntoUnSucPosReasonTable(connection1, TEMP_DIM_E_MSS_UNSUC_POSITION_REASON,
                TEST_VALUE_UNSUC_POSITION_REASON, "userDeniedDueToPrivacyVerification");
    }

    private void insertRowIntoUnSucPosReasonTable(final Connection connection1, final String table,
            final int unSucPosReason, final String unSucPosReasonDesc) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void populateGroupEvntSrcTable(final Connection connection1) throws SQLException {
        insertRowIntoGroupEvntSrcTable(connection1, TEMP_GROUP_TYPE_E_EVNTSRC_CS, TEST_VALUE_MSS_GROUP_EVNTSRC,
                TEST_VALUE_MSS_EVNTSRC, TEST_VALUE_MSS_EVNTSRC_ID);
    }

    private void insertRowIntoGroupEvntSrcTable(final Connection connection1, final String table,
            final String groupName, final String evntSrcName, final long hier3Id) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void populateGroupControllerTable(final Connection connection1) throws SQLException {
        insertRowIntoGroupControllerTable(connection1, TEMP_GROUP_TYPE_E_RAT_VEND_HIER3,
                TEST_VALUE_MSS_GROUP_CONTROLLER, RAT_FOR_GSM, ERICSSON, TEST_VALUE_MSS_CONTROLLER_NAME,
                TEST_VALUE_MSS_HIER3_ID);
    }

    private void insertRowIntoGroupControllerTable(final Connection connection1, final String table,
            final String groupName, final int rat, final String vendor, final String controllerName, final long hier3Id)
            throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
        valuesForTable.put(GROUP_NAME, groupName);
        valuesForTable.put(RAT, rat);
    ...
    private void populateGroupCellTable(final Connection connection1) throws SQLException {
        insertRowIntoGroupCellTable(connection1, TEMP_GROUP_TYPE_E_RAT_VEND_HIER321, TEST_VALUE_MSS_GROUP_CELL,
                RAT_FOR_GSM, ERICSSON, TEST_VALUE_MSS_CONTROLLER_NAME, TEST_VALUE_MSS_CELL_NAME,
                TEST_VALUE_MSS_HIER3_ID, TEST_VALUE_MSS_HIER321_ID);
    }

    private void insertRowIntoGroupCellTable(final Connection connection1, final String table, final String groupName,
            final int rat, final String vendor, final String controllerName, final String cellName, final long hier3Id,
    ...
    private void insertRowIntoGroupTacTable(final Connection connection1, final String table, final String grpName,
            final String tac) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void insertRowIntoGroupImsiTable(final Connection connection1, final String table, final String grpName,
            final long imsi) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
        valuesForTable.put(GROUP_NAME, grpName);
    ...
    private void populateSmsResultTable(final Connection connection1) throws SQLException {
        insertRowIntoSmsResultTable(connection1, TEMP_DIM_E_MSS_SMS_RESULT, TEST_VALUE_SMS_RESULT,
                "unsuccessfulMOSMSDeliverytoSMSCDuetoCAMELReason");
    }

    private void insertRowIntoSmsResultTable(final Connection connection1, final String table, final int smsResult,
            final String smsResultDesc) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private void populateMsgTypeIndicatorTable(final Connection connection1) throws SQLException {
        insertRowIntoMsgTypeIndicatorTable(connection1, TEMP_DIM_E_MSS_MSG_TYPE_INDICATOR,
                TEST_VALUE_MSG_TYPE_INDICATOR, "sMSdeliverSCtoMS");
    }

    private void insertRowIntoMsgTypeIndicatorTable(final Connection connection1, final String table,
            final int msgTypeIndicator, final String msgTypeIndicatorDesc) throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
