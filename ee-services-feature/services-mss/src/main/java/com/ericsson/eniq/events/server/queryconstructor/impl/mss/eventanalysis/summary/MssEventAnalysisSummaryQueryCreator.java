...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.ALL_ALIAS_TABLE_LIST_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.CELL_SQL_ID;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.COLUMNS;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.COMMON_COLUMNS_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.CONSTANT_COLUMN_NAME;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.CONSTANT_COLUMN_VALUE;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.DATETIME_ID;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.DAY_PARAM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.ERR_COLUMNS_ALIAS_LIST_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.EVENT_DESCRIPTION_COLUMN_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.EVENT_DESCRIPTION_TABLE_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.EVENT_ID_PARAM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.EVENT_TYPE_TABLE_VIEW;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.EXTRA_TABLE_JOIN_COLUMNS_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.EXTRA_TABLE_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.FILTER_COLUMNS_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.FULL_OUTER_JOIN_STRING;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.GROUP_DEFINITIONS;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.GROUP_NAME_KEY;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.GROUP_TYPE_EVENT_SRC_CS;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.GROUP_TYPE_HIER1;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.GROUP_TYPE_HIER3;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.HOUR_PARAM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.HOUR_SQL_PARAM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.IMPACTED_SUBSCRIBER_SQL_ENTRY;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.IMPACTED_SUBSCRIBER_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.IMSI_FILTER_COLUMNS_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.IS_EXCULDED_TAC_OR_TACGROUP;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.JOIN_COLUMNS_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_DROP_CALL;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_ERR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_LOC_SERVICE_ERR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_LOC_SERVICE_SUC;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_SMS_ERR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.KEY_TYPE_SMS_SUC;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.NO_OF_ERRORS_AGG;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.NO_OF_SUCCESSES_AGG;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.ON_CLAUSE_JOIN_TABLE;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.ON_CLAUSE_LEFT_OUTER_JOIN_ALIAS_TABLE;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.SELECT_COLUMNS_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.SUBBI_CELL_SQL_ID;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.SUC_COLUMNS_ALIAS_LIST_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.SUM_ERR_COLUMNS_ALIAS_LIST_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.SUM_SUC_COLUMNS_ALIAS_LIST_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.SUM_TOTAL_COLUMNS_ALIAS_LIST_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TAC_PARAM_UPPER_CASE;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TECH_PACK_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TEMP_JOIN_TABLES;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TEMP_JOIN_VIEW_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TIMERANGE_PARAM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TOPOLOGY_FILTER_COLUMNS;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TOPOLOGY_TABLE_VIEW;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TOTAL_COLUMNS_ALIAS_LIST_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TOTAL_EVENTS;
...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TYPE_MSISDN;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TYPE_PARAM;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TYPE_TO_NODE_TABLE_VIEW_VAR;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.UNION_ALL;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.USE_TAC_EXCLUSION_BOOLEAN;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.returnAggregateViewTypeWithOutOneMinute;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_LEFT_OUTER_JOIN_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_ON_CLAUSE_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_ON_CLAUSE_WITH_SINGLE_MULTI_JOIN_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_DRILLDOWN_EVNTID_EVNT_ANALYSIS_VOICE_ERRORVIEW_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_DRILLDOWN_EVNTID_EVNT_ANALYSIS_VOICE_IMSI_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_DRILLDOWN_EVNTID_EVNT_ANALYSIS_VOICE_IMSI_TOTAL_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_DRILLDOWN_EVNTID_EVNT_ANALYSIS_VOICE_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_EVNT_ANALYSIS_VOICE_ERRORVIEW_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_EVNT_ANALYSIS_VOICE_IMSI_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_EVNT_ANALYSIS_VOICE_IMSI_TOTAL_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_EVNT_ANALYSIS_VOICE_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_SUBBI_EVNT_ANALYSIS_VOICE_ERRORVIEW_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_SUBBI_EVNT_ANALYSIS_VOICE_IMSI_TEMPLATE;
import static com.ericsson.eniq.events.server.queryconstructor.QueryConstructorConstants.MSS_SUMMARY_SUBBI_EVNT_ANALYSIS_VOICE_TEMPLATE;
