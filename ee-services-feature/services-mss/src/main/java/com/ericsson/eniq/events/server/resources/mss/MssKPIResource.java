...
public class MssKPIResource extends MssBaseResource {
    ...
    /**
     * Gets the JSON chart results for KPI. For Single KPI, service is sampling 30
     * results based on timerange and interval
     * 
     * @param requestId
    ...
    private String getChartResults(final String requestId, final MultivaluedMap<String, String> requestParameters)
        ...
        final Map<String, QueryParameter> querParams = this.queryUtils.mapRequestParametersForHashId(requestParameters,
                newDateTimeRange);
        return this.dataService.getSamplingChartData(requestId, queries, querParams, kpiDateTimeList, KPI_X_AXIS_VALUE,
                MSS_KPI_SECOND_Y_AXIS_VALUE, EVENT_TIME_COLUMN_INDEX, tzOffset,
                getLoadBalancingPolicy(requestParameters));
    }

    private void updateTemplateParameterForTime(final Map<String, Object> templateParameters,
