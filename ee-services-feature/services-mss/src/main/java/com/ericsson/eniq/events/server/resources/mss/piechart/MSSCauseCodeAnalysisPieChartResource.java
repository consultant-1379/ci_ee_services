...
/**
 * This is the main resource class for MSS cause code pie chart analysis 
 * which is used by the API class #MSSCauseCodeAnalysisPieChartAPI
 * 
 * @author eavidat
 * @since 2011
 *
...
public class MSSCauseCodeAnalysisPieChartResource extends MssBaseResource {
     ...
     */
    private void updateTemplateWithTableInfo(final Map<String, Object> templateParameters,
            final TechPackTables techPackTables, final String key) {
    ...
    private boolean updateTemplateWithTechPackInfo(final Map<String, Object> templateParameters, final String type) {
        ...
        if (useAggregations) {
            ...
            return techPackTables.shouldReportErrorAboutEmptyRawTables()
                    || techPackRawTables.shouldReportErrorAboutEmptyRawTables();
        }
    ...
    private void updateTemplateWithTimeRangeInfo(final Map<String, Object> templateParameters,
        ...
        dateTimeRange = getAndCheckFormattedDateTimeRangeForDailyAggregation(requestParameters,
    ...
    private String getData(final MultivaluedMap<String, String> requestParameters, final String requestId,
        ...
        return this.dataService.getGridData(requestId, query,
                this.queryUtils.mapRequestParametersForHashId(requestParameters, newDateTimeRange), timeColumn,
