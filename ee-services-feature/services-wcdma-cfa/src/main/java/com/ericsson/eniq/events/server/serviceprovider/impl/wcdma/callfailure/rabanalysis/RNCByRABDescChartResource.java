...
@Stateless
@Local(Service.class)
public class RNCByRABDescChartResource extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_CONTROLLER_RAB_DESC;
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(HIER3_EVENTID_RABTYPE, EventDataSourceType.AGGREGATED_15MIN,
