...
@Stateless
@Local(Service.class)
public class AccessAreaCauseCodeListService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_ACCESS_AREA_CAUSE_CODE_LIST;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(HIER3_CELL_HASHID, QueryParameter.createLongParameter(hashedCellId));
