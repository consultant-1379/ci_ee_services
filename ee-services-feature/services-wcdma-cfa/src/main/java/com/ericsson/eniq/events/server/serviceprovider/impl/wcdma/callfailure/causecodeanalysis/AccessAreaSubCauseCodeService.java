...
@Stateless
@Local(Service.class)
public class AccessAreaSubCauseCodeService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_SUB_CAUSE_CODE;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        templateParameters.put(CAUSE_CODE_PARAM, requestParameters.getFirst(CAUSE_CODE_PARAM));
