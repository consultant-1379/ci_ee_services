...
@Stateless
@Local(Service.class)
public class SubscriberCallFailureFAforEAByImsiGroupService extends GenericService {
    ...
    public String getTemplatePath() {
        return SUBSCRIBER_FAILURE_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(GROUP_NAME_PARAM,
                getQueryUtils().createQueryParameter(GROUP_NAME_PARAM, requestParameters.getFirst(GROUP_NAME_PARAM)));
        queryParameters.put(EVENT_ID_PARAM,
                getQueryUtils().createQueryParameter(EVENT_ID_PARAM, requestParameters.getFirst(EVENT_ID_PARAM)));
