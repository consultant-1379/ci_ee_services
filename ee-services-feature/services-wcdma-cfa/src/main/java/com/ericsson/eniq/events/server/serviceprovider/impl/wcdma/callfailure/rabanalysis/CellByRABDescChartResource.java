...
@Stateless
@Local(Service.class)
public class CellByRABDescChartResource extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_CELL_RAB_DESC;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final String hashedIdForCell = requestParameters.getFirst(HIER3_CELL_ID_AGG);

        queryParameters.put(HIER3_CELL_ID_AGG, QueryParameter.createLongParameter(Long.parseLong(hashedIdForCell)));
    ...
    public List<String> getRequiredParametersForQuery() {
        ...
        requiredParameters.add(HIER3_CELL_ID_AGG);
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(HIER3_CELL_ID_EVENTID_RABTYPE, EventDataSourceType.AGGREGATED_15MIN,
