...
@Stateless
@Local(Service.class)
public class SubscriberCallSetupFailureDetailedEAService extends GenericService {
    ...
    public String getTemplatePath() {
        return SUBSCRIBER_CALL_FAILURE_DETAILED_EVENT_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(EVENT_ID_PARAM, QueryParameter.createIntParameter(CALL_SETUP_FAILURE_EVENT_ID_AS_INTEGER));
        queryParameters.put(
