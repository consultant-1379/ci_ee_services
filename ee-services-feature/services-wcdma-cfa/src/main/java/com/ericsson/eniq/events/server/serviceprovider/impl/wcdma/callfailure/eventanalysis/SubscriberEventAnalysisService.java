...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.IMSI_PARAM_UPPER_CASE;
...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.SUBSCRIBER_CALL_FAILURE_EVENT_ANALYSIS;
 ...
 * @author eflatib
 *         <p/>
 *         This is a hybrid Service to support IMSI-SUMMARY and GROUP-SUMMARY hence the mod in getServiceSpecificQueryParameters()
 */
@Stateless
@Local(Service.class)
public class SubscriberEventAnalysisService extends GenericService {
    ...
    public String getTemplatePath() {
        return SUBSCRIBER_CALL_FAILURE_EVENT_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        // decide if "imsi" or "imsi group" are to be queried
