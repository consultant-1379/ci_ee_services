...
@Stateless
@Local(Service.class)
public class CallFailureOperatorDrillRoamingAnalysisService extends GenericService {

    private static final String WCDMA_CALL_FAILURE_OPERATOR_DRILL_ROAMING_ANALYSIS = "WCDMA_CALL_FAILURE_OPERATOR_DRILL_ROAMING_ANALYSIS";
    ...
    public String getTemplatePath() {
        return WCDMA_CALL_FAILURE_OPERATOR_DRILL_ROAMING_ANALYSIS;
    }
