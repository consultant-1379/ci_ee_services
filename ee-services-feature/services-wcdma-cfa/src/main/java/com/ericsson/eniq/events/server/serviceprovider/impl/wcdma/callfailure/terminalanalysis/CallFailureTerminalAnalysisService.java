...
@Stateless
@Local(Service.class)
public class CallFailureTerminalAnalysisService extends GenericService {

    private static final String CALL_FAILURE_TERMINAL_ANALYSIS = "CALL_FAILURE_TERMINAL_ANALYSIS";
    ...
    public String getTemplatePath() {
        return CALL_FAILURE_TERMINAL_ANALYSIS;
    }
