...
@Stateless
@Local(Service.class)
public class AccessAreaGroupSubCauseCodeService extends GenericService {
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
            final MultivaluedMap<String, String> requestParameters) {
        final Map<String, QueryParameter> templateParameters = new HashMap<String, QueryParameter>();
        templateParameters.put(GROUP_NAME_PARAM,
