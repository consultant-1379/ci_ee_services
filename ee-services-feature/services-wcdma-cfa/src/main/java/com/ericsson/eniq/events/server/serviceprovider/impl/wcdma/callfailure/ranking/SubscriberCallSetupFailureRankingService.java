...
@Stateless
@Local(Service.class)
public class SubscriberCallSetupFailureRankingService extends GenericService {
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(EVENT_ID, CALL_SETUP_FAILURE_EVENT_ID);
    ...
    public String getTemplatePath() {
        return SUBSCRIBER_CALL_FAILURE_RANKING_ANALYSIS;
    }
