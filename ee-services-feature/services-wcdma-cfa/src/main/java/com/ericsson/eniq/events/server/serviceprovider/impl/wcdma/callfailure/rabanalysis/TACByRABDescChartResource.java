 ...
 * -----------------------------------------------------------------------
 */
package com.ericsson.eniq.events.server.serviceprovider.impl.wcdma.callfailure.rabanalysis;
...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.UNKNOWN;
import static com.ericsson.eniq.events.server.common.ApplicationConstants.WCDMA_CFA_TERMINAL_RAB_DESC;
...
@Stateless
@Local(Service.class)
public class TACByRABDescChartResource extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_TERMINAL_RAB_DESC;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(TAC, requestParameters.getFirst(TAC));
        serviceSpecificTemplateParameters.put(TYPE_PARAM, requestParameters.getFirst(TYPE_PARAM));
        serviceSpecificTemplateParameters.put(DISPLAY_PARAM, requestParameters.getFirst(DISPLAY_PARAM));
        serviceSpecificTemplateParameters.put(UNKNOWN, requestParameters.getFirst(RAB_TYPE));
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        //If we do not know the rabType then we will not pass it as a preparedstatement as the sub chart will just contain results which do not have a rabType 
        if (!"Unknown".equals(requestParameters.getFirst(RAB_TYPE)))
        {
        	queryParameters.put(RAB_TYPE, QueryParameter.createStringParameter(requestParameters.getFirst(RAB_TYPE)));
        }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
    	...
    	//return new AggregationTableInfo("");
    }
