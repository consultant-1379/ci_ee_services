...
/**
 * Resource for Call Failure Analysis Subscriber Overview and Subsequent Drilldown
 *
 * @author EEMECOY
 */
@Stateless
@Local(Service.class)
public class CallFailureSubsessionBIService extends GenericService {
    ...
    public String getTemplatePath() {
        return CALL_FAILURE_SUBBI_FAILURE;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (isADrilldown(requestParameters)) {
            queryParameters.put(EVENT_ID_PARAM,
                    QueryParameter.createIntParameter(getEventIdForEventDesc(requestParameters)));
        }
        return queryParameters;
    }

    int getEventIdForEventDesc(final MultivaluedMap<String, String> requestParameters) {
        final String eventDesc = requestParameters.getFirst(EVENT_PARAM);
        return EventIDConstants.getEventId(eventDesc);
    }
    ...
    private boolean isADrilldown(final MultivaluedMap<String, String> requestParameters) {
        if (requestParameters.containsKey(EVENT_PARAM)) {
            return true;
        }
        return false;
    }
