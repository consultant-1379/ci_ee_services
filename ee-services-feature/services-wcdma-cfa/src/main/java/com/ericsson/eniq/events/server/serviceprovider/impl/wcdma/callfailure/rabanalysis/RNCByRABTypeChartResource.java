...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.WCDMA_CFA_CONTROLLER_RAB_TYPE;
...
@Stateless
@Local(Service.class)
public class RNCByRABTypeChartResource extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_CONTROLLER_RAB_TYPE;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(HIER3_ID, QueryParameter.createLongParameter(Long.parseLong(hashedIdForController)));
