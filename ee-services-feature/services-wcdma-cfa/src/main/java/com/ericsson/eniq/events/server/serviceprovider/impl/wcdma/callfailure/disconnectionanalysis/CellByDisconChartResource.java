...
@Stateless
@Local(Service.class)
public class CellByDisconChartResource extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_CELL_DISCONNECTION;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        long hashedIdForCell;
        if (requestParameters.containsKey(HIER3_CELL_ID_AGG)) {
            hashedIdForCell = Long.parseLong(requestParameters.getFirst(HIER3_CELL_ID_AGG));
        } else {
            ...
            hashedIdForCell = getQueryUtils().createHashIDFor3GCell(_3G, controller, cell, vendor);
        }
