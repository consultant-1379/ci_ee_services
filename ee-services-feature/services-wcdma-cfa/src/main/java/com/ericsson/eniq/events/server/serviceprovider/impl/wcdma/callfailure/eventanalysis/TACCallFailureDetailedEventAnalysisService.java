...
@Stateless
@Local(Service.class)
public class TACCallFailureDetailedEventAnalysisService extends GenericService {
    ...
    public String getTemplatePath() {
        return TAC_CALL_FAILURE_DETAILED_EVENT_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        templateParameters.put(EVENT_ID_PARAM, requestParameters.get(EVENT_ID_PARAM));
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        extraQueryParameters.put(TACID_PARAM,
                QueryParameter.createIntParameter(Integer.valueOf(requestParameters.getFirst(TACID_PARAM))));
    ...
    public List<String> getRequiredParametersForQuery() {
        ...
        requiredParameters.add(TACID_PARAM);
