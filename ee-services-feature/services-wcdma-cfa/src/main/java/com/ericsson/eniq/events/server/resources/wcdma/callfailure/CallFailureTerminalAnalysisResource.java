...
@LocalBean
public class CallFailureTerminalAnalysisResource extends AbstractResource {

    private static final String CALL_FAILURE_TERMINAL_ANALYSIS_SERVICE = "CallFailureTerminalAnalysisService";

    @EJB(beanName = CALL_FAILURE_TERMINAL_ANALYSIS_SERVICE)
    ...
    public Response getMostCallDropsAsCSV() {
        final MultivaluedMap<String, String> serviceProviderParameters = mapResourceLayerParameters();
        serviceProviderParameters.putSingle(EVENT_ID, CALL_DROP_EVENT_ID);
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public String getMostSetupFailures() {
        final MultivaluedMap<String, String> serviceProviderParameters = mapResourceLayerParameters();
    ...
    @GET
    @Produces(MediaTypeConstants.APPLICATION_CSV)
    public Response getMostSetupFailuresAsCSV() {
        final MultivaluedMap<String, String> serviceProviderParameters = mapResourceLayerParameters();
        serviceProviderParameters.putSingle(EVENT_ID, CALL_SETUP_FAILURE_EVENT_ID);
        return service.getDataAsCSV(serviceProviderParameters, response);
    }
