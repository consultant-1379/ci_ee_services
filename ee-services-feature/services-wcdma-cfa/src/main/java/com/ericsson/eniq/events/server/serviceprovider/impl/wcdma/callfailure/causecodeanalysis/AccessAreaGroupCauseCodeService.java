...
@Stateless
@Local(Service.class)
public class AccessAreaGroupCauseCodeService extends GenericService {
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        if (requestParameters.containsKey(CAUSE_CODE_ID_LIST)) {
            templateParams.put(CAUSE_CODE_ID_LIST, requestParameters.getFirst(CAUSE_CODE_ID_LIST));
        }
