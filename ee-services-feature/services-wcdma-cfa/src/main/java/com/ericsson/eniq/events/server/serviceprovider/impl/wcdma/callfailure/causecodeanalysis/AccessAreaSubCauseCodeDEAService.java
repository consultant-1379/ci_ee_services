...
@Stateless
@Local(Service.class)
public class AccessAreaSubCauseCodeDEAService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_SUB_CAUSE_CODE_DEA;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if(cellParam != null){
        	...
        	hashedCellId = getQueryUtils().createHashIDFor3GCell(rat, bsc, cell, vendor);
        }
        queryParameters.put(HIER3_CELL_ID,
                QueryParameter.createLongParameter(hashedCellId));
    ...
    public List<Integer> getTimeColumnIndices() {
        final List<Integer> timemColumnIndices = new ArrayList<Integer>();
        timemColumnIndices.add(1);
        return timemColumnIndices;
    }
