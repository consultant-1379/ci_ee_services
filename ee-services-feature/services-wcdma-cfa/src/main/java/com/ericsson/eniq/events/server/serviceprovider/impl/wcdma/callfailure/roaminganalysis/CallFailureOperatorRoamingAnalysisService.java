...
@Stateless
@Local(Service.class)
public class CallFailureOperatorRoamingAnalysisService extends GenericService {

    private static final String WCDMA_CALL_FAILURE_OPERATOR_ROAMING_ANALYSIS = "WCDMA_CALL_FAILURE_OPERATOR_ROAMING_ANALYSIS";
    ...
    public String getTemplatePath() {
        return WCDMA_CALL_FAILURE_OPERATOR_ROAMING_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        templateParameters.put(AGGREGATION_VIEW, techPackList.getTechPack(EVENT_E_RAN_CFA).getPlainAggregationView());
