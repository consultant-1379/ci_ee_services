...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.WCDMA_CFA_CELL_RAB_TYPE;
...
@Stateless
@Local(Service.class)
public class CellByRABTypeChartResource extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_CELL_RAB_TYPE;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final String hashedIdForController = requestParameters.getFirst(HIER3_CELL_ID_AGG);

        queryParameters.put(HIER3_CELL_ID_AGG,
