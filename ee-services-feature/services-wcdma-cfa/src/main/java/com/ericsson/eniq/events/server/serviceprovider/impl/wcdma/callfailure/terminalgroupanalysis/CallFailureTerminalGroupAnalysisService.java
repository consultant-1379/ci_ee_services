...
import static com.ericsson.eniq.events.server.common.tablesandviews.TableKeys.TAC_EVENTID;

/**
 * Service for the WCDMA CFA terminal group query (both terminal group analysis and drilldown)
 *
 * @author EEMECOY
 */
@Stateless
@Local(Service.class)
public class CallFailureTerminalGroupAnalysisService extends GenericService {

    private static final String CALL_FAILURE_TERMINAL_GROUP_ANALYSIS = "CALL_FAILURE_TERMINAL_GROUP_ANALYSIS";
    ...
    public String getTemplatePath() {
        return CALL_FAILURE_TERMINAL_GROUP_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        templateParameters.put(EVENT_ID, Integer.parseInt(requestParameters.getFirst(EVENT_ID)));
        templateParameters.put(GROUP_NAME_PARAM, requestParameters.getFirst(GROUP_NAME_PARAM));
        templateParameters.put(AGGREGATION_VIEW, techPackList.getTechPack(EVENT_E_RAN_CFA).getErrAggregationView());
    ...
    public List<String> getRequiredParametersForQuery() {
        final ArrayList<String> requiredParameters = new ArrayList<String>();
        requiredParameters.add(TZ_OFFSET);
        requiredParameters.add(EVENT_ID);
