...
@Stateless
@Local(Service.class)
public class SubscriberCallDropDetailedEventAnalysisService extends GenericService {
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(EVENT_ID_PARAM, QueryParameter.createIntParameter(CALL_DROP_EVENT_ID_AS_INTEGER));
        queryParameters.put(
