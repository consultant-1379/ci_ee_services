...
@Stateless
@Local(Service.class)
public class TerminalFailedEventAnalysisService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_TERMINAL_FAILED_EVENT_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        //In the case of a drilldown on groups, there will be no tac value.
        if (requestParameters.getFirst(TAC) != null) {
            queryParameters.put(TAC, getQueryUtils().createQueryParameter(TAC, requestParameters.getFirst(TAC)));
        }
