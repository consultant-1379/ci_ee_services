 ...
 * -----------------------------------------------------------------------
 */
package com.ericsson.eniq.events.server.serviceprovider.impl.wcdma.callfailure.disconnectionanalysis;
...
@Stateless
@Local(Service.class)
public class RNCByDisconChartResource extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_CONTROLLER_DISCONNECTION;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        long hashedIdForController;
        if (requestParameters.containsKey(HIER3_ID)) {
            hashedIdForController = Long.parseLong(requestParameters.getFirst(HIER3_ID));
        } else {
    ...
    public List<String> getRequiredParametersForQuery() {
        ...
        //comment out to make ranking working until ranking workflow changes
        //        requiredParameters.add(HIER3_ID);
