...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.CAUSE_CODE_ID_LIST;
...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.HIER3_EVENTID_CV;
...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.WCDMA_CFA_CONTROLLER_CAUSE_CODE;
...
@Stateless
@Local(Service.class)
public class ControllerCauseCodeService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_CFA_CONTROLLER_CAUSE_CODE;
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(HIER3_EVENTID_CV, EventDataSourceType.AGGREGATED_15MIN,
