 ...
 *
 */
public class SubscriberCallSetupDEAIntegrationTest extends BaseServiceIntegrationTest {
    private SubscriberCallSetupFailureDetailedEAService service;

    @Before
    public void setup() {
        service = new SubscriberCallSetupFailureDetailedEAService();
    ...
    private MultivaluedMap<String, String> getRequestParameters(final String time) {
        ...
        requestParameters.putSingle(EVENT_ID, CALL_SETUP_FAILURE_EVENT_ID);
