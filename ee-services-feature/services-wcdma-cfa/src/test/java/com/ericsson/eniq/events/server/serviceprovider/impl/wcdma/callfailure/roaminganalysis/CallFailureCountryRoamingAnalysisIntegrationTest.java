...
public class CallFailureCountryRoamingAnalysisIntegrationTest extends ServiceBaseTest {

    @Resource(name = "callFailureCountryRoamingAnalysisService")
    private CallFailureCountryRoamingAnalysisService countryRoamingAnalysisService;

    @Test
    @Parameters(source = BasicDataProvider.class)
    public void testGetData(final MultivaluedMap<String, String> requestParameters) {
        runQuery(requestParameters, countryRoamingAnalysisService);
    }
