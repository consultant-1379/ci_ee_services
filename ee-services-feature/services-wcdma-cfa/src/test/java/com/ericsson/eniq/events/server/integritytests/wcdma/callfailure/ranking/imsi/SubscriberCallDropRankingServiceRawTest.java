...
import com.ericsson.eniq.events.server.serviceprovider.impl.wcdma.callfailure.ranking.SubscriberCallDropRankingService;
 ...
 *
 */
public class SubscriberCallDropRankingServiceRawTest extends
        BaseDataIntegrityTest<SubscriberCallSetupFailureRankingResult> {

    private SubscriberCallDropRankingService subscriberCallDropRankingService;
    ...
    public void onSetUp() throws Exception {
        subscriberCallDropRankingService = new SubscriberCallDropRankingService();
    ...
    private void insertData() throws Exception {
        ...
        insertIMSI(TEST_IMSI_0, dateTime, CALL_DROP_EVENT_ID, 3, SAMPLE_TAC);
        insertIMSI(TEST_IMSI_0, dateTime, CALL_SETUP_FAILURE_EVENT_ID, 4, SAMPLE_TAC);

        insertIMSI(TEST_IMSI_1, dateTime, CALL_DROP_EVENT_ID, 3, SAMPLE_TAC);
        insertIMSI(TEST_IMSI_1, dateTime, CALL_SETUP_FAILURE_EVENT_ID, 4, SAMPLE_TAC);

        insertIMSI(TEST_IMSI_2, dateTime, CALL_DROP_EVENT_ID, 2, SAMPLE_TAC);
        insertIMSI(TEST_IMSI_2, dateTime, CALL_SETUP_FAILURE_EVENT_ID, 4, SAMPLE_TAC);

        insertIMSI(TEST_IMSI_3, dateTime, CALL_DROP_EVENT_ID, 1, SAMPLE_TAC);
        insertIMSI(TEST_IMSI_3, dateTime, CALL_SETUP_FAILURE_EVENT_ID, 4, SAMPLE_TAC);

        insertIMSI(TEST_IMSI_3, dateTime, CALL_DROP_EVENT_ID, 1, SAMPLE_EXCLUSIVE_TAC);
        insertIMSI(TEST_IMSI_3, dateTime, CALL_SETUP_FAILURE_EVENT_ID, 4, SAMPLE_EXCLUSIVE_TAC);
