 ...
 *
 */
public class RNCDisconDataProvider {

    public static Object[] provideTestDataWithEventId() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(HIER3_ID, "8989201395503661953").add(WCDMA_CFA_DRILL_CATEGORY, "1")
                .add(CATEGORY_ID_PARAM, "0", "1", "2", "3").add(TYPE_PARAM, TYPE_BSC).add(TIME_QUERY_PARAM, ONE_WEEK)
                .add(EVENT_ID_PARAM, "438").add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET)
    ...
    public static Object[] provideTestDataWithOutEventId() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(RNC_FDN_PARAM, "fdn").add(RAN_VENDOR_PARAM, ERICSSON).add(TYPE_PARAM, TYPE_BSC)
