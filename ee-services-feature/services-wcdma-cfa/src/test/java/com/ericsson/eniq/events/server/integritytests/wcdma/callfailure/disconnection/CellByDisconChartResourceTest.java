 ...
 *
 */
public class CellByDisconChartResourceTest extends BaseDataIntegrityTest<DisconnectionChartResourceResult> {

    private CellByDisconChartResource cellByDisconnection;
    ...
    public void setup() throws Exception {
        cellByDisconnection = new CellByDisconChartResource();
        attachDependencies(cellByDisconnection);
    ...
    private void insertDataIntoTopologyTables() throws SQLException {
        ...
        valuesForRncTable.put(HIER3_CELL_ID, hashedIdForCell);
    ...
    private void insertRowIntoEventTable(final int eventId, final int tac, final String timestamp,
        ...
        values.put(HIER3_CELL_ID, hashedIdForCell);
    ...
    public void testGetFailures_ThirtyMinutes() throws URISyntaxException, Exception {
        ...
        requestParameters.putSingle("HIER3_CELL_ID", String.valueOf(hashedIdForCell));
        ...
        final String result = runQuery(cellByDisconnection, requestParameters);
    ...
    private void validateResult(final String json) throws Exception {
        ...
        assertEquals(resultForDisconnectionCongestion.getDisconnectionDesc(), "Disconnection Code: 6");
