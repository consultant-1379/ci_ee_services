...
import com.ericsson.eniq.events.server.test.queryresults.TerminalGroupFailedEventAnalysisResult;
 ...
 *
 */
public class WCDMACFATerminalGroupEventAnalysisTest extends
        BaseDataIntegrityTest<TerminalGroupFailedEventAnalysisResult> {
     ...
     */
    @Test
    public void testTerminalFailedEventAnalysisCFA() throws Exception {
        ...
        validateAgainstGridDefinition(json, "TERMINAL_WCDMA_CFA_EVENT_ANALYSIS_DRILL_ON_FAILURES_GROUP_CALL_DROPS");
        validateAgainstGridDefinition(json, "TERMINAL_WCDMA_CFA_EVENT_ANALYSIS_DRILL_ON_FAILURES_GROUP_CALL_SETUP");
        final List<TerminalGroupFailedEventAnalysisResult> results = getTranslator().translateResult(json,
                TerminalGroupFailedEventAnalysisResult.class);
    ...
    private void insertData() throws Exception {
        ...
        insertData(dateTime, CALL_DROP_EVENT_ID, String.valueOf(SAMPLE_TAC));
        insertData(dateTime, CALL_DROP_EVENT_ID, String.valueOf(SAMPLE_TAC));
        insertData(dateTime, CALL_DROP_EVENT_ID, String.valueOf(SAMPLE_TAC));
        insertData(dateTime, CALL_SETUP_FAILURE_EVENT_ID, String.valueOf(SAMPLE_TAC));
        insertData(dateTime, CALL_SETUP_FAILURE_EVENT_ID, String.valueOf(SAMPLE_TAC));
        insertData(dateTime, CALL_DROP_EVENT_ID, String.valueOf(SAMPLE_TAC_2));
        insertData(dateTime, CALL_SETUP_FAILURE_EVENT_ID, String.valueOf(SAMPLE_TAC_2));
        insertData(dateTime, CALL_DROP_EVENT_ID, String.valueOf(SAMPLE_TAC_3));
        insertData(dateTime, CALL_SETUP_FAILURE_EVENT_ID, String.valueOf(SAMPLE_TAC_3));
    ...
    private void insertData(final String dt, final String eventID, final String tac) throws SQLException {

        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
        valuesForTable.put(IMSI, SAMPLE_IMSI_AS_STRING);
