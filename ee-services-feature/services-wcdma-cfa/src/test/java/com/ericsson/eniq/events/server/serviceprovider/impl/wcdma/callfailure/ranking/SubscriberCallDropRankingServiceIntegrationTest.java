...
public class SubscriberCallDropRankingServiceIntegrationTest extends BaseServiceIntegrationTest {

    private SubscriberCallDropRankingService service;

    @Before
    public void init() {
        service = new SubscriberCallDropRankingService();
        attachDependencies(service);
    }

    @Test
    public void testCallDropRanking_FiveMin() {
