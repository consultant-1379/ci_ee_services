...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.RAB_TYPE;
...
import com.ericsson.eniq.events.server.serviceprovider.impl.wcdma.callfailure.eventanalysis.TerminalDetailedEventAnalysisByFilterService;
 ...
 *
 */
public class TerminalDetailedEventAnalysisByFilterTest extends
        BaseDataIntegrityTest<FailedEventAnalysisByFilterResult> {

    private TerminalDetailedEventAnalysisByFilterService service;
    ...
    public void setup() throws Exception {
        service = new TerminalDetailedEventAnalysisByFilterService();
    ...
    public void setCommonRequestParameters(MultivaluedMap<String, String> requestParameters)
    {
    ...
    @Test
    public void testFiveMinuteQueryForTerminalByRabType() throws URISyntaxException, Exception {
        ...
        requestParameters.add(TAC, TEST_TAC);
    ...
    private void verifyResultForRabType(String json) throws Exception {
    ...
    @Test
    public void testFiveMinuteQueryForTerminalByDisconnection() throws URISyntaxException, Exception {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        setCommonRequestParameters(requestParameters);
    ...
    private void verifyResultForDisconnection(String json) throws Exception {
    ...
    private Map<String, Object> getDefaultLookupValues() {
        ...
        lookupValues.put(HIER3_ID, HASH_ID);
