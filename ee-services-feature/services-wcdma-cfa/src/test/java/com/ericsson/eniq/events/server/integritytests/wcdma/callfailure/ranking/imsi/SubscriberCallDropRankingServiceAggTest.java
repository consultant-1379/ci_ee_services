 ...
 *
 */
public class SubscriberCallDropRankingServiceAggTest extends
    ...
    private void insertData() throws Exception {
        ...
        insertIMSI(TEST_IMSI_0, dateTime, CALL_DROP_EVENT_ID, 3);
        insertIMSI(TEST_IMSI_0, dateTime, CALL_SETUP_FAILURE_EVENT_ID, 4);

        insertIMSI(TEST_IMSI_1, dateTime, CALL_DROP_EVENT_ID, 3);
        insertIMSI(TEST_IMSI_1, dateTime, CALL_SETUP_FAILURE_EVENT_ID, 4);

        insertIMSI(TEST_IMSI_2, dateTime, CALL_DROP_EVENT_ID, 2);
        insertIMSI(TEST_IMSI_2, dateTime, CALL_SETUP_FAILURE_EVENT_ID, 4);

        insertIMSI(TEST_IMSI_3, dateTime, CALL_DROP_EVENT_ID, 1);
        insertIMSI(TEST_IMSI_3, dateTime, CALL_SETUP_FAILURE_EVENT_ID, 4);
