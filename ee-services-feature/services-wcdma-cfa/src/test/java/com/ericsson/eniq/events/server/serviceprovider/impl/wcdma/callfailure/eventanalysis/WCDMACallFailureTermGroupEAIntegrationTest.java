...
import com.ericsson.eniq.events.server.resources.automation.dataproviders.wcdma.callfailure.WCDMACallFailureTermGroupEADataProvider;
...
public class WCDMACallFailureTermGroupEAIntegrationTest extends ServiceBaseTest {

    @Resource(name = "terminalEventAnalysisService")
    private TerminalEventAnalysisService terminalEventAnalysisService;

    @Test
    @Parameters(source = WCDMACallFailureTermGroupEADataProvider.class)
