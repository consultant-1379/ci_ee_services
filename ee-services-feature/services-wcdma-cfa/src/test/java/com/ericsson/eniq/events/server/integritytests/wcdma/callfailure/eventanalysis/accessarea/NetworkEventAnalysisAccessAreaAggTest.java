...
public class NetworkEventAnalysisAccessAreaAggTest extends BaseDataIntegrityTest<NetworkEventAnalysisAccessAreaResult> {
    ...
    private static final String TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_EVENTID_ERR_DAY = "#EVENT_E_RAN_CFA_HIER3_CELL_ID_EVENTID_ERR_DAY";
    ...
    private static final String TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_ALLCALLS_DAY = "#EVENT_E_RAN_CFA_HIER3_CELL_ID_ALLCALLS_DAY";
    ...
    @Test
    public void testNetworkCellData_TotalRab_15MIN() throws Exception {
        ...
        assertEquals(resultForCallDropsEvent.getFailureType(), "Call Setup Failures");

    }

    @Test
    public void testNetworkCellData_TotalRab_DAY() throws Exception {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        requestParameters.putSingle(TIME_FROM_QUERY_PARAM, "2354");
        requestParameters.putSingle(TIME_TO_QUERY_PARAM, "0002");

        requestParameters.putSingle(DATE_FROM_QUERY_PARAM, "16052012");
        requestParameters.putSingle(DATE_TO_QUERY_PARAM, "25052012");
    ...
    private void populateData() throws SQLException {
        ...
        insertRow(TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_EVENTID_ERR_DAY, new HashMap<String, Object>() {
            {
                put("HIER3_CELL_ID", hashedIdForCell);
                put("EVENT_ID", 456);
                put("CS_RAB_FAIL_CNT", 1);
        ...
        insertRow(TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_ALLCALLS_DAY, new HashMap<String, Object>() {
            {
                put("HIER3_CELL_ID", hashedIdForCell);
                put("CALLS_PS_ALL", 1);
                put("CALLS_CS_ALL", 1);
    ...
    private void createCfaDataTableSchema() throws SQLException {
        ...
        final List<ColumnDetails> hier321ErrTableSchema_15MIN = new ArrayList<ColumnDetails>() {
            {
                add(new ColumnDetails("HIER3_ID", "unsigned bigint", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("HIER3_CELL_ID", "unsigned bigint", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("EVENT_ID", "smallint", Nullable.CAN_BE_NULL));
        ...
        final List<ColumnDetails> hier321ErrTableSchema_DAY = new ArrayList<ColumnDetails>() {
            {
                add(new ColumnDetails("HIER3_ID", "unsigned bigint", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("HIER3_CELL_ID", "unsigned bigint", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("EVENT_ID", "smallint", Nullable.CAN_BE_NULL));
        ...
        final List<ColumnDetails> hier321AllCallDayTableSchema = new ArrayList<ColumnDetails>() {
            {
                add(new ColumnDetails("HIER3_ID", "unsigned bigint", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("HIER3_CELL_ID", "unsigned bigint", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("CALLS_CS_ALL", "unsigned bigint", Nullable.CAN_BE_NULL));
        ...
        createTemporaryTable(TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_EVENTID_ERR_DAY, hier321ErrTableSchema_DAY);
        createTemporaryTable(TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_EVENTID_ERR_15MIN, hier321ErrTableSchema_15MIN);
        createTemporaryTable(TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_ALLCALLS_DAY, hier321AllCallDayTableSchema);
