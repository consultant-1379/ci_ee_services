 ...
 *
 */
public class CellByRABDescChartResourceTest extends BaseDataIntegrityTest<RABDescriptionChartResourceResult> {

    private static final String TEMP_EVENT_E_RAN_CFA_ERR_RAW = "#EVENT_E_RAN_CFA_ERR_RAW";

    private static final String TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_EVENTID_RABTYPE_ERR_15MIN = "#EVENT_E_RAN_CFA_HIER3_CELL_ID_EVENTID_RABTYPE_ERR_15MIN";

    private static final String TEMP_DIM_E_RAN_RABTYPE = "#DIM_E_RAN_RABTYPE";

    private CellByRABDescChartResource cellByRABDescChartResource;

    @Before
    public void setUp() throws Exception {
        cellByRABDescChartResource = new CellByRABDescChartResource();
        attachDependencies(cellByRABDescChartResource);
    ...
    @Test
    public void testNetworkCellData_CS_Raw() throws Exception {
        ...
        requestParameters.putSingle(HIER3_CELL_ID_AGG, "1234567890123");
        requestParameters.putSingle(TYPE_PARAM, "CELL");

        final String json = runQuery(cellByRABDescChartResource, requestParameters);
    ...
    @Test
    public void testNetworkCellData_CS_Agg() throws Exception {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        requestParameters.putSingle(TIME_FROM_QUERY_PARAM, "2354");
    ...
    private void populateData() throws SQLException {
        insertRow(TEMP_EVENT_E_RAN_CFA_ERR_RAW, new HashMap<String, Object>() {
            {
                put("HIER3_CELL_ID", "1234567890123");
                put("EVENT_ID", 438);
                put("FAILED_RAB_TYPE", 2);
        ...
        insertRow(TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_EVENTID_RABTYPE_ERR_15MIN, new HashMap<String, Object>() {
            {
                put("HIER3_CELL_ID", "1234567890123");
                put("EVENT_ID", 438);
                put("FAILED_RAB_TYPE", 2);
        ...
        insertRow(TEMP_DIM_E_RAN_RABTYPE, new HashMap<String, Object>() {
            {
                put("RABTYPE", "1");
                put("RABTYPE_DESC", "SRB_13.6_13.6");
            }
        });
        ...
        insertRow(TEMP_DIM_E_RAN_RABTYPE, new HashMap<String, Object>() {
            {
                put("RABTYPE", "2");
                put("RABTYPE_DESC", "CONVERSATIONAL_CS_12.2_12.2");
            }
        });
    ...
    private void createCfaRawTableSchema() throws SQLException {
        ...
        final List<ColumnDetails> errAggTableSchema = new ArrayList<ColumnDetails>() {
            {
                add(new ColumnDetails("HIER3_ID", "unsigned bigint", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("HIER3_CELL_ID", "unsigned bigint", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("EVENT_ID", "smallint", Nullable.CAN_BE_NULL));
        ...
        createTemporaryTable(TEMP_EVENT_E_RAN_CFA_HIER3_CELL_ID_EVENTID_RABTYPE_ERR_15MIN, errAggTableSchema);
    }
}
