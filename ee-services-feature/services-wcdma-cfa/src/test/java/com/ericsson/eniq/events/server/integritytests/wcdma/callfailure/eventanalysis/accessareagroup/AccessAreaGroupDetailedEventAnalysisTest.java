...
import static com.ericsson.eniq.events.server.test.temptables.TempTableNames.TEMP_GROUP_TYPE_E_RAT_VEND_HIER321_CELL;
...
import com.ericsson.eniq.events.server.test.queryresults.WCDMACallFailureNetworkCellGroupDEAResult;
 ...
 *
 */
public class AccessAreaGroupDetailedEventAnalysisTest extends
        BaseDataIntegrityTest<WCDMACallFailureNetworkCellGroupDEAResult> {
    ...
    public void testFiveMinuteQuery() throws URISyntaxException, Exception {
        ...
        requestParameters.add(GROUP_NAME_PARAM, groupName);
    ...
    */
    private void verifyResult(final String json) throws Exception {
        ...
        validateAgainstGridDefinition(json, "NETWORK_DETAILED_EVENT_ANALYSIS_WCDMA_CFA_CELL_GROUP_CALL_DROPS");
        validateAgainstGridDefinition(json, "NETWORK_DETAILED_EVENT_ANALYSIS_WCDMA_CFA_CELL_GROUP_CALL_SETUP");
        final List<WCDMACallFailureNetworkCellGroupDEAResult> results = getTranslator().translateResult(json,
                WCDMACallFailureNetworkCellGroupDEAResult.class);

        assertThat(results.size(), is(4));
        for (final WCDMACallFailureNetworkCellGroupDEAResult result : results) {
    ...
    */
    ...
    /**
    * The columns in th eAccessArea Group Column
    * @return
    */
    ...
    */
    private void insertDataIntoGroupTables() throws Exception {
        ...
        valuesForTable.put(HIER3_CELL_ID, HASH_ID);
