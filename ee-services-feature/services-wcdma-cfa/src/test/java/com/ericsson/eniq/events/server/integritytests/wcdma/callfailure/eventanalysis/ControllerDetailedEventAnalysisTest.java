...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.CONTROLLER_PARAM;
...
import com.ericsson.eniq.events.server.test.queryresults.WCDMACallFailureNetworkControllerDEAResult;
 ...
 *
 */
public class ControllerDetailedEventAnalysisTest extends
        BaseDataIntegrityTest<WCDMACallFailureNetworkControllerDEAResult> {
    ...
    public void setup() throws Exception {
        ...
        insertresult(SAMPLE_TAC);
        insertresult(SAMPLE_TAC_2);
        //This result should appear in the result set as it is an Exclusive Tac
        insertresult(SAMPLE_EXCLUSIVE_TAC);
    ...
    public void testFiveMinuteQuery() throws URISyntaxException, Exception {
        ...
        requestParameters.add(FAILURE_TYPE_PARAM, "Call Drops");
        requestParameters.add(CONTROLLER_PARAM, "DummyControllerName");

        requestParameters.add(EVENT_ID_PARAM, CALL_DROP_EVENT_ID);
        requestParameters.add(HIER3_ID, HASH_ID);
    ...
    private void verifyResult(final String json) throws Exception {
        ...
        validateAgainstGridDefinition(json, "NETWORK_DETAILED_EVENT_ANALYSIS_WCDMA_CFA_BSC_CALL_DROPS");
        validateAgainstGridDefinition(json, "NETWORK_DETAILED_EVENT_ANALYSIS_WCDMA_CFA_BSC_CALL_SETUP");
        final List<WCDMACallFailureNetworkControllerDEAResult> results = getTranslator().translateResult(json,
                WCDMACallFailureNetworkControllerDEAResult.class);

        assertThat(results.size(), is(2));

        for (final WCDMACallFailureNetworkControllerDEAResult result : results) {
     ...
     * @throws Exception
     */
    private void insertresult(final int tac) throws Exception {
