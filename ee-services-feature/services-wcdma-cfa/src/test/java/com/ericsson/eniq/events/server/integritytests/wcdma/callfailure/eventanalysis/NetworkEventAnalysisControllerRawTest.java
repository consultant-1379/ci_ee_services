 ...
 * 
 */
public class NetworkEventAnalysisControllerRawTest extends BaseDataIntegrityTest<NetworkEventAnalysisResult> {
    ...
    @Test
    public void testNetworkRncData_TotalRab_RAW() throws Exception {
