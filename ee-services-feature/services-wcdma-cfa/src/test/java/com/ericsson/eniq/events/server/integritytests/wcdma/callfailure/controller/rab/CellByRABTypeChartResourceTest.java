 ...
 *
 */
public class CellByRABTypeChartResourceTest extends BaseDataIntegrityTest<RABTypeChartResourceResult> {

    private CellByRABTypeChartResource cellByRABType;
    ...
    public void setUp() throws Exception {
        cellByRABType = new CellByRABTypeChartResource();
        attachDependencies(cellByRABType);
    ...
    @Test
    public void testNetworkCellData_Raw() throws Exception {
        ...
        final String json = runQuery(cellByRABType, requestParameters);
