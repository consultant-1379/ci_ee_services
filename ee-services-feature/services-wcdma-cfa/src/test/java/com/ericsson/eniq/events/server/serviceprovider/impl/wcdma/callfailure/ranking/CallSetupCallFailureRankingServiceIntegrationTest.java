...
public class CallSetupCallFailureRankingServiceIntegrationTest extends BaseServiceIntegrationTest {

    private CallSetupCallFailureRankingService service;

    @Before
    public void init() {
        service = new CallSetupCallFailureRankingService();
        attachDependencies(service);
    }

    @Test
    public void testCallSetupFailureRanking_FiveMin() {
        runQuery(FIVE_MINUTES);
    }

    @Test
    public void testCallSetupFailureRanking_OneWeek() {
        runQuery(ONE_WEEK);
    }
