...
public class SubscriberCallSetupFailureRankingServiceIntegrationTest extends BaseServiceIntegrationTest {

    private SubscriberCallSetupFailureRankingService service;

    @Before
    public void init() {
        service = new SubscriberCallSetupFailureRankingService();
