 ...
 *
 */
public class RNCByRABDescChartResourceTest extends BaseDataIntegrityTest<RABDescriptionChartResourceResult> {

    private static final String TEMP_EVENT_E_RAN_CFA_ERR_RAW = "#EVENT_E_RAN_CFA_ERR_RAW";

    private static final String TEMP_EVENT_E_RAN_CFA_HIER3_EVENTID_RABTYPE_ERR_15MIN = "#EVENT_E_RAN_CFA_HIER3_EVENTID_RABTYPE_ERR_15MIN";

    private static final String TEMP_DIM_E_RAN_RABTYPE = "#DIM_E_RAN_RABTYPE";

    private RNCByRABDescChartResource rncByRABDescChartResource;

    @Before
    public void setUp() throws Exception {
        rncByRABDescChartResource = new RNCByRABDescChartResource();
        attachDependencies(rncByRABDescChartResource);
    ...
    @Test
    public void testNetworkRncData_CS_Raw() throws Exception {
        ...
        final String json = runQuery(rncByRABDescChartResource, requestParameters);
    ...
    @Test
    public void testNetworkRncData_CS_Agg() throws Exception {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        requestParameters.putSingle(TIME_FROM_QUERY_PARAM, "2354");
    ...
    private void populateData() throws SQLException {
        ...
        insertRow(TEMP_EVENT_E_RAN_CFA_HIER3_EVENTID_RABTYPE_ERR_15MIN, new HashMap<String, Object>() {
            {
                put("HIER3_ID", "1234567890123");
                put("EVENT_ID", 438);
                put("FAILED_RAB_TYPE", 2);
    ...
    private void createCfaRawTableSchema() throws SQLException {
        ...
        createTemporaryTable(TEMP_EVENT_E_RAN_CFA_HIER3_EVENTID_RABTYPE_ERR_15MIN, errAggTableSchema);
    }
}
