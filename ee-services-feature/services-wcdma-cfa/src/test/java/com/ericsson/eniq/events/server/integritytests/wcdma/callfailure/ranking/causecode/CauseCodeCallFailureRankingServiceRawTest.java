 ...
 * 
 */
public class CauseCodeCallFailureRankingServiceRawTest extends BaseDataIntegrityTest<CauseCodeCallFailureRankingResult> {
    ...
    @Test
    public void testGetData_CauseCode_CallFailure_Raw() throws Exception {
        ...
        final String json = runQuery(causeCodeCallFailureService, requestParameters);
        System.out.println(json);
        verifyResult(json);
    }

    @Test
    public void testGetData_CauseCode_CallDrop_Raw() throws Exception {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        requestParameters.putSingle(TIME_QUERY_PARAM, FIVE_MINUTES);
        requestParameters.putSingle(TZ_OFFSET, TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
        requestParameters.putSingle(DISPLAY_PARAM, GRID_PARAM);
