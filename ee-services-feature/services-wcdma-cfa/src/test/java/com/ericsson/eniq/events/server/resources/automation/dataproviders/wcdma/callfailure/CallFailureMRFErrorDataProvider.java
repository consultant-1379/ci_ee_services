...
public class CallFailureMRFErrorDataProvider {

    public static Object[] provideTestData() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(RNCID, "1").add(CELL_ID, "1").add(IMSI_PARAM, "123456789012345").add(CAUSE_VALUE, "1")
                .add(EXTENDED_CAUSE_VALUE, "2").add(TIME_QUERY_PARAM, THIRTY_MINUTES)
