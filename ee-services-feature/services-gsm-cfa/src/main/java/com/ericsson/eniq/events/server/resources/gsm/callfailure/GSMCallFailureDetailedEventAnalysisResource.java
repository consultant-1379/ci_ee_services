...
public class GSMCallFailureDetailedEventAnalysisResource extends AbstractResource {
    ...
    private static final String GSM_SUBSRIBER_DETAILED_EVENT_ANALYSIS_SERVICE = "java:global/EniqEventsServices/GSMCallFailureSubscriberDetailedService";

    private static final String GSM_TERMINAL_DETAILED_EVENT_ANALYSIS_SERVICE = "TerminalDetailedService";

    //    private static final String GSM_CSF_SUBSRIBER_DETAILED_EVENT_ANALYSIS_SERVICE = "SubscriberCallSetupFailureDetailedService";
    ...
    @EJB(lookup = GSM_SUBSRIBER_DETAILED_EVENT_ANALYSIS_SERVICE)
    ...
    /*@EJB(beanName = GSM_CSF_SUBSRIBER_DETAILED_EVENT_ANALYSIS_SERVICE)
    private Service gsmCallSetupFailureSubscriberDetailedEventAnalysisService;*/
