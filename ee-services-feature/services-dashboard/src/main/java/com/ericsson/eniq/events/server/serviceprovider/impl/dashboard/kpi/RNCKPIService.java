...
public class RNCKPIService extends AbstractKPIService {
    ...
    public String getData(final MultivaluedMap<String, String> serviceProviderParameters) {
        ...
        try {
            ...
            final NodeQueryKPIDataType nodeQueryKPIDataType = nodeQuery.getRNCKPI(rncID, xmlGregorianCalendar);
            ...
            final NodeQueryKPIDataType nodeQueryKPIDataTypePreviousDay = nodeQuery.getRNCKPI(rncID, xmlGregorianCalendarPreviousDay);
