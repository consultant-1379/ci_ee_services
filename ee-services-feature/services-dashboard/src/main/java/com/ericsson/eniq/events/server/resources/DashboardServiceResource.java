...
import com.ericsson.eniq.events.server.resources.dashboard.AccessAreaResource;
import com.ericsson.eniq.events.server.resources.dashboard.DashboardKPIResource;
import com.ericsson.eniq.events.server.resources.dashboard.DashboardReportsResource;
import com.ericsson.eniq.events.server.resources.dashboard.HomerRoamerResource;
import com.ericsson.eniq.events.server.resources.dashboard.NetworkResource;
import com.ericsson.eniq.events.server.resources.dashboard.TerminalResource;

/**
 * The Class DashboardServiceResource.
