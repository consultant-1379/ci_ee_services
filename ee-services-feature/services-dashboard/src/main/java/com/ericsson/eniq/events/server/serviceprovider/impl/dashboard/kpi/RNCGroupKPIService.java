...
public class RNCGroupKPIService extends AbstractKPIService {
    ...
    public String getData(final MultivaluedMap<String, String> serviceProviderParameters) {
        ...
        try {
            ...
            final NodeQueryKPIDataType nodeQueryKPIDataType = nodeQuery.getRNCKPI(rncNames, xmlGregorianCalendar);
            ...
            final NodeQueryKPIDataType nodeQueryKPIDataTypePreviousDay = nodeQuery.getRNCKPI(rncNames, xmlGregorianCalendarPreviousDay);
