...
public class KPIAnalysisBySGSNGroupTest extends BaseKPIAnalysisTest {
    ...
    public void testGetKPIRawDataWhenOnlyOneSuccessEventExists() throws Exception {
        ...
        final String json = getData(FIVE_MINUTES);
    ...
    @Test
    public void testGetKPIAggregatedDataWhenManyEventsExistWithDataTiering() throws Exception {
        jndiProperties.setUpDataTieringJNDIProperty();
        String dateTime = populateRawTemporaryTablesWithManyEvents(getNumberOfMinutesAgoForRawEvents());
        dateTime = alignToPrevious15MinRop(dateTime);
        populateAggregatedTemporaryTablesWithManyEvents(dateTime);
        final String json = getData(THIRTY_MINUTES);
    ...
    public void testGetKPIAggregatedDataWhenOnlyOneSuccessEventExists() throws Exception {
        ...
        populateAggregatedTemporaryTablesWithJustOneSuccessAndOneFailEvent(dateTime);
        final String json = getData(THIRTY_MINUTES);
