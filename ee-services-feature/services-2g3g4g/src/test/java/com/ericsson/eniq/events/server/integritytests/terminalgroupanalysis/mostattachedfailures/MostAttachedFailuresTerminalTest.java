...
public class MostAttachedFailuresTerminalTest extends
    ...
    private void validateResult(final String result) throws Exception {
        ...
        assertThat(worstTac.getNoErrors(), is(MostAttachedFailuresTablesPopulator.noErrorsForWorstTac * 2));
        ...
        assertThat(secondWorstTac.getNoErrors(), is(MostAttachedFailuresTablesPopulator.noErrorsForSecondWorstTac));
