...
public class CauseCodeAnalysisResourceSummaryRawTest extends TestsWithTemporaryTablesBaseTestCase<CauseCodeAnalysisSummaryResult> {
    ...
    public void testGetSummaryData_CauseCode_APN() throws Exception {
        ...
        makeAssertions(summaryResult);

    }

    /**
     * makes all the assertions necessary for the integrity test
     * 
     * @param summaryResult
     *            the result from the database query
     */
    private void makeAssertions(final List<CauseCodeAnalysisSummaryResult> summaryResult) {
        ...
        assertThat(firstResult.getSubCauseCodeHelp(), is(""));
