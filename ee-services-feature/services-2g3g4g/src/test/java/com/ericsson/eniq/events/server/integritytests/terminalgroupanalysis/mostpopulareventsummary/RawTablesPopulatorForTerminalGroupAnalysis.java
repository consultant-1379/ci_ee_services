...
import static com.ericsson.eniq.events.server.test.temptables.TempTableNames.TEMP_EVENT_E_SGEH_MANUF_TAC_SUC_15MIN;
...
public class RawTablesPopulatorForTerminalGroupAnalysis {
    ...
    public void populateTemporaryTables(final String timeStamp) throws SQLException {
        ...
        insertRowIntoAggTable(TEMP_EVENT_E_SGEH_MANUF_TAC_SUC_15MIN, MOST_POPULAR_TAC, 0, noSuccessesForMostPopularTac,
                timeStamp);
        insertRowIntoAggTable(TEMP_EVENT_E_LTE_MANUF_TAC_SUC_15MIN, SECOND_MOST_POPULAR_TAC, 0,
                noSuccessesForMostPopularTac, timeStamp);
    }
    ...
    private void insertRowIntoRawTable(final String table, final int tac, final int imsi, final String timeStamp)
            throws SQLException {
