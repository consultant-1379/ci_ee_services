...
public class LTECFATerminalRankingServiceIntegrationTest extends ServiceBaseTest {
    @Resource(name = "lteCallFailureTerminalCallDropRankingService")
    private LTECFATerminalCallDropRankingService lteCallFailureTerminalCallDropRankingService;

    @Resource(name = "lteCallFailureTerminalCallSetupRankingService")
    ...
    public void testCallDropGetData(final MultivaluedMap<String, String> requestParameters) {
        runQuery(requestParameters, lteCallFailureTerminalCallDropRankingService);
    }

    @Test
    @Parameters(source = LTECFATerminalRankingDataProvider.class)
    public void testCallSetupGetData(final MultivaluedMap<String, String> requestParameters) {
        runQuery(requestParameters, lteCallFailureTerminalCallSetupRankingService);
    }
}
