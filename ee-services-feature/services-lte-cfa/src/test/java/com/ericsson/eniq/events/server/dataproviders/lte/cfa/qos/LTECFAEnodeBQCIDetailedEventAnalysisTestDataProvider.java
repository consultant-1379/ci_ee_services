 ...
 *
 */
public class LTECFAEnodeBQCIDetailedEventAnalysisTestDataProvider {
    private LTECFAEnodeBQCIDetailedEventAnalysisTestDataProvider() {
    }
    ...
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(HIER3_ID, TEST_VALUE_LTE_CFA_HIER3_ID)
