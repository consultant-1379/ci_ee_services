 ...
 *
 */
public class LTECFAEcellGroupEventVolumeAggTest extends BaseDataIntegrityTest<LTECFANodeEventVolumeResult> {
    ...
    private void insertData(final long hier321ID, final String tableName, final String eventTime) throws SQLException {
        ...
        insertEvent(hier321ID, tableName, eventTime, INTERNAL_PROC_INITIAL_CTXT_SETUP, 3);
        insertEvent(hier321ID, tableName, eventTime, INTERNAL_PROC_UE_CTXT_RELEASE, 2);
        insertEvent(hier321ID, tableName, eventTime, INTERNAL_PROC_RRC_CONN_SETUP, 2);
        insertEvent(hier321ID, tableName, eventTime, INTERNAL_PROC_ERAB_SETUP, 2);
        insertEvent(hier321ID, tableName, eventTime, INTERNAL_PROC_S1_SIG_CONN_SETUP, 2);

    }

    private void insertEvent(final long hier321ID, final String tableName, final String dt, final String eventID,
    ...
    public void testNetworkEventVolume15MIN() throws Exception {
        insertData(TEST_VALUE_HIER321_ID_1, TEMP_EVENT_E_LTE_CFA_HIER321_EVENTID_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertData(TEST_VALUE_HIER321_ID_1, TEMP_EVENT_E_LTE_CFA_HIER321_EVENTID_ERR_15MIN, DATETIME_ID_15MIN_2);

        insertData(TEST_VALUE_HIER321_ID_2, TEMP_EVENT_E_LTE_CFA_HIER321_EVENTID_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertData(TEST_VALUE_HIER321_ID_2, TEMP_EVENT_E_LTE_CFA_HIER321_EVENTID_ERR_15MIN, DATETIME_ID_15MIN_2);
    ...
    public void testNetworkEventVolumeDay() throws Exception {
        insertData(TEST_VALUE_HIER321_ID_1, TEMP_EVENT_E_LTE_CFA_HIER321_EVENTID_ERR_DAY, DATETIME_ID_DAY_1);
        insertData(TEST_VALUE_HIER321_ID_1, TEMP_EVENT_E_LTE_CFA_HIER321_EVENTID_ERR_DAY, DATETIME_ID_DAY_2);

        insertData(TEST_VALUE_HIER321_ID_2, TEMP_EVENT_E_LTE_CFA_HIER321_EVENTID_ERR_DAY, DATETIME_ID_DAY_1);
        insertData(TEST_VALUE_HIER321_ID_2, TEMP_EVENT_E_LTE_CFA_HIER321_EVENTID_ERR_DAY, DATETIME_ID_DAY_2);
