 ...
 *
 */
public class LTECFATracAreaQCIDetailEventAnalysisRawTest extends
        BaseDataIntegrityTest<LTECallFailureSubscriberERABDrilldownSetupResult> {
    LTECFATrackingAreaQCIDetailedEventAnalysisService lteCallFailureTrackingAreaQCIDetailedEventAnalysisService;
    ...
    public void onSetUp() throws Exception {
        lteCallFailureTrackingAreaQCIDetailedEventAnalysisService = new LTECFATrackingAreaQCIDetailedEventAnalysisService();
        attachDependencies(lteCallFailureTrackingAreaQCIDetailedEventAnalysisService);
    ...
    private void insertData(final String eventID, final String time, final int instances, final String qciID,
            final String hier3ID, final String hier321ID, final String trac) throws SQLException {
    ...
    private String getJsonResult(final String eventId) {
        ...
        return runQuery(lteCallFailureTrackingAreaQCIDetailedEventAnalysisService, requestParameters);
    }
    ...
    @Test
    public void testQCITrackingAreaDetailedAnalysisDrillDownEventIDSetup_Raw() throws Exception {

        insertData(INTERNAL_PROC_INITIAL_CTXT_SETUP, DATETIME_ID_RAW, 2, TEST_VALUE_QCI_ID_1, TEST_VALUE_HIER3_ID_1,
                TEST_VALUE_HIER321_ID_1, TEST_VALUE_TRAC_1);
        ...
        final List<LTECallFailureSubscriberERABDrilldownSetupResult> results = rt.translateResult(json,
                LTECallFailureSubscriberERABDrilldownSetupResult.class);
        assertThat(results.size(), is(2));
    }

    @Test
    public void testQCITrackingAreaDetailedAnalysisDrillDownEventIDRelease() throws Exception {
    ...
    @Test
    public void testQCITrackingAreaDetailedAnalysisDrillDownEventIDSetupRawGroup() throws Exception {
        ...
        insertData(INTERNAL_PROC_INITIAL_CTXT_SETUP, DATETIME_ID_RAW, 2, TEST_VALUE_QCI_ID_1, TEST_VALUE_HIER3_ID_2,
                TEST_VALUE_HIER321_ID_2, TEST_VALUE_TRAC_2);
    ...
    @Test
    public void testQCITrackingAreaDetailedAnalysisDrillDownEventIDReleaseRawGroup() throws Exception {
