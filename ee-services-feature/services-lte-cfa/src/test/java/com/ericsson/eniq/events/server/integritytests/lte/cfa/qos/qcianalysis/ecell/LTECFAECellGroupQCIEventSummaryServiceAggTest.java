...
import com.ericsson.eniq.events.server.test.queryresults.lte.callfailure.qos.LTECallFailureQOSECellGroupQCIEventSummaryResult;
 ...
 *
 */
public class LTECFAECellGroupQCIEventSummaryServiceAggTest extends
        BaseDataIntegrityTest<LTECallFailureQOSECellGroupQCIEventSummaryResult> {
    ...
    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);
    }
    ...
    @Test
    public void testECellGroupQCIEventSummary15MinAggCallDrop() throws Exception {
        ...
        final ResultTranslator<LTECallFailureQOSECellGroupQCIEventSummaryResult> rt = getTranslator();
        final List<LTECallFailureQOSECellGroupQCIEventSummaryResult> eventResult = rt.translateResult(json,
                LTECallFailureQOSECellGroupQCIEventSummaryResult.class);
        assertThat(eventResult.size(), is(1));
    }

    @Test
    public void testECellGroupQCIEventSummary15MinAggCallSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER321_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER321_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_2);
    ...
    @Test
    public void testECellGroupQCIEventSummaryDayAggCalLDrop() throws Exception {
    ...
    @Test
    public void testECellGroupQCIEventSummaryDayAggCalLSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER321_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER321_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_2);
