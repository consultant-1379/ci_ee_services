 ...
 *
 */
public class LTECFATracGroupCCPieDrilldownTestDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(GROUP_NAME_PARAM, "temp").add(EVENT_ID_PARAM, "4097", "4098", "4106", "4125")
                .add(TYPE_PARAM, TYPE_TRAC).build();
