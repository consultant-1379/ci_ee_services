 ...
 * @since 2011
 */
public class LTECFATrackingAreaGroupDetailedEventAnalysisTestDataProvider {
    public static Object[] provideTestData() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(GROUP_NAME_PARAM, "trackingGroup1")
                .add(EVENT_ID_PARAM, INTERNAL_PROC_RRC_CONN_SETUP, INTERNAL_PROC_S1_SIG_CONN_SETUP,
                        INTERNAL_PROC_ERAB_SETUP, INTERNAL_PROC_INITIAL_CTXT_SETUP, INTERNAL_PROC_UE_CTXT_RELEASE)
                .build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
    }

    private LTECFATrackingAreaGroupDetailedEventAnalysisTestDataProvider() {
    }
}
