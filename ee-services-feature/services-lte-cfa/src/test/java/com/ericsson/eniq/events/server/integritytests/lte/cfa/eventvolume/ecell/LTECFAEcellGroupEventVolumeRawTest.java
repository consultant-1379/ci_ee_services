 ...
 *
 */
public class LTECFAEcellGroupEventVolumeRawTest extends BaseDataIntegrityTest<LTECFANodeEventVolumeResult> {
    ...
    private void insertData(final long hier321ID, final String eventTime) throws SQLException {
        ...
        insertEvent(hier321ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_INITIAL_CTXT_SETUP, 3);
        insertEvent(hier321ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_UE_CTXT_RELEASE, 2);
        insertEvent(hier321ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_RRC_CONN_SETUP, 2);
        insertEvent(hier321ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_ERAB_SETUP, 2);
        insertEvent(hier321ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_S1_SIG_CONN_SETUP, 2);

        insertEvent(hier321ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_INITIAL_CTXT_SETUP, 3);
        insertEvent(hier321ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_UE_CTXT_RELEASE, 2);
        insertEvent(hier321ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_RRC_CONN_SETUP, 2);
        insertEvent(hier321ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_ERAB_SETUP, 2);
        insertEvent(hier321ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_S1_SIG_CONN_SETUP, 2);
    }
