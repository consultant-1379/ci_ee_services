...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.causecodeanalysis.LTECFAEnodeBCauseCodeDetailedEAService;
 ...
 *
 */
public class LTECFAEnodeBCauseCodeDetailedAnalysisServiceRawTest extends
    ...
    public void onSetUp() throws Exception {
        lteCallFailureEnodeBCauseCodeDetailedEventAnalysisService = new LTECFAEnodeBCauseCodeDetailedEAService();
        attachDependencies(lteCallFailureEnodeBCauseCodeDetailedEventAnalysisService);
    ...
    private String getJsonResult(final String eventId) {
        ...
        return runQuery(lteCallFailureEnodeBCauseCodeDetailedEventAnalysisService, requestParameters);
    }
    ...
    @Test
    public void testEnodeBCauseCodeAnalysisDetailedRrcConnSetupEvent_Raw() throws Exception {
    ...
    @Test
    public void testEnodeBCauseCodeAnalysisDetailedS1SigSetupEvent_Raw() throws Exception {
    ...
    @Test
    public void testEnodeBCauseCodeAnalysisDetailedInitialCxtSetupEvent_Raw() throws Exception {
    ...
    @Test
    public void testEnodeBCauseCodeAnalysisDetailedUeCxtReleaseEvent_Raw() throws Exception {
    ...
    @Test
    public void testEnodeBCauseCodeAnalysisDetailedRrcConnSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testEnodeBCauseCodeAnalysisDetailedS1SigSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testEnodeBCauseCodeAnalysisDetailedInitialCxtSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testEnodeBCauseCodeAnalysisDetailedUeCxtReleaseEvent_RawGrp() throws Exception {
