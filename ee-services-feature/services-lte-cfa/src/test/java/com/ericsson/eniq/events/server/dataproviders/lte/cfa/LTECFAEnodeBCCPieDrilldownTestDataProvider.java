 ...
 *
 */
public class LTECFAEnodeBCCPieDrilldownTestDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(NODE_PARAM, TEST_VALUE_ENODEB_NODE).add(EVENT_ID_PARAM, "4097", "4098", "4106", "4125")
                .add(CAUSE_CODE_PARAM, "0").add(TYPE_PARAM, TYPE_BSC).build();
