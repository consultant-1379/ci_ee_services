 ...
 *
 */
public class LTECFACauseCodeCallDropRankingServiceRawTest extends
    ...
    private void insertData() throws SQLException {
        ...
        insertTopoData(TEST_VALUE_CAUSE_CODE_ID_2, TEST_VALUE_CAUSE_CODE_DESC_2, INTERNAL_PROC_RRC_CONN_SETUP);
        insertTopoData(TEST_VALUE_CAUSE_CODE_ID_3, TEST_VALUE_CAUSE_CODE_DESC_3, INTERNAL_PROC_S1_SIG_CONN_SETUP);
        insertTopoData(TEST_VALUE_CAUSE_CODE_ID_4, TEST_VALUE_CAUSE_CODE_DESC_4, INTERNAL_PROC_UE_CTXT_RELEASE);
        ...
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, LTE_CALL_DROP_CATEGORY_ID,
                dateTime, 4);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_2, INTERNAL_PROC_RRC_CONN_SETUP,
                LTE_CALL_SETUP_FAILURE_CATEGORY_ID, dateTime, 3);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_3, INTERNAL_PROC_S1_SIG_CONN_SETUP,
                LTE_CALL_SETUP_FAILURE_CATEGORY_ID, dateTime, 2);
        insertEventWithCauseCode(TEST_VALUE_CAUSE_CODE_ID_4, INTERNAL_PROC_UE_CTXT_RELEASE, LTE_CALL_DROP_CATEGORY_ID,
                dateTime, 1);
    }
    ...
    public void testGetLTECFACauseCodeCallDropRankingData() throws Exception {
        ...
        final String json = runQuery(lteCallFailureCauseCodeCallDropRankingService, requestParameters);
    ...
    private void assertResult(final List<LTECallFailureCauseCodeRankingResults> rankingResult) {
        ...
        assertThat(result2.getCauseCodeID(), is(TEST_VALUE_CAUSE_CODE_ID_4));
        assertThat(result2.getCauseCodeDesc(), is(TEST_VALUE_CAUSE_CODE_DESC_4));
        assertThat(result2.getRank(), is(2));
        assertThat(result2.getFailures(), is(1));
    }
}
