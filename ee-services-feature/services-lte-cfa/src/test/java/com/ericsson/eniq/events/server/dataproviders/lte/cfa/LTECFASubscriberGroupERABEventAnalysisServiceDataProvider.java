 ...
 * @since 2011
 */
public class LTECFASubscriberGroupERABEventAnalysisServiceDataProvider {
    ...
    private static final String TEST_VALUE_GROUP_NAME = "testGroup";

    private static final String TEST_VALUE_TAC = "55840581";

    private LTECFASubscriberGroupERABEventAnalysisServiceDataProvider() {
    }
    ...
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(EVENT_ID_PARAM, INTERNAL_PROC_ERAB_SETUP, INTERNAL_PROC_INITIAL_CTXT_SETUP,
                        INTERNAL_PROC_UE_CTXT_RELEASE).add(GROUP_NAME_PARAM, TEST_VALUE_GROUP_NAME)
                .add(TAC, TEST_VALUE_TAC).build();
