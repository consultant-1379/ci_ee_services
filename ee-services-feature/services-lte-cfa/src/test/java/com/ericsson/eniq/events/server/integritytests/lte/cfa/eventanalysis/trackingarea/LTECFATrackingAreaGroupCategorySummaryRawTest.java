...
import com.ericsson.eniq.events.server.test.queryresults.lte.callfailure.LTECallFailureTrackingAreaGroupCategorySummaryResult;
 ...
 *
 */
public class LTECFATrackingAreaGroupCategorySummaryRawTest extends
        BaseDataIntegrityTest<LTECallFailureTrackingAreaGroupCategorySummaryResult> {
    ...
    private void insertRawData() throws Exception {
        insertData(TEST_VALUE_TRAC_1, TEST_VALUE_CATEGORY_ID_CALL_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TRAC_1, TEST_VALUE_CATEGORY_ID_CALL_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TRAC_2, TEST_VALUE_CATEGORY_ID_CALL_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TRAC_2, TEST_VALUE_CATEGORY_ID_CALL_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
        ...
        insertData(TEST_VALUE_TRAC_1, TEST_VALUE_CATEGORY_ID_CALL_DROP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TRAC_1, TEST_VALUE_CATEGORY_ID_CALL_DROP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TRAC_2, TEST_VALUE_CATEGORY_ID_CALL_DROP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TRAC_2, TEST_VALUE_CATEGORY_ID_CALL_DROP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    public void testTrackingAreaGroupEventSummary() throws Exception {
        ...
        final ResultTranslator<LTECallFailureTrackingAreaGroupCategorySummaryResult> rt = getTranslator();
        final List<LTECallFailureTrackingAreaGroupCategorySummaryResult> eventResult = rt.translateResult(json,
                LTECallFailureTrackingAreaGroupCategorySummaryResult.class);
        assertResult(eventResult);
    }

    private void assertResult(final List<LTECallFailureTrackingAreaGroupCategorySummaryResult> results) {
        assertThat(results.size(), is(2));
        for (final LTECallFailureTrackingAreaGroupCategorySummaryResult rs : results) {
