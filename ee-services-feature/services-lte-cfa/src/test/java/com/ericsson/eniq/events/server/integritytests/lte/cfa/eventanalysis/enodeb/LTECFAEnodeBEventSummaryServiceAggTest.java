 ...
 *
 */
public class LTECFAEnodeBEventSummaryServiceAggTest extends
    ...
    private void insertAggDataDay() throws Exception {
        insertDataAgg(TEMP_EVENT_E_LTE_CFA_HIER3_EVENTID_ERR_DAY, TEST_VALUE_HIER3_ID, INTERNAL_PROC_RRC_CONN_SETUP,
                TEST_VALUE_CATEGORY_ID_CALL_SETUP, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_CFA_HIER3_EVENTID_ERR_DAY, TEST_VALUE_HIER3_ID, INTERNAL_PROC_S1_SIG_CONN_SETUP,
                TEST_VALUE_CATEGORY_ID_CALL_SETUP, DATETIME_ID_DAY_1, 1, 20);
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_CFA_HIER3_EVENTID_ERR_DAY, TEST_VALUE_HIER3_ID, INTERNAL_PROC_ERAB_SETUP,
                TEST_VALUE_CATEGORY_ID_CALL_SETUP, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_CFA_HIER3_EVENTID_ERR_DAY, TEST_VALUE_HIER3_ID, INTERNAL_PROC_UE_CTXT_RELEASE,
    ...
    private void insertAggData15Min() throws Exception {
        insertDataAgg(TEMP_EVENT_E_LTE_CFA_HIER3_EVENTID_ERR_15MIN, TEST_VALUE_HIER3_ID, INTERNAL_PROC_RRC_CONN_SETUP,
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_CFA_HIER3_EVENTID_ERR_15MIN, TEST_VALUE_HIER3_ID, INTERNAL_PROC_ERAB_SETUP,
                TEST_VALUE_CATEGORY_ID_CALL_SETUP, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_CFA_HIER3_EVENTID_ERR_15MIN, TEST_VALUE_HIER3_ID, INTERNAL_PROC_UE_CTXT_RELEASE,
    ...
    @Test
    public void testEnodeBEventSummaryCallSetupDay() throws Exception {
        insertAggDataDay();
    ...
    @Test
    public void testEnodeBEventSummaryCallSetup15min() throws Exception {
        insertAggData15Min();
    ...
    @Test
    public void testEnodeBEventSummaryCallDropDay() throws Exception {
        insertAggDataDay();
    ...
    @Test
    public void testEnodeBEventSummaryCallDrop15min() throws Exception {
        insertAggData15Min();
    ...
    private void assertResultDay(final List<LTECallFailureEnodeBEventSummaryResultRaw> results) {
