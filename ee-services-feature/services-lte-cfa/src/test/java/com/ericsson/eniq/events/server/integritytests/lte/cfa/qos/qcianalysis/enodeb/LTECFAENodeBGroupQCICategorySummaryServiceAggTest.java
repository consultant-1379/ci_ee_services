 ...
 *
 */
public class LTECFAENodeBGroupQCICategorySummaryServiceAggTest extends
    ...
    private void createTable() throws Exception {
        ...
        columnsForTable.add(HIER3_ID);
        columnsForTable.add(DATETIME_ID);
        createTemporaryTable(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_15MIN, columnsForTable);
        createTemporaryTable(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_DAY, columnsForTable);
    ...
    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_1, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_2, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_3, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_1, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_2, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_3, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);
    }
    ...
    public void testENodeBGroupQCICategorySummary15MinAgg() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_2);
    ...
    public void testENodeBGroupQCICategorySummaryDayAgg() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_2);
