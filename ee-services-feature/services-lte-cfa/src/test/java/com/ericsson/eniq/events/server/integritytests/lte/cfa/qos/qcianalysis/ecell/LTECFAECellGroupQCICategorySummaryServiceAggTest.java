 ...
 *
 */
public class LTECFAECellGroupQCICategorySummaryServiceAggTest extends
    ...
    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);
    }
