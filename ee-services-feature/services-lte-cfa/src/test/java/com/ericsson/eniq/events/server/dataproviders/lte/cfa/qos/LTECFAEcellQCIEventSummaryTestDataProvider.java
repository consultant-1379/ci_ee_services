 ...
 *
 */
public class LTECFAEcellQCIEventSummaryTestDataProvider {

    private LTECFAEcellQCIEventSummaryTestDataProvider() {
    }
    ...
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(HIER321_ID, TEST_VALUE_LTE_CFA_HIER321_ID).build();
