 ...
 *
 */
public class LTECFASubscriberCallSetupRankingServiceAggTest extends
    ...
    private String getJson(final String timerange) {
        ...
        return runQuery(lteCallFailureSubscriberCallSetupFailureRankingService, requestParameters);
    }
