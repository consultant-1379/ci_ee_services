...
import com.ericsson.eniq.events.server.test.queryresults.lte.callfailure.qos.LTECallFailureQOSTrackingAreaGroupQCIEventSummaryResult;
 ...
 *
 */
public class LTECFATracAreaGroupQCIEventSummaryAggTest extends
        BaseDataIntegrityTest<LTECallFailureQOSTrackingAreaGroupQCIEventSummaryResult> {
    ...
    private void insertData(final int trac, final int tac, final int categoryID, final String eventID,
    ...
    private void insertAggData(final String aggTable, final int trac, final int categoryID, final String eventID,
    ...
    private void insertDataForAggTest(final int trac, final int categoryID, final String eventID, final int instances,
            final String dateTimeID, final String aggTable) throws SQLException {
        insertData(trac, SAMPLE_TAC, categoryID, eventID, dateTimeID, instances, TEST_VALUE_IMSI_1);
        insertData(trac, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), categoryID, eventID, dateTimeID, instances,
                TEST_VALUE_IMSI_1);
        insertData(trac, SAMPLE_TAC, categoryID, eventID, dateTimeID, instances, TEST_VALUE_IMSI_2);
        insertData(trac, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), categoryID, eventID, dateTimeID, instances,
                TEST_VALUE_IMSI_2);
        insertAggData(aggTable, trac, categoryID, eventID, dateTimeID, instances);
    }

    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTest(TEST_VALUE_TRAC_ID_1, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_TRAC_ID_1, CATEGORY_ID_CALL_SETUP, EventIDConstants.INTERNAL_PROC_ERAB_SETUP,
                2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_TRAC_ID_1, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_TRAC_ID_2, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_TRAC_ID_2, CATEGORY_ID_CALL_SETUP, EventIDConstants.INTERNAL_PROC_ERAB_SETUP,
                2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_TRAC_ID_2, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);
    }
    ...
    @Test
    public void testTrackingAreaGroupQCIEventSummary15MinAggCallDrop() throws Exception {
        ...
        final ResultTranslator<LTECallFailureQOSTrackingAreaGroupQCIEventSummaryResult> rt = getTranslator();
        final List<LTECallFailureQOSTrackingAreaGroupQCIEventSummaryResult> eventResult = rt.translateResult(json,
                LTECallFailureQOSTrackingAreaGroupQCIEventSummaryResult.class);
        assertThat(eventResult.size(), is(1));
    }

    @Test
    public void testTrackingAreaGroupQCIEventSummary15MinAggCallSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_TRAC_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_TRAC_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_2);
    ...
    @Test
    public void testTrackingAreaGroupQCIEventSummaryDayAggCalLDrop() throws Exception {
    ...
    @Test
    public void testTrackingAreaGroupQCIEventSummaryDayAggCalLSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_TRAC_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_TRAC_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_2);
