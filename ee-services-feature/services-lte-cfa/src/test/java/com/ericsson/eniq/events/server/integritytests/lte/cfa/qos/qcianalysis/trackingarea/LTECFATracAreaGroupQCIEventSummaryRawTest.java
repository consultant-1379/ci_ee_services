 ...
 *
 */
public class LTECFATracAreaGroupQCIEventSummaryRawTest extends
    ...
    private void insertData(final String tac, final int trac, final int categoryID, final String eventID,
    ...
    private void insertRawData() throws Exception {
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_ID_1, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_ID_2, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_ID_1, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_ID_2, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_ID_1, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_ID_2, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_ID_1, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_ID_2, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testTrackingAreaGroupQCIEventSummaryCallDrop() throws Exception {
    ...
    @Test
    public void testTrackingAreaGroupQCIEventSummaryCallSetup() throws Exception {
