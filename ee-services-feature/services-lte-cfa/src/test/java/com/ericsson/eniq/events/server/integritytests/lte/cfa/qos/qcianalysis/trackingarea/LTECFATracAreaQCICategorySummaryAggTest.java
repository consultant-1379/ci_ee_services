 ...
 *
 */
public class LTECFATracAreaQCICategorySummaryAggTest extends
    ...
    private void insertDataForAggTestWithEventID(final int categoryID, final int qciID, final int instances,
        ...
        insertData(Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), categoryID, qciID, dateTimeID, instances,
                TEST_VALUE_IMSI_2);
        insertAggData(aggTable, TEST_VALUE_TRAC, categoryID, qciID, dateTimeID, instances);
    }
    ...
    @Test
    public void testTrackingAreaQCICategorySummary15MinAgg() throws Exception {
    ...
    @Test
    public void testTrackingAreaQCICategorySummaryDayAgg() throws Exception {
