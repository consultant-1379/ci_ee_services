 ...
 *
 */
public class LTECFAEnodeBQCIEventSummaryTestDataProvider {

    private LTECFAEnodeBQCIEventSummaryTestDataProvider() {
    }
    ...
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(HIER3_ID, TEST_VALUE_LTE_CFA_HIER3_ID).build();
