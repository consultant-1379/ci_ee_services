...
public class LTECFATrackingAreaCCListIntegrationTest extends ServiceBaseTest {

    @Resource(name = "lteCallFailureTrackingAreaCauseCodeListService")
    ...
    public void testGetData(final MultivaluedMap<String, String> requestParameters) {
        runQuery(requestParameters, lteCallFailureTrackingAreaCauseCodeListService);
    }
