 ...
 *
 */
public class LTECFATrackingAreaGroupCategorySummaryAggTest extends
    ...
    private void insertDataForAggTestWithEventID(final String categoryID, final int instances, final String dateTimeID,
        ...
        insertData(TEST_VALUE_TRAC_1, categoryID, SAMPLE_TAC, dateTimeID, instances, TEST_VALUE_IMSI_1);
        insertData(TEST_VALUE_TRAC_1, categoryID, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), dateTimeID, instances,
                TEST_VALUE_IMSI_1);
        insertData(TEST_VALUE_TRAC_1, categoryID, SAMPLE_TAC, dateTimeID, instances, TEST_VALUE_IMSI_2);
        insertData(TEST_VALUE_TRAC_1, categoryID, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), dateTimeID, instances,
                TEST_VALUE_IMSI_2);
        insertAggData(aggTable, TEST_VALUE_TRAC_1, categoryID, dateTimeID, instances);
    }
