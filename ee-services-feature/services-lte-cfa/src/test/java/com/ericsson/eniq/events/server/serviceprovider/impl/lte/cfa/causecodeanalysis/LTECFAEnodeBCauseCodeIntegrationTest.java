...
public class LTECFAEnodeBCauseCodeIntegrationTest extends ServiceBaseTest {

    @Resource(name = "lteCallFailureEnodeBCauseCodeEventSummaryService")
    ...
    public void testGetData(final MultivaluedMap<String, String> requestParameters) {
        runQuery(requestParameters, lteCallFailureEnodeBCauseCodeEventSummaryService);
    }
