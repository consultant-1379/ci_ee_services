 ...
 *
 */
public class LTECFATrackingAreaEventVolumeAggTest extends BaseDataIntegrityTest<LTECFANodeEventVolumeResult> {
    ...
    public void testNetworkEventVolume15MIN() throws Exception {
        insertData(TEMP_EVENT_E_LTE_CFA_TRAC_HIER3_EVENTID_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertData(TEMP_EVENT_E_LTE_CFA_TRAC_HIER3_EVENTID_ERR_15MIN, DATETIME_ID_15MIN_2);
    ...
    public void testNetworkEventVolumeDay() throws Exception {
        insertData(TEMP_EVENT_E_LTE_CFA_TRAC_HIER3_EVENTID_ERR_DAY, DATETIME_ID_DAY_1);
        insertData(TEMP_EVENT_E_LTE_CFA_TRAC_HIER3_EVENTID_ERR_DAY, DATETIME_ID_DAY_2);
