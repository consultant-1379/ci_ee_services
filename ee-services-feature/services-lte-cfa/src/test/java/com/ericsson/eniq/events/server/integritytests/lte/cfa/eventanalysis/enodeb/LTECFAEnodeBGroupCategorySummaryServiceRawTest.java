 ...
 *
 */
public class LTECFAEnodeBGroupCategorySummaryServiceRawTest extends
    ...
    private void insertRawData() throws Exception {
        insertData(TEST_VALUE_HIER3_ID_1, TEST_VALUE_CATEGORY_ID_CALL_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_1, TEST_VALUE_CATEGORY_ID_CALL_SETUP,
        ...
        insertData(TEST_VALUE_HIER3_ID_1, TEST_VALUE_CATEGORY_ID_CALL_DROP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_1, TEST_VALUE_CATEGORY_ID_CALL_DROP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_HIER3_ID_2, TEST_VALUE_CATEGORY_ID_CALL_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, TEST_VALUE_CATEGORY_ID_CALL_SETUP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 1);
        ...
        insertData(TEST_VALUE_HIER3_ID_2, TEST_VALUE_CATEGORY_ID_CALL_DROP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, TEST_VALUE_CATEGORY_ID_CALL_DROP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);

    }

    @Test
    public void testEnodeBGroupCategorySummary() throws Exception {
    ...
    private void assertResult(final List<LTECallFailureEnodeBGroupCategorySummaryResultRaw> results) {
