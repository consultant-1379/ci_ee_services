...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.ranking.LTECFAEnodeBCallSetupRankingService;
 ...
 *
 */
public class LTECFAENodeBCallSetupRankingServiceAggTest extends
        BaseDataIntegrityTest<LTECallFailureEnodeBRankingResult> {

    private LTECFAEnodeBCallSetupRankingService lteCallFailureeNodeBCallSetupFailureRankingService;
    ...
    public void onSetUp() throws Exception {
        lteCallFailureeNodeBCallSetupFailureRankingService = new LTECFAEnodeBCallSetupRankingService();
        attachDependencies(lteCallFailureeNodeBCallSetupFailureRankingService);
    ...
    /**
     * @param dateTimeMinus55Minutes
     */
    private void insertEnodeBWithDateTime(final String dateTime) throws SQLException {
        inserteNodeB(TEST_VALUE_HIER3_ID_1, dateTime, INTERNAL_PROC_RRC_CONN_SETUP, LTE_CALL_SETUP_FAILURE_CATEGORY_ID,
                3);
        inserteNodeB(TEST_VALUE_HIER3_ID_1, dateTime, INTERNAL_PROC_S1_SIG_CONN_SETUP,
                LTE_CALL_SETUP_FAILURE_CATEGORY_ID, 3);
        inserteNodeB(TEST_VALUE_HIER3_ID_1, dateTime, INTERNAL_PROC_INITIAL_CTXT_SETUP,
                LTE_CALL_SETUP_FAILURE_CATEGORY_ID, 3);
        inserteNodeB(TEST_VALUE_HIER3_ID_1, dateTime, INTERNAL_PROC_ERAB_SETUP, LTE_CALL_SETUP_FAILURE_CATEGORY_ID, 3);

        inserteNodeB(TEST_VALUE_HIER3_ID_2, dateTime, INTERNAL_PROC_RRC_CONN_SETUP, LTE_CALL_SETUP_FAILURE_CATEGORY_ID,
                2);
        inserteNodeB(TEST_VALUE_HIER3_ID_2, dateTime, INTERNAL_PROC_S1_SIG_CONN_SETUP,
                LTE_CALL_SETUP_FAILURE_CATEGORY_ID, 2);
        inserteNodeB(TEST_VALUE_HIER3_ID_2, dateTime, INTERNAL_PROC_INITIAL_CTXT_SETUP,
                LTE_CALL_SETUP_FAILURE_CATEGORY_ID, 2);
        inserteNodeB(TEST_VALUE_HIER3_ID_2, dateTime, INTERNAL_PROC_ERAB_SETUP, LTE_CALL_SETUP_FAILURE_CATEGORY_ID, 2);

        inserteNodeB(TEST_VALUE_HIER3_ID_3, dateTime, INTERNAL_PROC_RRC_CONN_SETUP, LTE_CALL_SETUP_FAILURE_CATEGORY_ID,
                1);
        inserteNodeB(TEST_VALUE_HIER3_ID_3, dateTime, INTERNAL_PROC_S1_SIG_CONN_SETUP,
                LTE_CALL_SETUP_FAILURE_CATEGORY_ID, 1);
        inserteNodeB(TEST_VALUE_HIER3_ID_3, dateTime, INTERNAL_PROC_INITIAL_CTXT_SETUP,
                LTE_CALL_SETUP_FAILURE_CATEGORY_ID, 1);
        inserteNodeB(TEST_VALUE_HIER3_ID_3, dateTime, INTERNAL_PROC_ERAB_SETUP, LTE_CALL_SETUP_FAILURE_CATEGORY_ID, 1);
    }
    ...
    @Test
    public void testGetLTECFAeNodeBCallSetupFailureRankingDataAgg15MIN() throws Exception {
        ...
        final String json = runQuery(lteCallFailureeNodeBCallSetupFailureRankingService, requestParameters);
    ...
    @Test
    public void testGetLTECFAeNodeBCallSetupFailureRankingDataAggDAY() throws Exception {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        requestParameters.putSingle(DISPLAY_PARAM, GRID);
