...
import static com.ericsson.eniq.events.server.test.common.ApplicationTestConstants.TEST_VALUE_GUMMEI_TYPE;
...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.eventanalysis.LTECFAEnodeBDetailedEventAnalysisService;
 ...
 *
 */
public class LTECFAEnodeBDetailedAnalysisServiceRawTest extends
    ...
    private static final String TEST_VALUE_HIER3_ID_2 = "3135210477467174988";
    ...
    public void onSetUp() throws Exception {
        lteCallFailureEnodeBDetailedEventAnalysisService = new LTECFAEnodeBDetailedEventAnalysisService();
        attachDependencies(lteCallFailureEnodeBDetailedEventAnalysisService);
    ...
    private void insertData(final String hier3Id, final String eventID, final int tac, final String time,
    ...
    private String getJsonResult(final String eventId) {
        ...
        return runQuery(lteCallFailureEnodeBDetailedEventAnalysisService, requestParameters);
    }
    ...
    @Test
    public void testEnodeBAnalysisDetailedRrcConnSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_RRC_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testEnodeBAnalysisDetailedS1SigSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testEnodeBAnalysisDetailedInitialCxtSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testEnodeBAnalysisDetailedErabSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testEnodeBAnalysisDetailedUeCxtReleaseEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, SAMPLE_TAC, DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testEnodeBAnalysisDetailedRrcConnSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testEnodeBAnalysisDetailedS1SigSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testEnodeBAnalysisDetailedInitialCxtSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testEnodeBAnalysisDetailedErabSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testEnodeBAnalysisDetailedUeCxtReleaseEvent_RawGrp() throws Exception {
