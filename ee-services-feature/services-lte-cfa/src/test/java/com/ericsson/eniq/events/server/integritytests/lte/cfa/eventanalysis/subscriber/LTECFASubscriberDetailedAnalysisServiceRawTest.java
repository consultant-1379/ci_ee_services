...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.eventanalysis.LTECFASubscriberDetailedEventAnalysisService;
 ...
 *
 */
public class LTECFASubscriberDetailedAnalysisServiceRawTest extends
    ...
    public void onSetUp() throws Exception {
        lteCallFailureSubscriberDetailedEventAnalysisService = new LTECFASubscriberDetailedEventAnalysisService();
        attachDependencies(lteCallFailureSubscriberDetailedEventAnalysisService);
    ...
    private String getJsonResult(final String eventId) {
        ...
        return runQuery(lteCallFailureSubscriberDetailedEventAnalysisService, requestParameters);
    }
    ...
    @Test
    public void testSubscriberAnalysisDetailedRrcConnSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_RRC_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_RRC_CONN_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testSubscriberAnalysisDetailedS1SigSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testSubscriberAnalysisDetailedInitialCxtSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testSubscriberAnalysisDetailedErabSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testSubscriberAnalysisDetailedUeCxtReleaseEvent_Raw() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_UE_CTXT_RELEASE, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_UE_CTXT_RELEASE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testSubscriberAnalysisDetailedRrcConnSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_RRC_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_RRC_CONN_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_RRC_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_RRC_CONN_SETUP,
    ...
    @Test
    public void testSubscriberAnalysisDetailedS1SigSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_S1_SIG_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_S1_SIG_CONN_SETUP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testSubscriberAnalysisDetailedInitialCxtSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_INITIAL_CTXT_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_INITIAL_CTXT_SETUP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testSubscriberAnalysisDetailedErabSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_ERAB_SETUP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testSubscriberAnalysisDetailedUeCxtReleaseEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_UE_CTXT_RELEASE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_UE_CTXT_RELEASE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_UE_CTXT_RELEASE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(Long.toString(TEST_VALUE_IMSI), INTERNAL_PROC_UE_CTXT_RELEASE,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 1);
