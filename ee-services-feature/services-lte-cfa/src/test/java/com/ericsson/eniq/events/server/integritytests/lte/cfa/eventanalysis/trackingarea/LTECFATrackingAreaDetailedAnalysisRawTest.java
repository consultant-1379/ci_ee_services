...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.eventanalysis.LTECFATrackingAreaDetailedEAService;
 ...
 *
 */
public class LTECFATrackingAreaDetailedAnalysisRawTest extends
        BaseDataIntegrityTest<LTECallFailureSubscriberDetailedAnalysisSetupResult> {
    private LTECFATrackingAreaDetailedEAService lteCallFailureTrackingAreaDetailedEventAnalysisService;
    ...
    private static final String TEST_VALUE_HIER321_ID_1 = "4747612786969905161";
    ...
    private static final String TEST_VALUE_TRACKING_AREA_GROUP = "trackingAreaGroup";
    ...
    public void onSetUp() throws Exception {
        lteCallFailureTrackingAreaDetailedEventAnalysisService = new LTECFATrackingAreaDetailedEAService();
        attachDependencies(lteCallFailureTrackingAreaDetailedEventAnalysisService);
    ...
    private void insertTopoData() throws SQLException {
        ...
        valuesForTable.clear();
        valuesForTable.put(TRAC, TEST_VALUE_TRAC_1);
        valuesForTable.put(GROUP_NAME, TEST_VALUE_TRACKING_AREA_GROUP);
    ...
    private String getJsonResult(final String eventId) {
        ...
        return runQuery(lteCallFailureTrackingAreaDetailedEventAnalysisService, requestParameters);
    }
    ...
    private String getJsonResultForGroup(final String eventId) {
        ...
        requestParameters.putSingle(TZ_OFFSET, TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
        requestParameters.putSingle(EVENT_ID_PARAM, eventId);
        requestParameters.putSingle(GROUP_NAME_PARAM, TEST_VALUE_TRACKING_AREA_GROUP);
        requestParameters.putSingle(MAX_ROWS, DEFAULT_MAX_ROWS);
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedRrcConnSetupEvent_Raw() throws Exception {
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedS1SigSetupEvent_Raw() throws Exception {
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedInitialCxtSetupEvent_Raw() throws Exception {
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedErabSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_TRAC_1, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TRAC_1, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedUeCxtReleaseEvent_Raw() throws Exception {
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedRrcConnSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedS1SigSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedInitialCxtSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedErabSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_TRAC_1, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        //        insertData(TEST_VALUE_TRAC_1, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
        //                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_TRAC_2, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        //        insertData(TEST_VALUE_TRAC_2, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
        //                DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testTrackingAreaAnalysisDetailedUeCxtReleaseEvent_RawGrp() throws Exception {
