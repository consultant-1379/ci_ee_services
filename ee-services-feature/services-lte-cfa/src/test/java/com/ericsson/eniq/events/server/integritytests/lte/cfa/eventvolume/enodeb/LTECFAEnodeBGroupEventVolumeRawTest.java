 ...
 *
 */
public class LTECFAEnodeBGroupEventVolumeRawTest extends BaseDataIntegrityTest<LTECFANodeEventVolumeResult> {
    ...
    private void insertData(final long hier3ID, final String eventTime) throws SQLException {

        insertEvent(hier3ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_INITIAL_CTXT_SETUP, 3);
        insertEvent(hier3ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_UE_CTXT_RELEASE, 2);
        insertEvent(hier3ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_RRC_CONN_SETUP, 2);
        insertEvent(hier3ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_ERAB_SETUP, 2);
        insertEvent(hier3ID, TEST_VALUE_EXCLUSIVE_TAC, eventTime, INTERNAL_PROC_S1_SIG_CONN_SETUP, 2);

        insertEvent(hier3ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_INITIAL_CTXT_SETUP, 3);
        insertEvent(hier3ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_UE_CTXT_RELEASE, 2);
        insertEvent(hier3ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_RRC_CONN_SETUP, 2);
        insertEvent(hier3ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_ERAB_SETUP, 2);
        insertEvent(hier3ID, TEST_VALUE_TAC, eventTime, INTERNAL_PROC_S1_SIG_CONN_SETUP, 2);
    }

    private void insertEvent(final long hier3ID, final String tac, final String dt, final String eventID,
    ...
    public void testNetworkEventVolume() throws Exception {
        insertData(TEST_VALUE_HIER3_ID_1, EVENT_TIME_RAW_1);
        insertData(TEST_VALUE_HIER3_ID_1, EVENT_TIME_RAW_2);
        insertData(TEST_VALUE_HIER3_ID_1, EVENT_TIME_RAW_3);

        insertData(TEST_VALUE_HIER3_ID_2, EVENT_TIME_RAW_1);
        insertData(TEST_VALUE_HIER3_ID_2, EVENT_TIME_RAW_2);
        insertData(TEST_VALUE_HIER3_ID_2, EVENT_TIME_RAW_3);
