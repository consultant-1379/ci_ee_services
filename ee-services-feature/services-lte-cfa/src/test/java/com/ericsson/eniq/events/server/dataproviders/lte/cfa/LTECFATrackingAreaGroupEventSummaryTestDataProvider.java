 ...
 * @since 2011
 */
public class LTECFATrackingAreaGroupEventSummaryTestDataProvider {
    public static Object[] provideTestData() {

        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(DISPLAY_PARAM, GRID_PARAM).add(CATEGORY_ID, "0", "1")
                ...
                .add(GROUP_NAME_PARAM, "trackingAreaGroup1").build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
    }

    private LTECFATrackingAreaGroupEventSummaryTestDataProvider() {
    }
}
