 ...
 *
 */
public class LTECFAENodeBQCIEventSummaryServiceRawTest extends
    ...
    @Test
    public void testENodeBQCICategaryEventSummaryCallDrop() throws Exception {
        ...
        final List<LTECallFailureQOSENodeBQCIEventSummaryResult> qciResult = rt.translateResult(json,
                LTECallFailureQOSENodeBQCIEventSummaryResult.class);
        assertThat(qciResult.size(), is(1));
        for (final LTECallFailureQOSENodeBQCIEventSummaryResult rs : qciResult) {
    ...
    @Test
    public void testENodeBQCICategaryEventSummaryCallSetup() throws Exception {
