 ...
 *
 */
public class LTECFAENodeBGroupQCIEventSummaryServiceAggTest extends
    ...
    private void insertData(final long hier3ID, final int tac, final int categoryID, final String eventID,
    ...
    private void insertAggData(final String aggTable, final long hire3ID, final int categoryID, final String eventID,
    ...
    private void insertDataForAggTest(final long hier3ID, final int categoryID, final String eventID,
            final int instances, final String dateTimeID, final String aggTable) throws SQLException {
        insertData(hier3ID, SAMPLE_TAC, categoryID, eventID, dateTimeID, instances, TEST_VALUE_IMSI_1);
        insertData(hier3ID, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), categoryID, eventID, dateTimeID, instances,
                TEST_VALUE_IMSI_1);
    ...
    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_CALL_SETUP, EventIDConstants.INTERNAL_PROC_ERAB_SETUP,
                2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_CALL_SETUP, EventIDConstants.INTERNAL_PROC_ERAB_SETUP,
                2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);
    }
    ...
    @Test
    public void testENodeBGroupQCIEventSummary15MinAggCallDrop() throws Exception {
    ...
    @Test
    public void testENodeBGroupQCIEventSummary15MinAggCallSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_2);
    ...
    @Test
    public void testENodeBGroupQCIEventSummaryDayAggCalLDrop() throws Exception {
    ...
    @Test
    public void testENodeBGroupQCIEventSummaryDayAggCalLSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_2);
