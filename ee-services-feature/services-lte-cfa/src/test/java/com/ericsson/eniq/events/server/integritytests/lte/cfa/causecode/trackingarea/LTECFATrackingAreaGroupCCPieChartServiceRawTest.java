...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.causecodeanalysis.LTECFATrackingAreaCCPieChartService;
 ...
 *
 */
public class LTECFATrackingAreaGroupCCPieChartServiceRawTest extends
    ...
    public void onSetUp() throws Exception {
        lteCallFailureTrackingAreaCauseCodePieChartService = new LTECFATrackingAreaCCPieChartService();
        attachDependencies(lteCallFailureTrackingAreaCauseCodePieChartService);
    ...
    private String getJsonResult() throws URISyntaxException {
        ...
        return runQuery(lteCallFailureTrackingAreaCauseCodePieChartService, requestParameters);
    }
    ...
    @Test
    public void testTrackingAreaGroupCauseCodePieChartSummary() throws Exception {
