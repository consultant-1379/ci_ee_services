 ...
 *
 */
public class LTECFATracAreaQCIEventSummaryRawTest extends
    ...
    private String getJsonResult(final int categoryID) throws URISyntaxException {
        ...
        requestParameters.putSingle(TRAC, String.valueOf(TEST_VALUE_TRAC));
    ...
    @Test
    public void testTrackingAreaQCICategaryEventSummaryCallDrop() throws Exception {
        ...
        final List<LTECallFailureQOSTrackingAreaQCIEventSummaryResult> qciResult = rt.translateResult(json,
                LTECallFailureQOSTrackingAreaQCIEventSummaryResult.class);
        assertThat(qciResult.size(), is(1));
        for (final LTECallFailureQOSTrackingAreaQCIEventSummaryResult rs : qciResult) {
    ...
    @Test
    public void testTrackingAreaQCICategaryEventSummaryCallSetup() throws Exception {
