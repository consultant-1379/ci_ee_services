...
import com.ericsson.eniq.events.server.test.queryresults.lte.callfailure.qos.LTECallFailureQOSENodeBQCICategorySummaryResult;
 ...
 *
 */
public class LTECFAENodeBQCICategorySummaryServiceAggTest extends
        BaseDataIntegrityTest<LTECallFailureQOSENodeBQCICategorySummaryResult> {
    ...
    private void insertAggData(final String aggTable, final long hier3ID, final int categoryID, final int qciID,
    ...
    private void assertResult(final List<LTECallFailureQOSENodeBQCICategorySummaryResult> results) {
        assertThat(results.size(), is(6));
        for (final LTECallFailureQOSENodeBQCICategorySummaryResult rs : results) {
    ...
    public void testENodeBQCICategorySummary15MinAgg() throws Exception {
        ...
        final ResultTranslator<LTECallFailureQOSENodeBQCICategorySummaryResult> rt = getTranslator();
        final List<LTECallFailureQOSENodeBQCICategorySummaryResult> eventResult = rt.translateResult(json,
                LTECallFailureQOSENodeBQCICategorySummaryResult.class);
