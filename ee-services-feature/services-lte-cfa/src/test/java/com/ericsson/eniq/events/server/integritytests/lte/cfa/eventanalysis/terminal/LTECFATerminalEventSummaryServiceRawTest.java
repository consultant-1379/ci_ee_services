 ...
 *
 */
public class LTECFATerminalEventSummaryServiceRawTest extends
    ...
    private void insertRawData() throws Exception {
        insertData(TEST_VALUE_TAC, INTERNAL_PROC_RRC_CONN_SETUP, TEST_VALUE_CATEGORY_ID_CALL_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, INTERNAL_PROC_RRC_CONN_SETUP, TEST_VALUE_CATEGORY_ID_CALL_SETUP,
                DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_TAC, INTERNAL_PROC_S1_SIG_CONN_SETUP, TEST_VALUE_CATEGORY_ID_CALL_SETUP, DATETIME_ID_RAW,
                2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, INTERNAL_PROC_S1_SIG_CONN_SETUP, TEST_VALUE_CATEGORY_ID_CALL_SETUP,
                DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_TAC, INTERNAL_PROC_INITIAL_CTXT_SETUP, TEST_VALUE_CATEGORY_ID_CALL_SETUP,
                DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, INTERNAL_PROC_INITIAL_CTXT_SETUP, TEST_VALUE_CATEGORY_ID_CALL_SETUP,
                DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_TAC, INTERNAL_PROC_ERAB_SETUP, TEST_VALUE_CATEGORY_ID_CALL_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, INTERNAL_PROC_ERAB_SETUP, TEST_VALUE_CATEGORY_ID_CALL_SETUP,
                DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_TAC, INTERNAL_PROC_UE_CTXT_RELEASE, TEST_VALUE_CATEGORY_ID_CALL_DROP, DATETIME_ID_RAW, 2);
