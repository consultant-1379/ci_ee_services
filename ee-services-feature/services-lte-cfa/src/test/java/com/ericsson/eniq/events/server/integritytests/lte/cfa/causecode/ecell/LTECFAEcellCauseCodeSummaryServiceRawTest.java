...
import com.ericsson.eniq.events.server.test.queryresults.lte.callfailure.LTECallFailureEcellCauseCodeSummaryResultRaw;
 ...
 *
 */
public class LTECFAEcellCauseCodeSummaryServiceRawTest extends
        BaseDataIntegrityTest<LTECallFailureEcellCauseCodeSummaryResultRaw> {
    ...
    @Test
    public void testEcellCauseCodeSummary() throws Exception {
        final String json = getJsonResult();
        final ResultTranslator<LTECallFailureEcellCauseCodeSummaryResultRaw> rt = getTranslator();
        final List<LTECallFailureEcellCauseCodeSummaryResultRaw> eventResult = rt.translateResult(json,
                LTECallFailureEcellCauseCodeSummaryResultRaw.class);
        assertResult(eventResult);
    }

    private void assertResult(final List<LTECallFailureEcellCauseCodeSummaryResultRaw> results) {
        assertThat(results.size(), is(4));
        for (final LTECallFailureEcellCauseCodeSummaryResultRaw rs : results) {
