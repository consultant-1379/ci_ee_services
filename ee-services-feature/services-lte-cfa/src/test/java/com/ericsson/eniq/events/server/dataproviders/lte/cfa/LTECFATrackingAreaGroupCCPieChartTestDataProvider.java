 ...
 * @since 2011
 */
public class LTECFATrackingAreaGroupCCPieChartTestDataProvider {
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(CAUSE_CODE_ID_LIST, "4097-0,4097-1,4098-0,4098-1").add(GROUP_NAME_PARAM, "tempTracGroup").build();
