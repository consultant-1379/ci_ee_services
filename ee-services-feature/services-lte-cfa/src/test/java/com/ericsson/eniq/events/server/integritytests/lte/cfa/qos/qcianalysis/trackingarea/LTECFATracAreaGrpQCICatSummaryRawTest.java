 ...
 *
 */
public class LTECFATracAreaGrpQCICatSummaryRawTest extends
    ...
    private void insertData(final String tac, final int trac, final int categoryID, final int qciID, final String time,
    ...
    private void insertRawData() throws Exception {
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_1, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_1, DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_1,
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_1,
                DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_1, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_1, DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_1,
                DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_1,
                DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_2, DATETIME_ID_RAW, 3);
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_2, DATETIME_ID_RAW, 3);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_2,
                DATETIME_ID_RAW, 3);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_2,
                DATETIME_ID_RAW, 3);

        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_2, DATETIME_ID_RAW, 4);
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_2, DATETIME_ID_RAW, 4);

        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_2,
                DATETIME_ID_RAW, 4);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_2,
                DATETIME_ID_RAW, 4);

        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_3, DATETIME_ID_RAW, 5);
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_3, DATETIME_ID_RAW, 5);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_3,
                DATETIME_ID_RAW, 5);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_SETUP, TEST_VALUE_QCI_ID_3,
                DATETIME_ID_RAW, 5);

        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_3, DATETIME_ID_RAW, 6);
        insertData(TEST_VALUE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_3, DATETIME_ID_RAW, 6);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_1, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_3,
                DATETIME_ID_RAW, 6);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_TRAC_2, CATEGORY_ID_CALL_DROP, TEST_VALUE_QCI_ID_3,
                DATETIME_ID_RAW, 6);
    }
    ...
    private void assertResult(final List<LTECallFailureQOSTrackingAreaGroupQCICategorySummaryResult> results) {
        ...
        for (final LTECallFailureQOSTrackingAreaGroupQCICategorySummaryResult rs : results) {
            assertEquals(rs.getFailures(), i * 4);
            i++;
        }
    }

    @Test
    public void testTrackingAreaGroupQCICategaryEventSummary() throws Exception {
