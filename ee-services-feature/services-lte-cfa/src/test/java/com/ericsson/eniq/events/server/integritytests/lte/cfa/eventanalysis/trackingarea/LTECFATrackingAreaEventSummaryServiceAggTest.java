 ...
 *
 */
public class LTECFATrackingAreaEventSummaryServiceAggTest extends
    ...
    private void insertDataForAggTestWithEventID(final String eventID, final String categoryID,final int instances, final String dateTimeID,
        ...
        insertData(TEST_VALUE_TRAC, eventID, categoryID,SAMPLE_TAC, dateTimeID, instances, TEST_VALUE_IMSI_1);
        insertData(TEST_VALUE_TRAC, eventID, categoryID,Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), dateTimeID, instances,
                TEST_VALUE_IMSI_1);
        insertData(TEST_VALUE_TRAC, eventID, categoryID,SAMPLE_TAC, dateTimeID, instances, TEST_VALUE_IMSI_2);
        insertData(TEST_VALUE_TRAC, eventID, categoryID,Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), dateTimeID, instances,
                TEST_VALUE_IMSI_2);
        insertAggData(aggTable, TEST_VALUE_TRAC, eventID, categoryID, dateTimeID, instances);
    }
