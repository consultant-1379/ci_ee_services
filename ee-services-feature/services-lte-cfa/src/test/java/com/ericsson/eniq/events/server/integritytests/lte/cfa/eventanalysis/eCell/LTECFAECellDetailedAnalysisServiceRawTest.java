...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.eventanalysis.LTECFAECellDetailedEventAnalysisService;
 ...
 *
 */
public class LTECFAECellDetailedAnalysisServiceRawTest extends
    ...
    private static final String TEST_VALUE_ECELL_GROUP = "eCellGroup";
    ...
    public void onSetUp() throws Exception {
        lteCallFailureECellDetailedEventAnalysisService = new LTECFAECellDetailedEventAnalysisService();
        attachDependencies(lteCallFailureECellDetailedEventAnalysisService);
    ...
    private void insertTopoData() throws SQLException {
        ...
        valuesForTable.clear();
        valuesForTable.put(HIER321_ID, TEST_VALUE_HIER321_ID_1);
        valuesForTable.put(GROUP_NAME, TEST_VALUE_ECELL_GROUP);
    ...
    private void insertData(final String hier321Id, final String eventID, final int tac, final String time,
    ...
    private String getJsonResult(final String eventId) {
        ...
        return runQuery(lteCallFailureECellDetailedEventAnalysisService, requestParameters);
    }
    ...
    private String getJsonResultForGroup(final String eventId) {
        ...
        requestParameters.putSingle(TZ_OFFSET, TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
        requestParameters.putSingle(EVENT_ID_PARAM, eventId);
        requestParameters.putSingle(GROUP_NAME_PARAM, TEST_VALUE_ECELL_GROUP);
        requestParameters.putSingle(MAX_ROWS, DEFAULT_MAX_ROWS);
    ...
    @Test
    public void testECellAnalysisDetailedRrcConnSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_RRC_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_RRC_CONN_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testECellAnalysisDetailedS1SigSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_S1_SIG_CONN_SETUP,
    ...
    @Test
    public void testECellAnalysisDetailedInitialCxtSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_INITIAL_CTXT_SETUP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testECellAnalysisDetailedErabSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testECellAnalysisDetailedUeCxtReleaseEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, SAMPLE_TAC, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testECellAnalysisDetailedRrcConnSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_RRC_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_RRC_CONN_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_RRC_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_RRC_CONN_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testECellAnalysisDetailedS1SigSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_S1_SIG_CONN_SETUP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_S1_SIG_CONN_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_S1_SIG_CONN_SETUP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testECellAnalysisDetailedInitialCxtSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_INITIAL_CTXT_SETUP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_INITIAL_CTXT_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_INITIAL_CTXT_SETUP,
                Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testECellAnalysisDetailedErabSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_ERAB_SETUP, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_ERAB_SETUP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testECellAnalysisDetailedUeCxtReleaseEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_UE_CTXT_RELEASE, SAMPLE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_UE_CTXT_RELEASE, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
