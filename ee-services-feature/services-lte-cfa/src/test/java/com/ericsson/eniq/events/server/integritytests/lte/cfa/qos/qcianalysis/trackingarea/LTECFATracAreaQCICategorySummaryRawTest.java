...
import com.ericsson.eniq.events.server.test.queryresults.lte.callfailure.qos.LTECallFailureQOSTrackingAreaQCICategorySummaryResult;
 ...
 *
 */
public class LTECFATracAreaQCICategorySummaryRawTest extends
        BaseDataIntegrityTest<LTECallFailureQOSTrackingAreaQCICategorySummaryResult> {
    ...
    private static final String TEST_NODE_PARAM_VALUE = "1";
    ...
    private void insertData(final String tac, final int categoryID, final int qciID, final String time,
        ...
        for (int i = 0; i < instances; i++) {
            ...
            valuesForTable.put(TRAC, TEST_VALUE_TRAC);
    ...
    public void testECellQCICategaryEventSummary() throws Exception {
        ...
        final ResultTranslator<LTECallFailureQOSTrackingAreaQCICategorySummaryResult> rt = getTranslator();
        final List<LTECallFailureQOSTrackingAreaQCICategorySummaryResult> eventResult = rt.translateResult(json,
                LTECallFailureQOSTrackingAreaQCICategorySummaryResult.class);
        assertResult(eventResult);
    }

    private void assertResult(final List<LTECallFailureQOSTrackingAreaQCICategorySummaryResult> results) {
        assertThat(results.size(), is(6));
        int i = 1;
        for (final LTECallFailureQOSTrackingAreaQCICategorySummaryResult rs : results) {
