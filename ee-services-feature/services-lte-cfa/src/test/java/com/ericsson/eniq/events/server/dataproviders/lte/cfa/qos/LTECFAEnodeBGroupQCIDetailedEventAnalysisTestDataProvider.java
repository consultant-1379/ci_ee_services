 ...
 *
 */
public class LTECFAEnodeBGroupQCIDetailedEventAnalysisTestDataProvider {

    private LTECFAEnodeBGroupQCIDetailedEventAnalysisTestDataProvider() {
    }
    ...
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(EVENT_ID_PARAM, INTERNAL_PROC_INITIAL_CTXT_SETUP, INTERNAL_PROC_ERAB_SETUP,
                        INTERNAL_PROC_UE_CTXT_RELEASE).add(GROUP_NAME_PARAM, SAMPLE_BSC_GROUP).build();
