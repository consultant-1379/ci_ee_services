...
import com.ericsson.eniq.events.server.test.queryresults.lte.callfailure.qos.LTECallFailureQOSENodeBQCIEventSummaryResult;
 ...
 *
 */
public class LTECFAENodeBQCIEventSummaryServiceAggTest extends
        BaseDataIntegrityTest<LTECallFailureQOSENodeBQCIEventSummaryResult> {
    ...
    @Test
    public void testENodeBQCIEventSummary15MinAggCallDrop() throws Exception {
        ...
        final ResultTranslator<LTECallFailureQOSENodeBQCIEventSummaryResult> rt = getTranslator();
        final List<LTECallFailureQOSENodeBQCIEventSummaryResult> eventResult = rt.translateResult(json,
                LTECallFailureQOSENodeBQCIEventSummaryResult.class);
        assertThat(eventResult.size(), is(1));
    }

    @Test
    public void testENodeBQCIEventSummary15MinAggCallSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_2);
    ...
    @Test
    public void testENodeBQCIEventSummaryDayAggCallDrop() throws Exception {
    ...
    @Test
    public void testENodeBQCIEventSummaryDayAggCallSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER3_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_2);
