...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.ranking.LTECFAAccessAreaCallDropRankingService;
 ...
 *
 */
public class LTECFAAccessAreaCallDropRankingServiceAggTest extends
    ...
    public void onSetUp() throws Exception {
        lteCallFailureAccessAreaCallDropRankingService = new LTECFAAccessAreaCallDropRankingService();
        attachDependencies(lteCallFailureAccessAreaCallDropRankingService);
    ...
    private void insertData() throws SQLException {
        ...
        //2.Insert test data
        String dateTime = DateTimeUtilities.getDateTimeMinus55Minutes();
        inserteCell(TEST_VALUE_HIER3_ID_1, TEST_VALUE_HIER321_ID_1, dateTime, INTERNAL_PROC_UE_CTXT_RELEASE,
                LTE_CALL_DROP_CATEGORY_ID, 3);
        inserteCell(TEST_VALUE_HIER3_ID_2, TEST_VALUE_HIER321_ID_2, dateTime, INTERNAL_PROC_UE_CTXT_RELEASE,
                LTE_CALL_DROP_CATEGORY_ID, 2);
        inserteCell(TEST_VALUE_HIER3_ID_3, TEST_VALUE_HIER321_ID_3, dateTime, INTERNAL_PROC_UE_CTXT_RELEASE,
                LTE_CALL_DROP_CATEGORY_ID, 1);
    ...
    @Test
    public void testGetLTECFAeCellCallDropRankingDataAgg15MIN() throws Exception {
        ...
        final String json = runQuery(lteCallFailureAccessAreaCallDropRankingService, requestParameters);
    ...
    @Test
    public void testGetLTECFAeCellCallDropRankingDataAggDAY() throws Exception {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        requestParameters.putSingle(DISPLAY_PARAM, GRID);
