...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.causecodeanalysis.LTECFAEcellCauseCodeEventSummaryService;
import com.ericsson.eniq.events.server.test.queryresults.ResultTranslator;
import com.ericsson.eniq.events.server.test.queryresults.lte.callfailure.LTECallFailureGroupCauseCodeSummaryResultRaw;
 ...
 *
 */
public class LTECFAEcellGroupCauseCodeSummaryServiceRawTest extends
        BaseDataIntegrityTest<LTECallFailureGroupCauseCodeSummaryResultRaw> {
    ...
    private static final long TEST_VALUE_HIER321_ID_2 = 4747612786969905162L;
    ...
    public void onSetUp() throws Exception {
        lteCallFailureEcellCauseCodeEventSummaryService = new LTECFAEcellCauseCodeEventSummaryService();
        attachDependencies(lteCallFailureEcellCauseCodeEventSummaryService);
    ...
    private String getJsonResult() throws URISyntaxException {
        ...
        return runQuery(lteCallFailureEcellCauseCodeEventSummaryService, requestParameters);
    }
    ...
    public void testEcellGroupCauseCodeSummary() throws Exception {
        ...
        final ResultTranslator<LTECallFailureGroupCauseCodeSummaryResultRaw> rt = getTranslator();
        final List<LTECallFailureGroupCauseCodeSummaryResultRaw> eventResult = rt.translateResult(json,
                LTECallFailureGroupCauseCodeSummaryResultRaw.class);
        assertResult(eventResult);
    }

    private void assertResult(final List<LTECallFailureGroupCauseCodeSummaryResultRaw> results) {
        assertThat(results.size(), is(4));
        for (final LTECallFailureGroupCauseCodeSummaryResultRaw rs : results) {
