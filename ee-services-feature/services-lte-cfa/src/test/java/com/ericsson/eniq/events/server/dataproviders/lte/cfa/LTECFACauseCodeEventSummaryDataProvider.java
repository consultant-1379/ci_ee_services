 ...
 * @since 2011
 */
public class LTECFACauseCodeEventSummaryDataProvider {
    private static final String TEST_VALUE_CAUSE_CODE = "1";

    public static Object[] provideTestData() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(DISPLAY_PARAM, GRID_PARAM)
                .add(TIME_QUERY_PARAM, FIVE_MINUTES, THIRTY_MINUTES, ONE_DAY, TWO_WEEKS)
                .add(CAUSE_CODE_PARAM, TEST_VALUE_CAUSE_CODE)
    ...
    private LTECFACauseCodeEventSummaryDataProvider() {
