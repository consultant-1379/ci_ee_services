 ...
 *
 */
public class LTECFAECellQCIEventSummaryServiceAggTest extends
    ...
    @Test
    public void testECellQCIEventSummary15MinAggCallDrop() throws Exception {
        ...
        final List<LTECallFailureQOSECellQCIEventSummaryResult> eventResult = rt.translateResult(json,
                LTECallFailureQOSECellQCIEventSummaryResult.class);
        assertThat(eventResult.size(), is(1));
    }

    @Test
    public void testECellQCIEventSummary15MinAggCallSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER321_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER321_EVENTID_QCI_ERR_15MIN, DATETIME_ID_15MIN_2);
    ...
    @Test
    public void testECellQCIEventSummaryDayAggCallDrop() throws Exception {
    ...
    @Test
    public void testECellQCIEventSummaryDayAggCallSetup() throws Exception {
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER321_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_1);
        insertAggData(TEMP_EVENT_E_LTE_CFA_ARRAY_ERAB_HIER321_EVENTID_QCI_ERR_DAY, DATETIME_ID_DAY_2);
