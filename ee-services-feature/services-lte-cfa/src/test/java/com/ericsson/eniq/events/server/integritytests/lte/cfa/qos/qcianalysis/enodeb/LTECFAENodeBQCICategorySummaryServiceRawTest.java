 ...
 *
 */
public class LTECFAENodeBQCICategorySummaryServiceRawTest extends
    ...
    private void insertRawData() throws Exception {
        ...
        insertData(TEST_VALUE_TAC, 1, 1, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, 1, 1, DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_TAC, 0, 1, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, 0, 1, DATETIME_ID_RAW, 2);

        insertData(TEST_VALUE_TAC, 1, 2, DATETIME_ID_RAW, 3);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, 1, 2, DATETIME_ID_RAW, 3);

        insertData(TEST_VALUE_TAC, 0, 2, DATETIME_ID_RAW, 4);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, 0, 2, DATETIME_ID_RAW, 4);

        insertData(TEST_VALUE_TAC, 1, 3, DATETIME_ID_RAW, 5);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, 1, 3, DATETIME_ID_RAW, 5);

        insertData(TEST_VALUE_TAC, 0, 3, DATETIME_ID_RAW, 6);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, 0, 3, DATETIME_ID_RAW, 6);
    }
