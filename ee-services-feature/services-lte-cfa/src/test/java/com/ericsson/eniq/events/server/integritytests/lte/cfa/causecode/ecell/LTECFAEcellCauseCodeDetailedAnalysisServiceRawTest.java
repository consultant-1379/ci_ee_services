...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.causecodeanalysis.LTECFAEcellCauseCodeDetailedEAService;
 ...
 *
 */
public class LTECFAEcellCauseCodeDetailedAnalysisServiceRawTest extends
    ...
    private static final String TEST_VALUE_HIER321_ID_1 = "4809532081614999117";

    private static final String TEST_VALUE_HIER321_ID_2 = "3135210477467174988";
    ...
    public void onSetUp() throws Exception {
        lteCallFailureEcellCauseCodeDetailedEventAnalysisService = new LTECFAEcellCauseCodeDetailedEAService();
        attachDependencies(lteCallFailureEcellCauseCodeDetailedEventAnalysisService);
    ...
    private String getJsonResult(final String eventId) {
        ...
        return runQuery(lteCallFailureEcellCauseCodeDetailedEventAnalysisService, requestParameters);
    }
    ...
    @Test
    public void testEcellCauseCodeAnalysisDetailedRrcConnSetupEvent_Raw() throws Exception {
    ...
    @Test
    public void testEcellCauseCodeAnalysisDetailedS1SigSetupEvent_Raw() throws Exception {
    ...
    @Test
    public void testEcellCauseCodeAnalysisDetailedInitialCxtSetupEvent_Raw() throws Exception {
    ...
    @Test
    public void testEcellCauseCodeAnalysisDetailedUeCxtReleaseEvent_Raw() throws Exception {
    ...
    @Test
    public void testEcellCauseCodeAnalysisDetailedRrcConnSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testEcellCauseCodeAnalysisDetailedS1SigSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testEcellCauseCodeAnalysisDetailedInitialCxtSetupEvent_RawGrp() throws Exception {
    ...
    @Test
    public void testEcellCauseCodeAnalysisDetailedUeCxtReleaseEvent_RawGrp() throws Exception {
