...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.eventanalysis.LTECFATerminalDetailedEventAnalysisService;
 ...
 *
 */
public class LTECFATerminalDetailedAnalysisServiceRawTest extends
        BaseDataIntegrityTest<LTECallFailureSubscriberDetailedAnalysisSetupResult> {
    LTECFATerminalDetailedEventAnalysisService lteCallFailureTerminalDetailedEventAnalysisService;
    ...
    private static final String TEST_VALUE_HIER321_ID_1 = "5345046159527374400";

    private static final String TEST_VALUE_HIER321_ID_2 = "4747612786969905162";
    ...
    public void onSetUp() throws Exception {
        lteCallFailureTerminalDetailedEventAnalysisService = new LTECFATerminalDetailedEventAnalysisService();
        attachDependencies(lteCallFailureTerminalDetailedEventAnalysisService);
    ...
    private void insertData(final String hier321Id, final String eventID, final String tac, final String time,
    ...
    private String getJsonResult(final String eventId) {
        ...
        requestParameters.putSingle(TAC, TEST_VALUE_TAC_1);
        requestParameters.putSingle(MAX_ROWS, DEFAULT_MAX_ROWS);

        return runQuery(lteCallFailureTerminalDetailedEventAnalysisService, requestParameters);
    }
    ...
    @Test
    public void testTerminalAnalysisDetailedRrcConnSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_RRC_CONN_SETUP, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_RRC_CONN_SETUP, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testTerminalAnalysisDetailedS1SigSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW,
                2);
    ...
    @Test
    public void testTerminalAnalysisDetailedInitialCxtSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, TEST_VALUE_EXCLUSIVE_TAC,
                DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testTerminalAnalysisDetailedErabSetupEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_ERAB_SETUP, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_ERAB_SETUP, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW, 2);

        final String json = getJsonResult(INTERNAL_PROC_ERAB_SETUP);

        final ResultTranslator<LTECallFailureSubscriberDetailedAnalysisSetupResult> rt = getTranslator();
        final List<LTECallFailureSubscriberDetailedAnalysisSetupResult> eventResult = rt.translateResult(json,
                LTECallFailureSubscriberDetailedAnalysisSetupResult.class);
        assertResult(eventResult, INTERNAL_PROC_ERAB_SETUP);
    }

    @Test
    public void testTerminalAnalysisDetailedUeCxtReleaseEvent_Raw() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testTerminalAnalysisDetailedRrcConnSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_RRC_CONN_SETUP, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_RRC_CONN_SETUP, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_RRC_CONN_SETUP, TEST_VALUE_TAC_2, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_RRC_CONN_SETUP, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testTerminalAnalysisDetailedS1SigSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_S1_SIG_CONN_SETUP, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW,
                1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_S1_SIG_CONN_SETUP, TEST_VALUE_TAC_2, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_S1_SIG_CONN_SETUP, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW,
                1);
    ...
    @Test
    public void testTerminalAnalysisDetailedInitialCxtSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_INITIAL_CTXT_SETUP, TEST_VALUE_EXCLUSIVE_TAC,
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_INITIAL_CTXT_SETUP, TEST_VALUE_TAC_2, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_INITIAL_CTXT_SETUP, TEST_VALUE_EXCLUSIVE_TAC,
                DATETIME_ID_RAW, 1);
    ...
    @Test
    public void testTerminalAnalysisDetailedErabSetupEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_ERAB_SETUP, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_ERAB_SETUP, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_ERAB_SETUP, TEST_VALUE_TAC_2, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_ERAB_SETUP, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW, 1);

        final String json = getJsonResultForGroup(INTERNAL_PROC_ERAB_SETUP);
    ...
    @Test
    public void testTerminalAnalysisDetailedUeCxtReleaseEvent_RawGrp() throws Exception {

        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, TEST_VALUE_TAC_1, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_1, INTERNAL_PROC_UE_CTXT_RELEASE, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_UE_CTXT_RELEASE, TEST_VALUE_TAC_2, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER321_ID_2, INTERNAL_PROC_UE_CTXT_RELEASE, TEST_VALUE_EXCLUSIVE_TAC, DATETIME_ID_RAW, 1);
