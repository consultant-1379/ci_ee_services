...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.ranking.LTECFATerminalCallDropRankingService;
 ...
 *
 */
public class LTECFATerminalCallDropRankingServiceRawTest extends
        BaseDataIntegrityTest<LTECallFailureTerminalRankingResult> {
    private LTECFATerminalCallDropRankingService lteCallFailureTerminalCallDropRankingService;
    ...
    public void onSetUp() throws Exception {
        lteCallFailureTerminalCallDropRankingService = new LTECFATerminalCallDropRankingService();
        attachDependencies(lteCallFailureTerminalCallDropRankingService);
        createTables();
        insertData();
    }
    ...
    private void insertData() throws SQLException {
        ...
        insertTAC(TEST_TAC_1, dateTime, 0, 3);
        insertTAC(TEST_TAC_2, dateTime, 0, 2);
        insertTAC(TEST_TAC_3, dateTime, 0, 1);
    }
    ...
    private String getJson(final String timerange) {
        ...
        return runQuery(lteCallFailureTerminalCallDropRankingService, requestParameters);
    }
     ...
     */
    @Test
    public void testGetRankingDataTerminalCallDropRankingRaw() throws Exception {
