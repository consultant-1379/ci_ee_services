 ...
 *
 */
public class LTECFAECellGroupQCIEventSummaryServiceRawTest extends
    ...
    private void insertRawData() throws Exception {
        insertData(TEST_VALUE_TAC, TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_TAC, TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_DROP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, DATETIME_ID_RAW, 1);

        insertData(TEST_VALUE_TAC, TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_TAC, TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_HIER321_ID_1, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
        insertData(TEST_VALUE_EXCLUSIVE_TAC, TEST_VALUE_HIER321_ID_2, CATEGORY_ID_CALL_SETUP,
                EventIDConstants.INTERNAL_PROC_ERAB_SETUP, DATETIME_ID_RAW, 2);
    ...
    @Test
    public void testECellGroupQCIEventSummaryCallDrop() throws Exception {
    ...
    @Test
    public void testECellGroupQCIEventSummaryCallSetup() throws Exception {
