...
import com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.eventanalysis.LTECFASubscriberDetailedReoccFailureService;
 ...
 *
 */
public class LTECFASubscriberReoccuringFailureServiceRawTest extends
        BaseDataIntegrityTest<LTECallFailureSubscriberDetailedAnalysisSetupResult> {
    private LTECFASubscriberDetailedReoccFailureService lteCallFailureIMSIReoccuringFailureDrilldownService;
    ...
    public void onSetUp() throws Exception {
        lteCallFailureIMSIReoccuringFailureDrilldownService = new LTECFASubscriberDetailedReoccFailureService();
        attachDependencies(lteCallFailureIMSIReoccuringFailureDrilldownService);
    ...
    private String getJsonResult(final String eventId) throws URISyntaxException {
        ...
        return runQuery(lteCallFailureIMSIReoccuringFailureDrilldownService, requestParameters);
    }
