 ...
 *
 */
public class LTECFAENodeBQCIDetailedEventAnalysisRawTest extends
        BaseDataIntegrityTest<LTECallFailureSubscriberERABDrilldownSetupResult> {
    LTECFAEnodeBQCIDetailedEventAnalysisService LTECFAEnodeBQCIDetailedEventAnalysisService;
    ...
    public void onSetUp() throws Exception {
        LTECFAEnodeBQCIDetailedEventAnalysisService = new LTECFAEnodeBQCIDetailedEventAnalysisService();
        attachDependencies(LTECFAEnodeBQCIDetailedEventAnalysisService);
    ...
    private String getJsonResult(final String eventId) {
        ...
        return runQuery(LTECFAEnodeBQCIDetailedEventAnalysisService, requestParameters);
    }
    ...
    @Test
    public void testQCIeNodeBDetailedAnalysisDrillDownEventIDSetup_Raw() throws Exception {
    ...
    @Test
    public void testQCIeNodeBDetailedAnalysisDrillDownEventIDRelease() throws Exception {
    ...
    @Test
    public void testQCIeNodeBDetailedAnalysisDrillDownEventIDSetup_RawGroup() throws Exception {
    ...
    @Test
    public void testQCIeNodeBDetailedAnalysisDrillDownEventIDReleaseGroup() throws Exception {
