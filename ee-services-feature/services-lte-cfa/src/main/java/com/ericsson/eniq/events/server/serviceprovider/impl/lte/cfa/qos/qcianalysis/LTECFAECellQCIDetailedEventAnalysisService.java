...
@Stateless
@Local(Service.class)
public class LTECFAECellQCIDetailedEventAnalysisService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_QOS_QCI_ECELL_DETAILED_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (hashedIdForCell != null) {
            dataServiceParameters.put(CELL_SQL_ID, QueryParameter.createLongParameter(Long.parseLong(hashedIdForCell)));
        }
        return dataServiceParameters;
    }
