...
@Stateless
@Local(Service.class)
public class LTECFAEnodeBCauseCodeEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_ENODEB_CAUSE_CODE_EVENT_SUMMARY_ANALYSIS;
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(LTE_CFA_HIER3_EVENTID_CC, EventDataSourceType.AGGREGATED_15MIN,
