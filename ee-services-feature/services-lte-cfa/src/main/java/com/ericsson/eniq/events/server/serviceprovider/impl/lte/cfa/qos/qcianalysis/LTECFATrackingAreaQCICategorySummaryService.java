 ...
 * -----------------------------------------------------------------------
 */
package com.ericsson.eniq.events.server.serviceprovider.impl.lte.cfa.qos.qcianalysis;
...
@Stateless
@Local(Service.class)
public class LTECFATrackingAreaQCICategorySummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_QOS_QCI_TRACKING_AREA_CATEGORY_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(AGGREGATION_VEIW_LIST, techPackList.getTechPack(EVENT_E_LTE_CFA_TP_NAME)
        ...
        if (requestParameters.getFirst(TRACKING_AREA) == null) {
            if (requestParameters.getFirst(NODE_PARAM) != null) {
                queryParameters.put(TRACKING_AREA,
                        QueryParameter.createIntParameter(Integer.parseInt(requestParameters.getFirst(NODE_PARAM))));
            }
        } else {
            queryParameters.put(TRACKING_AREA,
                    QueryParameter.createIntParameter(Integer.parseInt(requestParameters.getFirst(TRACKING_AREA))));
        }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(TRAC_HIER3_EVENTID_QCI, EventDataSourceType.AGGREGATED_15MIN,
