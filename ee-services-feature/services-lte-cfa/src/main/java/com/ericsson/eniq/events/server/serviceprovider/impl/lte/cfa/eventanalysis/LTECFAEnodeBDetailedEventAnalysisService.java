...
@Stateless
@Local(Service.class)
public class LTECFAEnodeBDetailedEventAnalysisService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_ENODEB_DETAILED_EVENT_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (hashedIdForController != null) {
            dataServiceParameters
                    .put(HIER3_ID, QueryParameter.createLongParameter(Long.valueOf(hashedIdForController)));
        }
        return dataServiceParameters;
    }
