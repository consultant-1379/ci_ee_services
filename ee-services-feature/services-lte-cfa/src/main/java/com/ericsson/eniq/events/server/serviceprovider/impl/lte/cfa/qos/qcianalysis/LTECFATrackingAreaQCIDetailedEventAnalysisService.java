...
@Stateless
@Local(Service.class)
public class LTECFATrackingAreaQCIDetailedEventAnalysisService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_QOS_QCI_TRACKING_AREA_DETAILED_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put("isSetupEvent", false);
        if (EventIDConstants.INTERNAL_PROC_ERAB_SETUP.equals(eventId)
            ...
            serviceSpecificTemplateParameters.put("isSetupEvent", true);
        }
