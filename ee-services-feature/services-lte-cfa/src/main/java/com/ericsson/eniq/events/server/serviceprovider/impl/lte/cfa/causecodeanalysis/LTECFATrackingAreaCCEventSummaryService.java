...
@Stateless
@Local(Service.class)
public class LTECFATrackingAreaCCEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_TRACKING_AREA_CAUSE_CODE_EVENT_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        if (node != null) {
            serviceSpecificTemplateParameters.put(TRACKING_AREA, node);
        }
