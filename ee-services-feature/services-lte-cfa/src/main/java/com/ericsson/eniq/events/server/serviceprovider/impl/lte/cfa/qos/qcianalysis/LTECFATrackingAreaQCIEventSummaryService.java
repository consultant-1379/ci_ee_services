...
@Stateless
@Local(Service.class)
public class LTECFATrackingAreaQCIEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_QOS_QCI_TRACKING_AREA_EVENT_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        dataServiceParameters.put(CATEGORY_ID,
    ...
    public List<String> getRequiredParametersForQuery() {
        ...
        requiredParams.add(CATEGORY_ID);
