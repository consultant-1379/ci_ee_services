...
@Stateless
@Local(Service.class)
public class LTECFATrackingAreaEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_TRACKING_AREA_EVENT_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(CATEGORY_ID,
                QueryParameter.createIntParameter(Integer.valueOf(requestParameters.getFirst(CATEGORY_ID))));
