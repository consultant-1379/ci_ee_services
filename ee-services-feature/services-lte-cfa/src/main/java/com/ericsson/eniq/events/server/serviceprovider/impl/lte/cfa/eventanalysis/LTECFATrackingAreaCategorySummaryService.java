...
import static com.ericsson.eniq.events.server.common.tablesandviews.TableKeys.TRAC_HIER3_EVENTID;
...
@Stateless
@Local(Service.class)
public class LTECFATrackingAreaCategorySummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_TRACKING_AREA_CATEGORY_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(AGGREGATION_VIEW, techPackList.getTechPack(EVENT_E_LTE_CFA)
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        String trackingArea = requestParameters.getFirst(TRACKING_AREA); 
        if (trackingArea == null) {
            trackingArea = requestParameters.getFirst(NODE_PARAM);
        }
        if(trackingArea != null){
            queryParameters.put(TRACKING_AREA,
                    QueryParameter.createIntParameter(Integer.valueOf(trackingArea)));
        }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(TRAC_HIER3_EVENTID, EventDataSourceType.AGGREGATED_15MIN,
