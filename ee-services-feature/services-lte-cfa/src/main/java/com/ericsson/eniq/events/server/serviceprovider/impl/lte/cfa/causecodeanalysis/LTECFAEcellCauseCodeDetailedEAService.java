...
@Stateless
@Local(Service.class)
public class LTECFAEcellCauseCodeDetailedEAService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_ECELL_CAUSE_CODE_DETAILED_EVENT_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        dataServiceParameters.put(CC_SQL_NAME,
                QueryParameter.createIntParameter(Integer.valueOf(requestParameters.getFirst(CAUSE_CODE_PARAM))));
        ...
        if (hashedIdForCellAsString == null || requestParameters.getFirst(NODE_PARAM) != null) {
            ...
            dataServiceParameters.put(CELL_SQL_ID,
                    QueryParameter.createLongParameter(Long.valueOf(hashedIdForCellAsString)));
        }
        if (hashedIdForCell != 0) {
            dataServiceParameters.put(CELL_SQL_ID, QueryParameter.createLongParameter(Long.valueOf(hashedIdForCell)));
        }
        return dataServiceParameters;
    }
