...
@Stateless
@Local(Service.class)
public class LTECFASubscriberCallSetupFailureRankingService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_SUBSCRIBER_CALL_FAILURE_CALL_SETUP_FAILURE_RANKING_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        params.put(AGGREGATION_VIEW, techPackList.getTechPack(EVENT_E_LTE_CFA).getPlainAggregationView());
        return params;
    }
