...
@Stateless
@Local(Service.class)
public class LTECFATrackingAreaCallDropRankingService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_TRACKING_AREA_CALL_DROP_RANKING_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        params.put(CATEGORY_ID, LTE_CALL_DROP_CATEGORY_ID);
