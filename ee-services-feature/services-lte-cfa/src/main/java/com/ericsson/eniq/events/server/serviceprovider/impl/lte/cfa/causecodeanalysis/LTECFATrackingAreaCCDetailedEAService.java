...
@Stateless
@Local(Service.class)
public class LTECFATrackingAreaCCDetailedEAService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_TRACKING_AREA_CAUSE_CODE_DETAILED_EVENT_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        } else if (requestParameters.getFirst(NODE_PARAM) != null) {
            dataServiceParameters.put(TRACKING_AREA,
