...
@Stateless
@Local(Service.class)
public class LTECFAECellQCIEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_QOS_QCI_ECELL_EVENT_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(QCI_ID_SQL_ID,
