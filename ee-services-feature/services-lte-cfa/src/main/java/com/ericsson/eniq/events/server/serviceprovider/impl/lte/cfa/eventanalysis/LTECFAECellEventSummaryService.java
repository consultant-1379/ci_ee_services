...
@Stateless
@Local(Service.class)
public class LTECFAECellEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_ECELL_EVENT_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final String hashedIdForCell = requestParameters.getFirst(CELL_SQL_ID); //HIER321_ID
        if (hashedIdForCell != null) {
            queryParameters.put(CELL_SQL_ID, QueryParameter.createLongParameter(Long.valueOf(hashedIdForCell)));
        }
        queryParameters.put(CATEGORY_ID, QueryParameter.createIntParameter(Integer.valueOf(requestParameters.getFirst(CATEGORY_ID))));
