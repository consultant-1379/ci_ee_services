...
@Stateless
@Local(Service.class)
public class LTECFAEnodeBEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_ENODEB_EVENT_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (hashedIdForController != null) {
            queryParameters.put(HIER3_ID, QueryParameter.createLongParameter(Long.valueOf(hashedIdForController)));
        }
