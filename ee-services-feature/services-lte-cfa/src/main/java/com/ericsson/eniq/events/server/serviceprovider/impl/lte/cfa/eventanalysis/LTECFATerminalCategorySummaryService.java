...
@Stateless
@Local(Service.class)
public class LTECFATerminalCategorySummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_TERMINAL_CATEGORY_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final String tac_value = node.substring(index + 1);
