...
@Stateless
@Local(Service.class)
public class LTECFATrackingAreaCallSetupRankingService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_TRACKING_AREA_CALL_SETUP_FAILURE_RANKING_ANALYSIS;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        params.put(CATEGORY_ID, LTE_CALL_SETUP_FAILURE_CATEGORY_ID);
        params.put(AGGREGATION_VIEW, techPackList.getTechPack(EVENT_E_LTE_CFA).getErrAggregationView());
        return params;
    }
