...
@Stateless
@Local(Service.class)
public class LTECFAEnodeBCategorySummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return LTE_CALL_FAILURE_ENODEB_CATEGORY_SUMMARY_ANALYSIS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (hashedIdForControllerAsString == null) {
            ...
            hashedIdForController = Long.valueOf(hashedIdForControllerAsString);
        }
