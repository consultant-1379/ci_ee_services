 ...
 *
 */
public class RNCGroupHFAESSTest extends BaseServiceIntegrationTest {
    private RNCHandoverFailureEventSummaryService service;

    @Before
    public void init() {
        service = new RNCHandoverFailureEventSummaryService();
    ...
    private MultivaluedMap<String, String> getRequestParameters(final String time) {
        ...
        requestParameters.putSingle(GROUP_NAME_PARAM, "RNC_GROUP_1");
