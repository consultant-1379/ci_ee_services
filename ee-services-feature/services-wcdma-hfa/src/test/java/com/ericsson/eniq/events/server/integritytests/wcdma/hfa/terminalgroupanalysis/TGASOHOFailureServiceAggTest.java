...
import com.ericsson.eniq.events.server.serviceprovider.impl.wcdma.hfa.terminalgroupanalysis.TerminalGASOHOFailureService;
 ...
 *
 */
public class TGASOHOFailureServiceAggTest extends
        BaseDataIntegrityTest<HandoverFailureTerminalGroupAnalysisResult> {

    private TerminalGASOHOFailureService service;

    @Before
    public void setUp() throws Exception {
        service = new TerminalGASOHOFailureService();
        ...
        insertDataIntoRawTable(SAMPLE_TAC, Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID), SAMPLE_IMSI,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoRawTable(SAMPLE_TAC, Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID), SAMPLE_IMSI,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoRawTable(SAMPLE_TAC_2, Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID), SAMPLE_IMSI_2,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoRawTable(SAMPLE_EXCLUSIVE_TAC, Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID), SAMPLE_IMSI_3,
                DateTimeUtilities.getDateTimeMinus48Hours());
        //insert data into Aggregation table
        //please note that we are not putting exclusive tac data into aggregation table
        insertDataIntoAggTable(SAMPLE_TAC, Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID), 2,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoAggTable(SAMPLE_TAC_2, Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID), 1,
                DateTimeUtilities.getDateTimeMinus48Hours());
    }

    @Test
    public void getTerminalGroupAnalysisSOHOFailureForOneWeek() throws Exception {
        ...
        //validate result
        //validateAgainstGridDefinition(result, "TERMINAL_GROUP_ANALYSIS_RAN_WCDMA_HFA_SOHO");
        ...
        assertThat(sampleTacGroupResult.getCategoryId(), is(Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID)));
        ...
        assertThat(sampleExclusiveTacGroupResult.getCategoryId(), is(Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID)));
    ...
    private void createRawTable() throws SQLException {
        ...
        createTemporaryTable(TEMP_EVENT_E_RAN_HFA_SOHO_ERR_RAW, columns);
    }
    ...
    private void insertDataIntoRawTable(final int tac, final int categoryId, final long imsi, final String date)
        ...
        insertRow(TEMP_EVENT_E_RAN_HFA_SOHO_ERR_RAW, values);
    }
