 ...
 *
 */
public class TerminalHFARSTest extends BaseServiceIntegrationTest {

    private TerminalHandoverFailureRankingService service;

    @Before
    public void init() {
        service = new TerminalHandoverFailureRankingService();
