 ...
 *
 */
public class TGAIFHOFailureServiceRawTest extends
    ...
    public void setUp() throws Exception {
        ...
        insertRowIntoEventTable(SAMPLE_IMSI, Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID), SAMPLE_TAC,
                dateTimeNowMinus27Mins);
        insertRowIntoEventTable(SAMPLE_IMSI_2, Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID), SAMPLE_TAC_2,
                dateTimeNowMinus27Mins);
        insertRowIntoEventTable(SAMPLE_IMSI_3, Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID), SAMPLE_TAC_3,
                dateTimeNowMinus27Mins);
    }

    @Test
    public void getTerminalGroupAnalysisIFHOFailure() throws Exception {
