...
import com.ericsson.eniq.events.server.serviceprovider.impl.wcdma.hfa.terminalgroupanalysis.TerminalGAIFHOFailureService;
 ...
 *
 */
public class TGAIFHOFailureServiceAggTest extends
        BaseDataIntegrityTest<HandoverFailureTerminalGroupAnalysisResult> {

    private TerminalGAIFHOFailureService service;

    @Before
    public void setUp() throws Exception {
        service = new TerminalGAIFHOFailureService();
        ...
        insertDataIntoRawTable(SAMPLE_TAC, Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID), SAMPLE_IMSI,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoRawTable(SAMPLE_TAC, Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID), SAMPLE_IMSI,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoRawTable(SAMPLE_TAC_2, Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID), SAMPLE_IMSI_2,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoRawTable(SAMPLE_EXCLUSIVE_TAC, Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID), SAMPLE_IMSI_3,
                DateTimeUtilities.getDateTimeMinus48Hours());
        //insert data into Aggregation table
        insertDataIntoAggTable(SAMPLE_TAC, Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID), 2,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoAggTable(SAMPLE_TAC_2, Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID), 1,
                DateTimeUtilities.getDateTimeMinus48Hours());
    }

    @Test
    public void getTerminalGroupAnalysisIFHOFailureForOneWeek() throws Exception {
        ...
        //validate result
        //validateAgainstGridDefinition(result, "TERMINAL_GROUP_ANALYSIS_RAN_WCDMA_HFA_IFHO");
        ...
        assertThat(sampleTacGroupResult.getCategoryId(), is(Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID)));
        ...
        assertThat(sampleExclusiveTacGroupResult.getCategoryId(), is(Integer.parseInt(WCDMA_HFA_IFHO_CATEGORY_ID)));
    ...
    private void createRawTable() throws SQLException {
        ...
        createTemporaryTable(TEMP_EVENT_E_RAN_HFA_IFHO_ERR_RAW, columns);
    }
    ...
    private void createAggTable() throws SQLException {
        ...
        columns.put(DATETIME_ID, Nullable.CANNOT_BE_NULL);
        createTemporaryTable(TEMP_EVENT_E_RAN_HFA_IFHO_TAC_ERR_DAY, columns);
    }
    ...
    private void insertDataIntoRawTable(final int tac, final int categoryId, final long imsi, final String date)
        ...
        insertRow(TEMP_EVENT_E_RAN_HFA_IFHO_ERR_RAW, values);
    }
    ...
    private void insertDataIntoAggTable(final int tac, final int categoryId, final int numOfErrs, final String date)
        ...
        values.put(DATETIME_ID, date);
        insertRow(TEMP_EVENT_E_RAN_HFA_IFHO_TAC_ERR_DAY, values);
    }
}
