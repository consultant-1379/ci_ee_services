...
public class HandoverFailureCellGroupSCCServiceRawTest extends BaseDataIntegrityTest<HandoverFailureSCCGroupResult> {
    ...
    @Test
    public void testCellGroupServiceZ() throws Exception {
        ...
        final HandoverFailureSCCGroupResult resultForHFACellGroup = result.get(0);
        ...
        assertThat(resultForHFACellGroup.getGroupName(), is(WCDMA_HFA_SOURCE_AND_TARGET_GROUP_ID));
    }
