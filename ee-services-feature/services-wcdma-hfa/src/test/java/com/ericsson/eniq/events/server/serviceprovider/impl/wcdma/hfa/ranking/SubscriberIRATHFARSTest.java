...
public class SubscriberIRATHFARSTest extends BaseServiceIntegrationTest {
    private SubscriberIRATFailureRankingService service;

    @Before
    public void init() {
        service = new SubscriberIRATFailureRankingService();
    ...
    private MultivaluedMap<String, String> getRequestParameters(final String time) {
        ...
        requestParameters.putSingle(CATEGORY_ID_PARAM, WCDMA_HFA_IRAT_CATEGORY_ID);
