 ...
 *
 */
public class SourceCellSOHOHFADEADataProvider {

    public static Object[] provideTestData() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(TYPE_PARAM, TYPE_CELL).add(CATEGORY_ID_PARAM, WCDMA_HFA_SOHO_CATEGORY_ID).add(CELL_ID_PARAM, "1")
                .add(RAN_VENDOR_PARAM, ERICSSON).add(RNC_FDN_PARAM, "fdn").add(DISPLAY_PARAM, GRID_PARAM)
    ...
    public static Object[] provideTestDataGroup() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(TYPE_PARAM, TYPE_CELL).add(CATEGORY_ID_PARAM, WCDMA_HFA_SOHO_CATEGORY_ID)
