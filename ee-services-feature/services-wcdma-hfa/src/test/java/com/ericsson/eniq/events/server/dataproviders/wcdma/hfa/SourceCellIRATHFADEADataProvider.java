 ...
 *
 */
public class SourceCellIRATHFADEADataProvider {

    public static Object[] provideTestData() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(TYPE_PARAM, TYPE_CELL).add(CATEGORY_ID_PARAM, WCDMA_HFA_IRAT_CATEGORY_ID).add(CELL_ID_PARAM, "1")
    ...
    public static Object[] provideTestDataGroup() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(TYPE_PARAM, TYPE_CELL).add(CATEGORY_ID_PARAM, WCDMA_HFA_IRAT_CATEGORY_ID)
