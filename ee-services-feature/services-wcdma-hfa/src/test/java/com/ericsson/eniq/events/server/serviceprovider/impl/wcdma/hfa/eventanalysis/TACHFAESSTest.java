 ...
 *
 */
public class TACHFAESSTest extends BaseServiceIntegrationTest {
    private TACHandoverFailureEventSummaryService service;

    @Before
    public void init() {
        service = new TACHandoverFailureEventSummaryService();
    ...
    private MultivaluedMap<String, String> getRequestParameters(final String time) {
        ...
        requestParameters.putSingle(TAC_PARAM, "1234421");
