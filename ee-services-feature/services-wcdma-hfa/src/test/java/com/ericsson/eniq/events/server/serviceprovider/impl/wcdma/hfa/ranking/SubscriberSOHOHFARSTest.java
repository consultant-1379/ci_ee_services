 ...
 *
 */
public class SubscriberSOHOHFARSTest extends BaseServiceIntegrationTest {
    private SubscriberSOHOFailureRankingService service;

    @Before
    public void init() {
        service = new SubscriberSOHOFailureRankingService();
    ...
    private MultivaluedMap<String, String> getRequestParameters(final String time) {
        ...
        requestParameters.putSingle(CATEGORY_ID_PARAM, WCDMA_HFA_SOHO_CATEGORY_ID);
