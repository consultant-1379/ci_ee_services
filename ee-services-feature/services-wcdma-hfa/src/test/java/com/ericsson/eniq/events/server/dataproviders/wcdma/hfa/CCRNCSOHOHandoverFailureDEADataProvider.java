 ...
 *
 */
public class CCRNCSOHOHandoverFailureDEADataProvider {

    public static Object[] provideTestDataChart() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(TYPE_PARAM, BSC).add(CAUSE_CODE_PARAM, "1").add(SUB_CAUSE_CODE_PARAM, "1")
                .add(EVENT_ID_PARAM, "423").add(NODE_PARAM, TEST_BSC1_NODE).add(DISPLAY_PARAM, CHART_PARAM)
    ...
    public static Object[] provideTestDataGrid() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(TYPE_PARAM, BSC).add(CAUSE_CODE_PARAM, "1").add(SUB_CAUSE_CODE_PARAM, "1")
                .add(EVENT_ID_PARAM, "423").add(NODE_PARAM, TEST_BSC1_NODE).add(DISPLAY_PARAM, GRID_PARAM)
                .add(TIME_QUERY_PARAM, THIRTY_MINUTES).add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET)
                .add(MAX_ROWS, DEFAULT_MAX_ROWS, NO_MAX_ROWS).build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
    }
