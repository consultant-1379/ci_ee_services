 ...
 *
 */
public class CauseCodeHFARSTest extends BaseServiceIntegrationTest {
    private CauseCodeHandoverFailureRankingService service;

    @Before
    public void init() {
        service = new CauseCodeHandoverFailureRankingService();
