...
import static com.ericsson.eniq.events.server.test.temptables.TempTableNames.TEMP_EVENT_E_RAN_HFA_IRAT_IMSI_ERR_15MIN;
import static com.ericsson.eniq.events.server.test.temptables.TempTableNames.TEMP_EVENT_E_RAN_HFA_IRAT_IMSI_ERR_DAY;
 ...
 *
 */
public class IMSIIRATHFARSAggTest extends
    ...
    public void testGetRankingData_IMSI_HFA_15MINS() throws Exception {
        ...
        createAndPopulateAggTable(TEMP_EVENT_E_RAN_HFA_IRAT_IMSI_ERR_15MIN, DateTimeUtilities.getDateTimeMinus48Hours());
    ...
    public void testGetRankingData_IMSI_HFA_DAY() throws Exception {
        createAndPopulateAggTable(TEMP_EVENT_E_RAN_HFA_IRAT_IMSI_ERR_DAY, DateTimeUtilities.getDateTimeMinus48Hours());
    ...
    private void createAndPopulateAggTable(final String tempTableName, final String dateTime) throws SQLException {
        ...
        try {
            ...
            sqlExecutor.executeUpdate("insert into " + tempTableName + " values(" + TEST_IMSI_2 + "," + "3" + ","
                    + "56" + ",'" + dateTime + "')");
            sqlExecutor.executeUpdate("insert into " + tempTableName + " values(" + TEST_IMSI_3 + "," + "3" + ","
                    + "60" + ",'" + dateTime + "')");
        } finally {
            if (sqlExecutor != null) {
                sqlExecutor.close();
