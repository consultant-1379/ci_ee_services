 ...
 *
 */
public class RNCHFARSIntegrationTest extends BaseServiceIntegrationTest {
    private RNCHandoverFailureRankingService service;

    @Before
    public void init() {
        service = new RNCHandoverFailureRankingService();
