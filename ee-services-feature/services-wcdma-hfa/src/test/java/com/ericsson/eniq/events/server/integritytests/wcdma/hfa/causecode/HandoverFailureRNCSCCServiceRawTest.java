...
public class HandoverFailureRNCSCCServiceRawTest extends BaseDataIntegrityTest<HandoverFailureSCCGroupResult> {
    ...
    // RNC Test
    @Test
    public void testRNCService() throws Exception {
        ...
        requestParameters.putSingle(NODE_PARAM, TEST_VALUE_RNC01_NODE);
        ...
        final HandoverFailureSCCGroupResult resultForHFArnc = result.get(0);

        assertThat(resultForHFArnc.getLabel(), is("SCC" + TEST_VALUE_SUB_CAUSE_VALUE_1 + "-"
                + TEST_VALUE_CATEGORY_TABLE_NAME + TEST_VALUE_EVENT_ID_LABEL));
        assertThat(resultForHFArnc.getSubCauseCodeDesc(), is(TEST_VALUE_SUB_CAUSE_VALUE_DESC));
        ...
        assertThat(resultForHFArnc.getCauseCodeId(), is(new Integer(TEST_VALUE_CAUSE_VALUE)));
        assertThat(resultForHFArnc.getSubCauseCodeId(), is(new Integer(TEST_VALUE_SUB_CAUSE_VALUE_1)));
        assertThat(resultForHFArnc.getEventId(), is(new Integer(TEST_EVENT_ID)));
        assertThat(resultForHFArnc.getCategoryId(), is(new Integer(SOFT_HANDOVER_EVENT_ID_AS_INTEGER)));
