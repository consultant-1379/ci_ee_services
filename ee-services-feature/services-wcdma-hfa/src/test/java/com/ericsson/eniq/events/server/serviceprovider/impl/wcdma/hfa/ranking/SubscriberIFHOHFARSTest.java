 ...
 *
 */
public class SubscriberIFHOHFARSTest extends BaseServiceIntegrationTest {
    private SubscriberIFHOFailureRankingService service;

    @Before
    public void init() {
        service = new SubscriberIFHOFailureRankingService();
    ...
    private MultivaluedMap<String, String> getRequestParameters(final String time) {
        ...
        requestParameters.putSingle(CATEGORY_ID_PARAM, WCDMA_HFA_IFHO_CATEGORY_ID);
