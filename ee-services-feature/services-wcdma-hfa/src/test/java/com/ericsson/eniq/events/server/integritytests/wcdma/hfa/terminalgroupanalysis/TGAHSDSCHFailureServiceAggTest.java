 ...
 *
 */
public class TGAHSDSCHFailureServiceAggTest extends
    ...
    public void setUp() throws Exception {
        ...
        insertDataIntoRawTable(SAMPLE_TAC, Integer.parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID), SAMPLE_IMSI,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoRawTable(SAMPLE_TAC, Integer.parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID), SAMPLE_IMSI,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoRawTable(SAMPLE_TAC_2, Integer.parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID), SAMPLE_IMSI_2,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoRawTable(SAMPLE_EXCLUSIVE_TAC, Integer.parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID), SAMPLE_IMSI_3,
                DateTimeUtilities.getDateTimeMinus48Hours());
        //insert data into Aggregation table
        insertDataIntoAggTable(SAMPLE_TAC, Integer.parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID), 2,
                DateTimeUtilities.getDateTimeMinus48Hours());
        insertDataIntoAggTable(SAMPLE_TAC_2, Integer.parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID), 1,
                DateTimeUtilities.getDateTimeMinus48Hours());
    }

    @Test
    public void getTerminalGroupAnalysisHSDSCHFailureForOneWeek() throws Exception {
        ...
        assertThat(sampleExclusiveTacGroupResult.getCategoryId(), is(Integer.parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID)));
