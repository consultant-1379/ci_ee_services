 ...
 *
 */
public class SubscriberHFAESSRawTest extends
    ...
    @Test
    public void testGetData_IMSI_EA_HandoverFailure_Raw() throws Exception {
    ...
    private void verifyResult(final String json) throws Exception {
        ...
        assertThat(resultForHFAImsi.getFailures(), is(1));
    ...
    private void insertData() throws Exception {
        ...
        dataForRawEventTable.put(IMSI, "12345");
