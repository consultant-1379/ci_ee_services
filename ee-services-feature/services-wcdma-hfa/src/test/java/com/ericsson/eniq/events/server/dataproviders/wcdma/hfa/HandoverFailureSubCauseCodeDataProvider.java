 ...
 *
 */
public class HandoverFailureSubCauseCodeDataProvider {
    ...
    public static Object[] provideTestDataGridBsc() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(NODE_PARAM, TEST_BSC1_NODE).add(TYPE_PARAM, BSC).add(CAUSE_CODE_PARAM, "1")
                .add(EVENT_ID_PARAM, "423").add(CATEGORY_ID_PARAM, "1").build();
    ...
    public static Object[] provideTestDataGridBscGroup() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(DISPLAY_PARAM, GRID_PARAM).add(TIME_QUERY_PARAM, FIVE_MINUTES, THIRTY_MINUTES, ONE_DAY, ONE_WEEK)
                .add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET).add(MAX_ROWS, DEFAULT_MAX_ROWS)
                .add(GROUP_NAME_PARAM, "test").add(TYPE_PARAM, BSC).add(CAUSE_CODE_PARAM, "1")
                .add(EVENT_ID_PARAM, "423").add(CATEGORY_ID_PARAM, "1").build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
    }
    ...
    public static Object[] provideTestDataGridCell() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET).add(MAX_ROWS, DEFAULT_MAX_ROWS)
                .add(NODE_PARAM, TEST_VALUE_ACCESS_AREA_NODE).add(TYPE_PARAM, CELL).add(CAUSE_CODE_PARAM, "1")
                .add(EVENT_ID_PARAM, "423").add(CATEGORY_ID_PARAM, "1")
    ...
    public static Object[] provideTestDataGridCellGroup() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(DISPLAY_PARAM, GRID_PARAM).add(TIME_QUERY_PARAM, THIRTY_MINUTES)
                .add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET).add(MAX_ROWS, DEFAULT_MAX_ROWS)
                .add(GROUP_NAME_PARAM, "test").add(TYPE_PARAM, CELL).add(CAUSE_CODE_PARAM, "1")
                .add(EVENT_ID_PARAM, "423").add(CATEGORY_ID_PARAM, "1")
                .add(WCDMA_HFA_STATE_PARAM, WCDMA_HFA_SOURCE_AND_TARGET_GROUP_ID).build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
    }
