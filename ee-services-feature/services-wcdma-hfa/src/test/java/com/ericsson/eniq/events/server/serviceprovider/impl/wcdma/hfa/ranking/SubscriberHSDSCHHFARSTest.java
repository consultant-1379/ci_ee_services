 ...
 *
 */
public class SubscriberHSDSCHHFARSTest extends BaseServiceIntegrationTest {
    private SubscriberHSDSCHFailureRankingService service;

    @Before
    public void init() {
        service = new SubscriberHSDSCHFailureRankingService();
    ...
    private MultivaluedMap<String, String> getRequestParameters(final String time) {
        ...
        requestParameters.putSingle(CATEGORY_ID_PARAM, WCDMA_HFA_HSDSCH_CATEGORY_ID);
