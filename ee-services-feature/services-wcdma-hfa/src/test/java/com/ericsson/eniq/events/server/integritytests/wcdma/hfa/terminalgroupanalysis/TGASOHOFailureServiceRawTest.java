...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.WCDMA_HFA_SOHO_CATEGORY_ID;
 ...
 *
 */
public class TGASOHOFailureServiceRawTest extends
    ...
    public void setUp() throws Exception {
        ...
        insertRowIntoEventTable(SAMPLE_IMSI, Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID), SAMPLE_TAC,
                dateTimeNowMinus27Mins);
        insertRowIntoEventTable(SAMPLE_IMSI_2, Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID), SAMPLE_TAC_2,
                dateTimeNowMinus27Mins);
        insertRowIntoEventTable(SAMPLE_IMSI_3, Integer.parseInt(WCDMA_HFA_SOHO_CATEGORY_ID), SAMPLE_TAC_3,
                dateTimeNowMinus27Mins);
    }

    @Test
    public void getTerminalGroupAnalysisSOHOFailure() throws Exception {
