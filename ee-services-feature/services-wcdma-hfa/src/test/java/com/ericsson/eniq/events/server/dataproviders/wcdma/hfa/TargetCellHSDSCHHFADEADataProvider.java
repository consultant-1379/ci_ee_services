 ...
 *
 */
public class TargetCellHSDSCHHFADEADataProvider {

    public static Object[] provideTestData() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                .add(TYPE_PARAM, TYPE_CELL).add(CATEGORY_ID_PARAM, WCDMA_HFA_HSDSCH_CATEGORY_ID)
                .add(CELL_ID_PARAM, "1").add(RAN_VENDOR_PARAM, ERICSSON).add(RNC_FDN_PARAM, "fdn")
