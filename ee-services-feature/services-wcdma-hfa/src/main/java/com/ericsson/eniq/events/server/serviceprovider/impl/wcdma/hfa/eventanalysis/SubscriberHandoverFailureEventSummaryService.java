...
@Stateless
@Local(Service.class)
public class SubscriberHandoverFailureEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_EVENT_SUMMARY + "/" + IMSI;
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(IMSI, EventDataSourceType.AGGREGATED_15MIN, EventDataSourceType.AGGREGATED_DAY);
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (requestParameters.containsKey(GROUP_NAME_PARAM)) {
            ...
            queryParameters.put(IMSI_PARAM_UPPER_CASE,
                    QueryParameter.createLongParameter(Long.parseLong(requestParameters.getFirst(IMSI_PARAM))));
        }
