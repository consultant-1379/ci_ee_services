...
@Stateless
@Local(Service.class)
public class SubscriberHSDSCHFailureRankingService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_RANKING + "/" + TYPE_IMSI;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(CATEGORY_ID_PARAM,
                QueryParameter.createIntParameter(Integer.parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID)));
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(TYPE_IMSI, EventDataSourceType.AGGREGATED_15MIN,
