...
@Stateless
@Local(Service.class)
public class SourceCellHandoverFailureEventSummaryService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_EVENT_SUMMARY + "/" + TYPE_SOURCE_CELL;
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo("HIER3_CELL", EventDataSourceType.AGGREGATED_15MIN,
