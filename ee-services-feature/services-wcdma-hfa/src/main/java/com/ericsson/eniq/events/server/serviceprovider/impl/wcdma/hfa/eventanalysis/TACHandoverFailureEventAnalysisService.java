...
@Stateless
@Local(Service.class)
public class TACHandoverFailureEventAnalysisService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_NETWORK_EVENT_ANALYSIS + "/" + TAC;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (requestParameters.containsKey(NODE_PARAM)) {
            final String[] nodeValues = requestParameters.getFirst(NODE_PARAM).split(DELIMITER);
            queryParameters.put(TAC, getQueryUtils().createQueryParameter(TAC, nodeValues[nodeValues.length - 1]));
