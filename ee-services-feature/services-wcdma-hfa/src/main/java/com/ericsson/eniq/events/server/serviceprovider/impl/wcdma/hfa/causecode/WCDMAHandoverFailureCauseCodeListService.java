...
@Stateless
@Local(Service.class)
public class WCDMAHandoverFailureCauseCodeListService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_CONTROLLER_CAUSE_CODE_LIST;
    }
        ...
        if (requestParameters.containsKey(NODE_PARAM)) {
            ...
            if (node != null) {
                ...
                if (requestParameters.get(TYPE_PARAM).contains(TYPE_BSC)) {
                    final long hashedIdRnc = getQueryUtils().createHashIDForController(allData[2], allData[0],
                            allData[1]);
                    queryParameters.put(HIER3_ID, QueryParameter.createLongParameter(hashedIdRnc));
