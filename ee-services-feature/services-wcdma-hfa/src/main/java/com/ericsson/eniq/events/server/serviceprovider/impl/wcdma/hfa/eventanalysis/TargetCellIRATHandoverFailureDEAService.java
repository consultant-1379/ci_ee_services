...
@Stateless
@Local(Service.class)
public class TargetCellIRATHandoverFailureDEAService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_DETAILED_EVENT_ANALYSIS + "/" + TARGET_CELL + "/" + HFA_IRAT;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (!requestParameters.containsKey(GROUP_NAME_PARAM)) {
            ...
            final String sac = requestParameters.getFirst(CELL_ID_PARAM);
            final long hashedIdForSAC = getQueryUtils().createHashIDForCell(GSM, controller, "", sac, vendor);
            queryParameters.put(THIER321_HASHID, QueryParameter.createLongParameter(hashedIdForSAC));
        }
