...
@Stateless
@Local(Service.class)
public class TerminalGroupAnalysisIFHODrilldownService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_TERMINAL_GROUP_ANALYSIS + "/" + MOST_IFHO_FAILURES;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final QueryParameter categoryIdParam = QueryParameter.createIntParameter(Integer
                .parseInt(WCDMA_HFA_IFHO_CATEGORY_ID));
