...
@Stateless
@Local(Service.class)
public class TerminalAnalysisHSDSCHFailureService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_TERMINAL_ANALYSIS + "/" + MOST_HSDSCH_FAILURES;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final QueryParameter categoryParam = QueryParameter.createIntParameter(Integer
                .parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID));
        params.put(CATEGORY_ID_PARAM, categoryParam);
        return params;
    }
