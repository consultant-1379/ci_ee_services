...
@Stateless
@Local(Service.class)
public class CCCellIRATHandoverFailureDEAService extends GenericService {
    ...
    public String getTemplatePath() {
        return DETAIL_SUB_CAUSE_CODE_GRID + "/" + CELL + "/" + HFA_IRAT;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(WCDMA_HFA_STATE_PARAM, requestParameters.getFirst(WCDMA_HFA_STATE_PARAM));
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (requestParameters.containsKey(NODE_PARAM)) {
            ...
            if (node != null) {
                ...
                if (requestParameters.get(TYPE_PARAM).contains(TYPE_CELL)) {
                    ...
                    final long hashedId2GCell = getQueryUtils().createHashIDForCell(GSM, allData[2], "", allData[0],
                            allData[3]);
                    if (WCDMA_HFA_SOURCE_GROUP_ID.equals(requestParameters.getFirst(WCDMA_HFA_STATE_PARAM))) {
                        queryParameters.put(HIER3_CELL_ID, QueryParameter.createLongParameter(hashedId3GCell));
                    } else if (WCDMA_HFA_TARGET_GROUP_ID.equals(requestParameters.getFirst(WCDMA_HFA_STATE_PARAM))) {
                        queryParameters.put(CELL_SQL_ID, QueryParameter.createLongParameter(hashedId2GCell));
                    } else if (WCDMA_HFA_SOURCE_AND_TARGET_GROUP_ID.equals(requestParameters
                            .getFirst(WCDMA_HFA_STATE_PARAM))) {
                        queryParameters.put(HIER3_CELL_ID, QueryParameter.createLongParameter(hashedId3GCell));
                        queryParameters.put(CELL_SQL_ID, QueryParameter.createLongParameter(hashedId2GCell));
                    }
                }
    ...
    public List<String> getRequiredParametersForQuery() {
        ...
        requiredParameters.add(WCDMA_HFA_STATE_PARAM);
