...
@Stateless
@Local(Service.class)
public class TerminalGroupAnalysisIRATDrilldownService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_TERMINAL_GROUP_ANALYSIS + "/" + MOST_IRAT_FAILURES;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final QueryParameter categoryIdParam = QueryParameter.createIntParameter(Integer
                .parseInt(WCDMA_HFA_IRAT_CATEGORY_ID));
