...
@Stateless
@Local(Service.class)
public class TerminalGroupAnalysisSOHODrilldownService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_TERMINAL_GROUP_ANALYSIS + "/" + MOST_SOHO_FAILURES;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        final QueryParameter categoryIdParam = QueryParameter.createIntParameter(Integer
                .parseInt(WCDMA_HFA_SOHO_CATEGORY_ID));
