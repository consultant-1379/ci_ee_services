...
@Stateless
@Local(Service.class)
public class WCDMAHandoverFailureCauseCodeService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_CONTROLLER_CAUSE_CODE;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        if (requestParameters.containsKey(CAUSE_CODE_LABEL_LIST_SOURCE)) {
            serviceSpecificTemplateParameters.put(CAUSE_CODE_LABEL_LIST_SOURCE,
                    requestParameters.getFirst(CAUSE_CODE_LABEL_LIST_SOURCE));
        }
        if (requestParameters.containsKey(CAUSE_CODE_LABEL_LIST_TARGET)) {
            serviceSpecificTemplateParameters.put(CAUSE_CODE_LABEL_LIST_TARGET,
                    requestParameters.getFirst(CAUSE_CODE_LABEL_LIST_TARGET));
        }
