...
@Stateless
@Local(Service.class)
public class TerminalGroupAnalysisHSDSCHDrilldownService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_TERMINAL_GROUP_ANALYSIS + "/" + MOST_HSDSCH_FAILURES;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
            final MultivaluedMap<String, String> requestParameters) {
        final Map<String, QueryParameter> params = new HashMap<String, QueryParameter>();
        final QueryParameter categoryIdParam = QueryParameter.createIntParameter(Integer
                .parseInt(WCDMA_HFA_HSDSCH_CATEGORY_ID));
        params.put(CATEGORY_ID_PARAM, categoryIdParam);

        if (requestParameters.get(GROUP_NAME_PARAM) != null) {
            params.put(GROUP_NAME_PARAM,
    ...
    public List<String> getRequiredParametersForQuery() {
        return Arrays.asList(TZ_OFFSET);
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(TAC, EventDataSourceType.AGGREGATED_15MIN, EventDataSourceType.AGGREGATED_DAY);
    }
    ...
    public List<String> getApplicableTechPacks(final MultivaluedMap<String, String> requestParameters) {
        return Arrays.asList(EVENT_E_RAN_HFA);
    }
