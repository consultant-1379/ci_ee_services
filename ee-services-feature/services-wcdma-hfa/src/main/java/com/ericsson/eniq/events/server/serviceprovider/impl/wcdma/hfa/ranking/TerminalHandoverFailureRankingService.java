...
@Stateless
@Local(Service.class)
public class TerminalHandoverFailureRankingService extends GenericService {
    ...
    public String getTemplatePath() {
        return WCDMA_HFA_RANKING + "/" + TYPE_TAC;
    }
    ...
    public AggregationTableInfo getAggregationView(final String type) {
        return new AggregationTableInfo(TYPE_TAC, EventDataSourceType.AGGREGATED_15MIN,
