...
import com.ericsson.eniq.events.server.utils.sbr.TCPPerfSummaryProcessor;
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.summary.ITcpPerformanceSummary;
...
@Stateless
@Local(Service.class)
public class SBrowserTcpPerfSumService extends GenericService {
    ...
    public String getTemplatePath() {
        return USER_PLANE + PATH_SEPARATOR + TCP_PERFORMANCE_SUMMARY;
    }
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                ITcpPerformanceSummary.class, new TCPPerfSummaryProcessor());
