...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.summary.IRadioConditionsVisitedCellsSummary;
...
@Stateless
@Local(Service.class)
public class SBrowserVisitedCellsSumService extends GenericService {
    /* (non-Javadoc)
     * @see com.ericsson.eniq.events.server.serviceprovider.impl.GenericServiceInterface#getTemplatePath()
     */
    @Override
    public String getTemplatePath() {
        return SESSION_SUMMARY + PATH_SEPARATOR + VISITED_CELLS;
    }
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IRadioConditionsVisitedCellsSummary.class, null);
