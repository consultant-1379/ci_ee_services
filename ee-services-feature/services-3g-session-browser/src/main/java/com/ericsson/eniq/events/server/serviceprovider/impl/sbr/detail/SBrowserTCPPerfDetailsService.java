...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.details.ITcpPerformanceDetails;
...
@Stateless
@Local(Service.class)
public class SBrowserTCPPerfDetailsService extends GenericService {
    ...
    public String getTemplatePath() {
        return USER_PLANE + PATH_SEPARATOR + TCP_PERFORMANCE_DETAILS;
    }
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                ITcpPerformanceDetails.class, null);
