...
@Stateless
@Local(Service.class)
public class SBrowserRncUkpiDrillService extends GenericService {

    private String drillType;

    private final static String START_HIER3_ID = "START_HIER3_ID";
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (StringUtils.isNotBlank(node)) {
            ...
            queryParameters.put(START_HIER3_ID, QueryParameter.createLongParameter(hashedIdForController));
        }
