...
@Stateless
@Local(Service.class)
public class SBrowserNetworkUkpiDrillService extends GenericService {

    private String drillType;

    @Override
    public String getTemplatePath() {
        return USER_PLANE + PATH_SEPARATOR + KPI_CHART + PATH_SEPARATOR + KPI_DRILL + PATH_SEPARATOR + NETWORK;
    }
    ...
    public List<String> getRequiredParametersForQuery() {
        ...
        requiredParameters.add(DRILLTYPE_PARAM);
