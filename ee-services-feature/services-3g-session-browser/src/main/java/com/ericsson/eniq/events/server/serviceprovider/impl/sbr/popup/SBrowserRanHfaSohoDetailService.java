...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.popup.IHfaSohoPopupDetails;
...
@Stateless
@Local(Service.class)
public class SBrowserRanHfaSohoDetailService extends GenericService {
    ...
    public String getTemplatePath() {
        return POPUP_DETAIL + PATH_SEPARATOR + RAN_HFA + PATH_SEPARATOR + SOHO;
    }
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IHfaSohoPopupDetails.class, new GenericDetailsPopupProcessor(IHfaSohoPopupDetails.class, tzOffset));
