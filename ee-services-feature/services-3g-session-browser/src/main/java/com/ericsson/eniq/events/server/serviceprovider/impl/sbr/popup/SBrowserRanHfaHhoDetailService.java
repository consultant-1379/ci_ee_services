...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.popup.IHhoPopupDetails;
...
@Stateless
@Local(Service.class)
public class SBrowserRanHfaHhoDetailService extends GenericService {
    ...
    public String getTemplatePath() {
        return POPUP_DETAIL + PATH_SEPARATOR + RAN_HFA + PATH_SEPARATOR + HHO;
    }
    ...
    public List<String> getMeasurementTypes() {
        ...
        measurementTypes.add(INTER_OUT_HHO);
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IHhoPopupDetails.class, new GenericDetailsPopupProcessor(IHhoPopupDetails.class, tzOffset));
