...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.popup.IHfaHSDSCHSuccessPopupDetails;
...
@Stateless
@Local(Service.class)
public class SBrowserSucHsdschDetailService extends GenericService {
    ...
    public String getTemplatePath() {
        return POPUP_DETAIL + PATH_SEPARATOR + HSDSCH + PATH_SEPARATOR + SUC;
    }
    ...
    public List<String> getMeasurementTypes() {
        ...
        measurementTypes.add(SUC_HSDSCH_CELL_CHANGE);
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IHfaHSDSCHSuccessPopupDetails.class, new GenericDetailsPopupProcessor(
                        IHfaHSDSCHSuccessPopupDetails.class, tzOffset));
