...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.popup.IHfaIfhoPopupDetails;
...
@Stateless
@Local(Service.class)
public class SBrowserRanHfaIfhoDetailService extends GenericService {
    ...
    public String getTemplatePath() {
        return POPUP_DETAIL + PATH_SEPARATOR + RAN_HFA + PATH_SEPARATOR + IFHO;
    }
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IHfaIfhoPopupDetails.class, new GenericDetailsPopupProcessor(IHfaIfhoPopupDetails.class, tzOffset));
