...
import com.ericsson.eniq.events.server.utils.sbr.StartEndIdsResultSetTransformer;
...
@Stateless
@Local(Service.class)
public class SBrowserRabDetailService extends GenericService {
    ...
    public String getTemplatePath() {
        return SESSION_DETAIL + PATH_SEPARATOR + RAB;
    }
    ...
    public List<String> getApplicableTechPacks(final MultivaluedMap<String, String> requestParameters) {
        ...
        techPackList.add(EVENT_E_CORE_SESSION);
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new StartEndIdsResultSetTransformer(timeStampFrom, timeStampTo,
                tzOffset, IDataBearerSessionEventData.class, null);
