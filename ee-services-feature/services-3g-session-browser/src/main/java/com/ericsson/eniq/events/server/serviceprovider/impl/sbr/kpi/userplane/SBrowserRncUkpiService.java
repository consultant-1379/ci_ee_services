...
import com.ericsson.eniq.events.ui.shared.model.kpianalysis.IUserPlaneChartKpiResult;
...
@Stateless
@Local(Service.class)
public class SBrowserRncUkpiService extends GenericService {
    ...
    public String getTemplatePath() {
        return USER_PLANE + PATH_SEPARATOR + KPI_CHART;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        if (StringUtils.isNotBlank(node)) {
            ...
            final long hashedIdForController = getQueryUtils().createHashIDForController(allData[2], allData[0],
                    allData[1]);
    ...
    public List<String> getApplicableTechPacks(final MultivaluedMap<String, String> requestParameters) {
        final String[] techPacksPerRequestType = new String[] { EVENT_E_USER_PLANE };
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IUserPlaneChartKpiResult.class, null);
