...
import com.ericsson.eniq.events.server.utils.sbr.ApplicationLayerDetailsProcessor;
...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.details.IApplicationLayerDetails;
...
@Stateless
@Local(Service.class)
public class SBrowserAppLayerDetailsService extends GenericService {
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(
        ...
        serviceSpecificTemplateParameters.put(INTERVAL_PARAM, "1");
    ...
    public String getTemplatePath() {
        return USER_PLANE + PATH_SEPARATOR + APPLICATION_LAYER_DETAILS;
    }
    ...
    public List<String> getMeasurementTypes() {
        ...
        measurementTypes.add(APPLICATION_LAYER_PERF);
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IApplicationLayerDetails.class, new ApplicationLayerDetailsProcessor());
