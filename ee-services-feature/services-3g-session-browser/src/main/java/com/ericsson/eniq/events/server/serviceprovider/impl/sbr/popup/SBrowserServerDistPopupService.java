...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.popup.IServerDistribution;
...
public class SBrowserServerDistPopupService extends GenericService {
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IServerDistribution.class, null);
