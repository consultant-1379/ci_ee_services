...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.summary.IApplicationLayerSummary;
...
@Stateless
@Local(Service.class)
public class SBrowserAppLayerSumService extends GenericService {
    /* (non-Javadoc)
    ...
    public String getTemplatePath() {
        return USER_PLANE + PATH_SEPARATOR + APPLICATION_LAYER_SUMMARY;
    }
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IApplicationLayerSummary.class, null);
