...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.popup.IHfaIRatPopupDetails;
...
@Stateless
@Local(Service.class)
public class SBrowserRanHfaIratDetailService extends GenericService {
    ...
    public String getTemplatePath() {
        return POPUP_DETAIL + PATH_SEPARATOR + RAN_HFA + PATH_SEPARATOR + IRAT;
    }
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IHfaIRatPopupDetails.class, new GenericDetailsPopupProcessor(IHfaIRatPopupDetails.class, tzOffset));
