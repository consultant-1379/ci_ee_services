...
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.details.IRadioCellConditionsEventData;
import com.sun.jersey.core.util.MultivaluedMapImpl;

/** 
 * Session Browser Radio and Cell Condition detail services
 * @author ehaoswa
 * @since 2012
 *
 */
@Stateless
@Local(Service.class)
public class SBrowserRccDetailService extends GenericService {
    ...
    public String getTemplatePath() {
        return SESSION_DETAIL + PATH_SEPARATOR + RADIO_AND_CELL_CONDITION;
    }
    ...
    public List<Integer> getTimeColumnIndices() {
        ...
        public String runQuery(final String query, final String requestId,
            ...
            final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                    IRadioCellConditionsEventData.class, null);
