...
import com.ericsson.eniq.events.server.utils.sbr.RrcMeasurementReportDetailsPopupProcessor;
import com.ericsson.eniq.events.server.utils.sbr.SbrowserUtil;
import com.ericsson.eniq.events.ui.shared.model.sessionbrowser.popup.IRRCMeasurementReportPopupDetails;
...
@Stateless
@Local(Service.class)
public class SBrowserRrcPopupDetailService extends GenericService {
    ...
    public String getTemplatePath() {
        return POPUP_DETAIL + PATH_SEPARATOR + RRC_MEAS;
    }
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(
        ...
        queryParameters.put(ADDITIONAL_EVENT_ID,
                QueryParameter.createIntParameter(Integer.parseInt(requestParameters.getFirst(ADDITIONAL_EVENT_ID))));
    ...
    public String runQuery(final String query, final String requestId,
        ...
        final JsonResultSetTransformer transformer = new JsonResultSetTransformer(timeStampFrom, timeStampTo, tzOffset,
                IRRCMeasurementReportPopupDetails.class, new RrcMeasurementReportDetailsPopupProcessor(
                        IRRCMeasurementReportPopupDetails.class, tzOffset));
