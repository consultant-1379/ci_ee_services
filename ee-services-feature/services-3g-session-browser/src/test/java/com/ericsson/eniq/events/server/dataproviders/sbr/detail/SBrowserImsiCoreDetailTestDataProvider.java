 ...
 *
 */
public class SBrowserImsiCoreDetailTestDataProvider {
...
//        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
        ...
        //data on 926 for EVENT_E_SGEH_ERR_RAW table
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(IMSI_PARAM, "454063899810676").build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());

        //data on 1127 for EVENT_E_SGEH_ERR_RAW table
//        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
//                .add(TIME_FROM_QUERY_PARAM, "0000").add(TIME_TO_QUERY_PARAM, "0000")
//                .add(DATE_FROM_QUERY_PARAM, "14062012").add(DATE_TO_QUERY_PARAM, "16062012").add(TZ_OFFSET, "+0100")
//                .add(IMSI_PARAM, "460000000163724").build();
//        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
