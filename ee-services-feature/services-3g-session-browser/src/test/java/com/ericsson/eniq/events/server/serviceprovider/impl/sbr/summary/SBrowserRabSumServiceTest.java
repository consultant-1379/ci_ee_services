...
public class SBrowserRabSumServiceTest extends ServiceBaseTest {
    @Resource(name = "sessionBrowserRabSumService")
    ...
    public void testSessionRabImsiDetail(final MultivaluedMap<String, String> requestParameters) {
        runQuery(requestParameters, sBrowserRabSumService);
    }
}
