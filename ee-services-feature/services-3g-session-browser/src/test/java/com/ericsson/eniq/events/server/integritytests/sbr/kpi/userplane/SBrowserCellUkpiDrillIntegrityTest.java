...
import com.ericsson.eniq.events.server.serviceprovider.impl.sbr.kpi.userplane.SBrowserCellUkpiDrillService;
...
public class SBrowserCellUkpiDrillIntegrityTest extends BaseDataIntegrityTest {
    ...
    public void setUp() throws Exception {
        sBrowserCellUkpiDrillService = new SBrowserCellUkpiDrillService();
        attachDependencies(sBrowserCellUkpiDrillService);
        createDimTables();
        createTableSchema();
        populateTestData();
    }
    ...
    @Test
    public void testSBrowserCellUkpiDrill_ECNO() throws Exception {
        ...
        requestParameters.putSingle(NODE_PARAM, "13021,,smartone_R:RNC10:RNC10,Ericsson,3G");
        requestParameters.putSingle(TYPE_PARAM, TYPE_CELL);

        final String json = runQuery(sBrowserCellUkpiDrillService, requestParameters);
        ...
        insertRow(TEMP_EVENT_E_USER_PLANE_TCP_RAW, new HashMap<String, Object>() {
            {
                ...
                put("THROUGHPUT", 794);
                put("HIER321_ID", 5696952213025519142L);
        ...
        insertRow(TEMP_EVENT_E_RAN_SESSION_RAW, new HashMap<String, Object>() {
            {
                ...
                put("ECNO_AVG", -23.5);
                put("RSCP_AVG", 1);
                put("START_HIER321_ID", 5696952213025519142L);
    ...
    private void createTableSchema() throws Exception {
        final List<ColumnDetails> ranTable = new ArrayList<ColumnDetails>() {
            {
                add(new ColumnDetails("START_HIER321_ID", "unsigned bigint", Nullable.CAN_BE_NULL));
