...
public class SBrowserTCPPerfDetailsServiceTest extends ServiceBaseTest {
    @Resource(name = "sessionBrowserTCPPerfDetailsService")
    ...
    public void testSessionRabImsiDetail(final MultivaluedMap<String, String> requestParameters) {
        runQuery(requestParameters, sBrowserTCPPerfDetailsService);
    }
