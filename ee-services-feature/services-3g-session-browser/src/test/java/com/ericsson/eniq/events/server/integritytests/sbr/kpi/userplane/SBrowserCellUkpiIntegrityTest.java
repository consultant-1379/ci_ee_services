...
import com.ericsson.eniq.events.server.serviceprovider.impl.sbr.kpi.userplane.SBrowserCellUkpiService;
...
public class SBrowserCellUkpiIntegrityTest extends BaseDataIntegrityTest {
    ...
    public void setUp() throws Exception {
        sbrowserCellUkpiService = new SBrowserCellUkpiService();
        attachDependencies(sbrowserCellUkpiService);
    ...
    @Test
    public void testSBrowserCellUkpi() throws Exception {
        ...
        final String json = runQuery(sbrowserCellUkpiService, requestParameters);
