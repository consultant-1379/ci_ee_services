...
public class SBrowserCoreKpiMapServiceIntegrityTest extends BaseDataIntegrityTest {

    private static final String TEMP_EVENT_E_SGEH_ERR_RAW = "#EVENT_E_SGEH_ERR_RAW";

    private static final String TEMP_EVENT_E_SGEH_VEND_HIER321_EVENTID_SUC_15MIN = "#EVENT_E_SGEH_VEND_HIER321_EVENTID_SUC_15MIN";
    ...
    @Test
    public void testNetworkRncData() throws Exception {
        ...
        assertEquals("0.0", kpis.getString("PDP Context Activation Success Rate"));
    ...
    @SuppressWarnings("unchecked")
    @Test
    public void testSingleCellData() throws Exception {
        final MultivaluedMap<String, String> requestParameters = new MultivaluedMapImpl();
        requestParameters.putSingle(TIME_FROM_QUERY_PARAM, "2254");
        requestParameters.putSingle(TIME_TO_QUERY_PARAM, "2302");
        ...
        requestParameters.putSingle(NODE_PARAM, "12151,,RNC01,Ericsson,3G");
        ...
        final JSONObject jsonResult = new JSONObject(json);
        final JSONObject data = jsonResult.getJSONObject("data");
        final JSONObject cellData = data.getJSONObject("12151");
        final JSONObject kpis = cellData.getJSONObject("kpis");

        // CELL
        assertEquals("RNC01", cellData.getString("rncName"));
        assertEquals("1", cellData.getString("rat"));
        assertEquals("ERICSSON", cellData.getString("vendor"));
        assertEquals("TESTCELL", cellData.getString("cellName"));
        // KPI's
        assertEquals("-", kpis.getString("Service Request Failure Ratio"));
        assertEquals("-", kpis.getString("Paging Failure Ratio"));
        assertEquals("-", kpis.getString("RAU Success Rate"));
    ...
    private void populateSgehTestData() throws SQLException {
        ...
        insertRow(TEMP_EVENT_E_SGEH_VEND_HIER321_EVENTID_SUC_15MIN, new HashMap<String, Object>() {
            {
    ...
    private void createDimTableSchema() throws SQLException {
        ...
        final List<ColumnDetails> hier321CellTableSchema = new ArrayList<ColumnDetails>() {
            {
        ...
        createTemporaryTable(TEMP_DIM_E_SGEH_HIER321_CELL, hier321CellTableSchema);
    }
    ...
    private void createSgehTableSchema() throws SQLException {
        ...
        final List<ColumnDetails> succTableSchemaHier321 = new ArrayList<ColumnDetails>() {
            {
                add(new ColumnDetails("HIERARCHY_3", "varchar (127)", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("HIERARCHY_2", "varchar", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("HIERARCHY_1", "varchar (127)", Nullable.CAN_BE_NULL));
        ...
        final List<ColumnDetails> succTableSchemaHier3 = new ArrayList<ColumnDetails>() {
            {
                add(new ColumnDetails("HIERARCHY_3", "varchar (127)", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("HIERARCHY_2", "varchar", Nullable.CAN_BE_NULL));
                add(new ColumnDetails("HIERARCHY_1", "varchar (127)", Nullable.CAN_BE_NULL));
        ...
        createTemporaryTable(TEMP_EVENT_E_SGEH_VEND_HIER321_EVENTID_SUC_15MIN, succTableSchemaHier321);
        createTemporaryTable(TEMP_EVENT_E_SGEH_VEND_HIER3_EVENTID_SUC_15MIN, succTableSchemaHier3);
    }
}
