...
import com.ericsson.eniq.events.server.serviceprovider.impl.sbr.kpi.userplane.SBrowserRncUkpiService;
...
public class SBrowserRncUkpiIntegrityTest extends BaseDataIntegrityTest {
    ...
    public void setUp() throws Exception {
        sBrowserRncUkpiService = new SBrowserRncUkpiService();
        attachDependencies(sBrowserRncUkpiService);
    ...
    @Test
    public void testSBrowserRncUkpi() throws Exception {
        ...
        final String json = runQuery(sBrowserRncUkpiService, requestParameters);
