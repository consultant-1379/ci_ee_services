...
public class SBrowserNetworkUserKpiDrillTestDataProvider {
    ...
    public static Object[] provideTestData() {
        ...
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>()
                ...
                .add(KPI_END_TIME, String.valueOf(new Date().getTime() - 1000000))
                .add(DRILLTYPE_PARAM, SBrowserUserPlaneKpiDrillTypes.getDrillTypes())
