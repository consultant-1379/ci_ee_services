...
import com.ericsson.eniq.events.server.serviceprovider.impl.sbr.kpi.userplane.SBrowserNetworkUkpiDrillService;
...
public class SBrowserNwkUkpiDrillIntegrityTest extends BaseDataIntegrityTest {
    ...
    private SBrowserNetworkUkpiDrillService sBrowserNetworkUkpiDrillService;

    @Before
    public void setUp() throws Exception {
        sBrowserNetworkUkpiDrillService = new SBrowserNetworkUkpiDrillService();
        attachDependencies(sBrowserNetworkUkpiDrillService);
        createDimTables();
        createTableSchema();
        populateTestData();
    }
    ...
    @Test
    public void testSBrowserNwkUkpiDrill_ECNO() throws Exception {
        ...
        final String json = runQuery(sBrowserNetworkUkpiDrillService, requestParameters);
