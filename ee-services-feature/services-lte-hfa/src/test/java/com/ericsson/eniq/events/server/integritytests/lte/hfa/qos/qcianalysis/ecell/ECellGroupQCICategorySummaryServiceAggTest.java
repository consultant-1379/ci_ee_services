...
public class ECellGroupQCICategorySummaryServiceAggTest extends
   ...
   EcellQCICategorySummaryService lteHFAECellQCICategarySummaryService;
    ...
    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_1, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_2, 2, dateTimeID,
                aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_PREP, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC, TEST_VALUE_QCI_ID_3, 2, dateTimeID,
                aggTable);
    }
