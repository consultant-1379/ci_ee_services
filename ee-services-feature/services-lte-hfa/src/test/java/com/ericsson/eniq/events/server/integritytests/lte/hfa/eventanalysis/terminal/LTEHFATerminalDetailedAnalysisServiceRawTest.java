 ...
 *
 */
public class LTEHFATerminalDetailedAnalysisServiceRawTest extends
        BaseDataIntegrityTest<LTEHFATerminalDetailedAnalysisSetupResult> {
    ...
    //private static final String TEST_VALUE_THIER3_ID_2 = "3135210477467174911";
    ...
    private void insertLookupData(final String tac, final String manufacturer, final String marketingName)
            throws SQLException {
        final Map<String, Object> valuesForTable = new HashMap<String, Object>();
    ...
    private String getJsonResult(final String eventId) {
        ...
        requestParameters.putSingle(TAC_PARAM, TEST_VALUE_TAC_1);
    ...
    public void testENodeBAnalysisDetailedPrepX2InEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_PREP_X2_IN_HFA, Integer.parseInt(TEST_VALUE_TAC_1),
                DATETIME_ID_RAW, 2);
        ...
        final List<LTEHFATerminalDetailedAnalysisSetupResult> eventResult = rt.translateResult(json,
                LTEHFATerminalDetailedAnalysisSetupResult.class);
    ...
    public void testTerminalAnalysisDetailedPrepX2OutEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, Integer.parseInt(TEST_VALUE_TAC_1),
                DATETIME_ID_RAW, 2);
    ...
    public void testTerminalAnalysisDetailedExecX2InEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, Integer.parseInt(TEST_VALUE_TAC_1),
                DATETIME_ID_RAW, 2);
    ...
    public void testETerminalAnalysisDetailedExecX2OutEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, Integer.parseInt(TEST_VALUE_TAC_1),
                DATETIME_ID_RAW, 2);
    ...
    public void testTerminalAnalysisDetailedPrepS1InEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_PREP_S1_IN_HFA, Integer.parseInt(TEST_VALUE_TAC_1),
                DATETIME_ID_RAW, 2);
    ...
    public void testTerminalAnalysisDetailedPrepS1OutEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, Integer.parseInt(TEST_VALUE_TAC_1),
                DATETIME_ID_RAW, 2);
    ...
    public void testTerminalBAnalysisDetailedExecS1InEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, Integer.parseInt(TEST_VALUE_TAC_1),
                DATETIME_ID_RAW, 2);
    ...
    public void testTerminalBAnalysisDetailedExecS1OutEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, Integer.parseInt(TEST_VALUE_TAC_1),
                DATETIME_ID_RAW, 2);
    ...
    public void testTerminalAnalysisDetailedPrepX2InEvent_RawGrp() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_PREP_X2_IN_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_HO_PREP_X2_IN_HFA, Integer.parseInt(TEST_VALUE_TAC_2),
                DATETIME_ID_RAW, 1);
    ...
    public void testTerminalAnalysisDetailedPrepX2OutEvent_RawGrp() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, Integer.parseInt(TEST_VALUE_TAC_2),
                DATETIME_ID_RAW, 1);
    ...
    public void testTerminalAnalysisDetailedExecX2InEvent_RawGrp() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, Integer.parseInt(TEST_VALUE_TAC_2),
                DATETIME_ID_RAW, 1);
    ...
    public void testTerminalAnalysisDetailedExecX2OutEvent_RawGrp() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, Integer.parseInt(TEST_VALUE_TAC_2),
                DATETIME_ID_RAW, 1);
    ...
    public void testTerminalAnalysisDetailedPrepS1InEvent_RawGrp() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_PREP_S1_IN_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_HO_PREP_S1_IN_HFA, Integer.parseInt(TEST_VALUE_TAC_2),
                DATETIME_ID_RAW, 1);
    ...
    public void testTerminalAnalysisDetailedPrepS1OutEvent_RawGrp() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, Integer.parseInt(TEST_VALUE_TAC_2),
                DATETIME_ID_RAW, 1);
    ...
    public void testTerminalAnalysisDetailedExecS1InEvent_RawGrp() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, Integer.parseInt(TEST_VALUE_TAC_2),
                DATETIME_ID_RAW, 1);
    ...
    public void testTerminalAnalysisDetailedExecS1OutEvent_RawGrp() throws Exception {
        ...
        insertData(TEST_VALUE_HIER3_ID_1, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 1);
        insertData(TEST_VALUE_HIER3_ID_2, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, Integer.parseInt(TEST_VALUE_TAC_2),
                DATETIME_ID_RAW, 1);
