...
public class LTEHFATerminalTacRankingServiceAggTest extends BaseDataIntegrityTest<LTEHFATerminalRankingResult> {
    ...
    private void assertResult(final List<LTEHFATerminalRankingResult> rankingResult) {
        ...
        assertThat("worstSubscriber should have exactly 9 Drop Calls events!", worstSubscriber.getFailures(), is(9));
        ...
        assertThat("nextWorstSubscriber should have exactly 4 Drop Calls events!", nextWorstSubscriber.getFailures(),
                is(4));
    ...
    private void createTables() throws Exception {
        ...
        columnsForEETable.add(NO_OF_ERRORS_AGG);
        createTemporaryTable(TEMP_EVENT_E_LTE_HFA_TAC_EVENTID_ERR_15MIN, columnsForEETable);
