 ...
 *
 */
public class LTEHandoverFailureEcellCCPieChartServiceRawTest extends
        BaseDataIntegrityTest<LTEHandoverFailureCCPieChartResult> {
    ...
    public void testEcellCauseCodePieChartSummary() throws Exception {
        ...
        final List<LTEHandoverFailureCCPieChartResult> eventResult = rt.translateResult(json,
                LTEHandoverFailureCCPieChartResult.class);
