 ...
 *
 */
public class LTEHFAEnodeBGroupEventHandoverStageServiceAggTest extends
    ...
    private void insertAggDataDay() throws Exception {
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_DAY, TEST_VALUE_HIER3_ID_1,
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_DAY, TEST_VALUE_HIER3_ID_2,
                INTERNAL_PROC_HO_PREP_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_DAY, TEST_VALUE_HIER3_ID_2,
                INTERNAL_PROC_HO_PREP_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_DAY_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_DAY, TEST_VALUE_HIER3_ID_2,
    ...
    private void insertAggData15Min() throws Exception {
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_15MIN, TEST_VALUE_HIER3_ID_1,
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_15MIN, TEST_VALUE_HIER3_ID_2,
                INTERNAL_PROC_HO_PREP_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_15MIN, TEST_VALUE_HIER3_ID_2,
                INTERNAL_PROC_HO_PREP_X2_OUT_HFA, EventIDConstants.CATEGORY_ID_2_PREP, DATETIME_ID_15MIN_1, 1, 20);
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_15MIN, TEST_VALUE_HIER3_ID_2,
    ...
    /* @Test
     public void testEnodeBGroupEventSummaryDayRankingDrillDown() throws Exception {
         insertAggDataDay();
         final String json = getJsonResultDay(true);
         final ResultTranslator<LTEHandoverFailureEnodeBGroupEventHandoverStageResultRaw> rt = getTranslator();
         final List<LTEHandoverFailureEnodeBGroupEventHandoverStageResultRaw> eventResult = rt.translateResult(json,
                 LTEHandoverFailureEnodeBGroupEventHandoverStageResultRaw.class);
         assertResultDay(eventResult);
     }

     @Test
     public void testEnodeBGroupEventSummary15minRankingDrillDown() throws Exception {
         insertAggData15Min();
