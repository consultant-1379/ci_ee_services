 ...
 *
 */
public class LTEHFAEventHandoverStageServiceRawTest extends
        BaseDataIntegrityTest<LTEHandoverFailureEventHandoverStageResultRaw> {
    ...
    public void testSubscriberEventHandoverStageSummary() throws Exception {
        ...
        /*insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP, SAMPLE_TAC, DATETIME_ID_RAW, 
                EventIDConstants.PREPARATION_CATEGORY_ID_2_DESC, 2);
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_IN_HFA, EventIDConstants.CATEGORY_ID_2_PREP, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), DATETIME_ID_RAW, 
                EventIDConstants.PREPARATION_CATEGORY_ID_2_DESC, 2);*/
    ...
    private void assertResult(final List<LTEHandoverFailureEventHandoverStageResultRaw> results) {
