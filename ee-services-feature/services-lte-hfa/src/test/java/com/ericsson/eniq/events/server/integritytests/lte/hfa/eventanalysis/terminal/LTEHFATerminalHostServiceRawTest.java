...
public class LTEHFATerminalHostServiceRawTest extends BaseDataIntegrityTest<LTEHFATerminalHostResultRaw> {
    ...
    private String getJsonResult() throws URISyntaxException {
        ...
        requestParameters.putSingle(NODE_PARAM, "Sony Ericsson E16i," + TEST_VALUE_TAC);
    ...
    public void testTerminalHostSummary() throws Exception {
        ...
        final List<LTEHFATerminalHostResultRaw> eventResult = rt.translateResult(json,
                LTEHFATerminalHostResultRaw.class);
