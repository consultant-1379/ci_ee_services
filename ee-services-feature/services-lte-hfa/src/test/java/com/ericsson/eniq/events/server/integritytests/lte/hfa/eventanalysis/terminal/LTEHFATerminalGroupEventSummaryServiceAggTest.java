 ...
 *
 */
public class LTEHFATerminalGroupEventSummaryServiceAggTest extends
    ...
    private String getJsonResult(final String dateFrom, final String dateTo, final String categoryId) throws URISyntaxException {
   ...
   private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTestWithEventID(INTERNAL_PROC_HO_PREP_X2_IN_HFA, CATEGORY_ID_2_PREP, 2, dateTimeID,
                aggTable);
        insertDataForAggTestWithEventID(INTERNAL_PROC_HO_PREP_X2_OUT_HFA, CATEGORY_ID_2_PREP, 2,
                dateTimeID, aggTable);
        insertDataForAggTestWithEventID(INTERNAL_PROC_HO_PREP_S1_IN_HFA, CATEGORY_ID_2_PREP, 2,
                dateTimeID, aggTable);
        insertDataForAggTestWithEventID(INTERNAL_PROC_HO_PREP_S1_OUT_HFA, CATEGORY_ID_2_PREP, 2, dateTimeID,
                aggTable);
        insertDataForAggTestWithEventID(INTERNAL_PROC_HO_EXEC_X2_IN_HFA, CATEGORY_ID_2_EXEC, 2, dateTimeID,
                aggTable);
        insertDataForAggTestWithEventID(INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, CATEGORY_ID_2_EXEC, 2, dateTimeID,
                aggTable);
        insertDataForAggTestWithEventID(INTERNAL_PROC_HO_EXEC_S1_IN_HFA, CATEGORY_ID_2_EXEC, 2, dateTimeID,
                aggTable);
        insertDataForAggTestWithEventID(INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, CATEGORY_ID_2_EXEC, 2, dateTimeID,
                aggTable);
    }
