 ...
 *
 */
public class LTEHFAEnodeBEventHandoverStageServiceAggTest extends
    ...
    private void insertAggDataDay() throws Exception {
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_DAY, TEST_VALUE_HIER3_ID,
    ...
    private void insertAggData15Min() throws Exception {
        ...
        insertDataAgg(TEMP_EVENT_E_LTE_HFA_HIER3_EVENTID_ERR_15MIN, TEST_VALUE_HIER3_ID,
    ...
    /*@Test
    public void testEnodeBEventSummaryDayRankingDrillDown() throws Exception {
        insertAggDataDay();
        final String json = getJsonResultDay(true);
        final ResultTranslator<LTEHandoverFailureEnodeBEventHandoverStageResultRaw> rt = getTranslator();
        final List<LTEHandoverFailureEnodeBEventHandoverStageResultRaw> eventResult = rt.translateResult(json,
                LTEHandoverFailureEnodeBEventHandoverStageResultRaw.class);
        assertResultDay(eventResult);
    }

    @Test
    public void testEnodeBEventSummary15minRankingDrillDown() throws Exception {
        insertAggData15Min();
