 ...
 *
 */
public class LTEHFAENodeBGroupQCIEventSummaryServiceAggTest extends
    ...
    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_2_PREP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_2_EXEC, EventIDConstants.INTERNAL_PROC_ERAB_SETUP,
                2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_1, CATEGORY_ID_2_EXEC,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_2_PREP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_2_EXEC, EventIDConstants.INTERNAL_PROC_ERAB_SETUP,
                2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER3_ID_2, CATEGORY_ID_2_EXEC,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);
    }
