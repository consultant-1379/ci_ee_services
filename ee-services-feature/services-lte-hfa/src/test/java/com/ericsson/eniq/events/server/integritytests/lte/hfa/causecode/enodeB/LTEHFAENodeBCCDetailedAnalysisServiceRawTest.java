 ...
 *
 */
public class LTEHFAENodeBCCDetailedAnalysisServiceRawTest extends
        BaseDataIntegrityTest<LTEHFAEnodeBDetailedAnalysisCCSetupResult> {
    ...
    public void testENodeBAnalysisDetailedPrepX2InEvent_Raw() throws Exception {
        ...
        final List<LTEHFAEnodeBDetailedAnalysisCCSetupResult> eventResult = rt.translateResult(json,
                LTEHFAEnodeBDetailedAnalysisCCSetupResult.class);
