 ...
 *
 */
public class LTEHFASubscriberPrepRankingServiceRawTest extends
        BaseDataIntegrityTest<LTEHandoverFailureSubscriberPrepRankingSetupResult> {
    ...
    public void testSubscriberPrepRanking_Raw() throws Exception {
        ...
        final String json = getJsonResult(LTE_HFA_PREP_CATEGORY_ID);
