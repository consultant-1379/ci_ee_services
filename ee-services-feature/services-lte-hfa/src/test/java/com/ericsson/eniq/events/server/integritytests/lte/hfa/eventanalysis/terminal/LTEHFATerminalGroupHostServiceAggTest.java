 ...
 *
 */
public class LTEHFATerminalGroupHostServiceAggTest extends
        BaseDataIntegrityTest<LTEHFATerminalHostResultRawGroup> {
    ...
    public void testTerminalHostSummary15MinAgg() throws Exception {
        ...
        final List<LTEHFATerminalHostResultRawGroup> eventResult = rt.translateResult(json,
                LTEHFATerminalHostResultRawGroup.class);
