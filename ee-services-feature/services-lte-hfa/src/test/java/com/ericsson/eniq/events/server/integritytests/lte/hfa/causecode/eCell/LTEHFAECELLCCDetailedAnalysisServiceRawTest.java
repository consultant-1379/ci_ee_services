 ...
 *
 */
public class LTEHFAECELLCCDetailedAnalysisServiceRawTest extends
        BaseDataIntegrityTest<LTEHFAECellDetailedAnalysisCCSetupResult> {
    ...
    public void testECELLAnalysisDetailedPrepX2InEvent_Raw() throws Exception {
        ...
        final List<LTEHFAECellDetailedAnalysisCCSetupResult> eventResult = rt.translateResult(json,
                LTEHFAECellDetailedAnalysisCCSetupResult.class);
