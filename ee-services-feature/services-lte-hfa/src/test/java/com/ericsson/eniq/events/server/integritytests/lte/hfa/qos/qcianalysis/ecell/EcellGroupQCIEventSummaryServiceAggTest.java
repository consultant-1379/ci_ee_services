 ...
 *
 */
public class EcellGroupQCIEventSummaryServiceAggTest extends
    ...
    private void insertData(final long hier321ID, final int tac, final int categoryID, final String eventID,
    ...
    private void insertAggData(final String aggTable, final long hier321ID, final int categoryID, final String eventID,
    ...
    private void insertDataForAggTest(final long hier321ID, final int categoryID, final String eventID,
        ...
        insertData(hier321ID, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC), categoryID, eventID, dateTimeID, instances,
                TEST_VALUE_IMSI_1);
    ...
    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_PREP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC, EventIDConstants.INTERNAL_PROC_ERAB_SETUP,
                2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_1, CATEGORY_ID_2_EXEC,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);

        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_PREP,
                EventIDConstants.INTERNAL_PROC_UE_CTXT_RELEASE, 2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC, EventIDConstants.INTERNAL_PROC_ERAB_SETUP,
                2, dateTimeID, aggTable);
        insertDataForAggTest(TEST_VALUE_HIER321_ID_2, CATEGORY_ID_2_EXEC,
                EventIDConstants.INTERNAL_PROC_INITIAL_CTXT_SETUP, 2, dateTimeID, aggTable);
    }
