 ...
 *
 */
public class LTEHandoverFailureECellCCSummaryServiceRawTest extends
        BaseDataIntegrityTest<LTEHandoverFailureECellCCSummaryResultRaw> {
    ...
    @Test
    public void testECellCCSummary() throws Exception {
        final String json = getJsonResult();
        final ResultTranslator<LTEHandoverFailureECellCCSummaryResultRaw> rt = getTranslator();
        final List<LTEHandoverFailureECellCCSummaryResultRaw> eventResult = rt.translateResult(json,
                LTEHandoverFailureECellCCSummaryResultRaw.class);
