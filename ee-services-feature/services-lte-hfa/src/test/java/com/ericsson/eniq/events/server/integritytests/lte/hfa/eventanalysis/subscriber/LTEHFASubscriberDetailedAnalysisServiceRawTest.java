 ...
 *
 */
public class LTEHFASubscriberDetailedAnalysisServiceRawTest extends
        BaseDataIntegrityTest<LTEHandoverFailureSubscriberDetailedAnalysisSetupResult> {
    ...
    public void testSubscriberAnalysisDetailedPrepX2InEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_IN_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    public void testSubscriberAnalysisDetailedPrepX2OutEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_X2_OUT_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    public void testSubscriberAnalysisDetailedExecX2InEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_IN_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    public void testSubscriberAnalysisDetailedExecX2OutEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    public void testSubscriberAnalysisDetailedPrepS1InEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_IN_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    public void testSubscriberAnalysisDetailedPrepS1OutEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_PREP_S1_OUT_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    public void testSubscriberAnalysisDetailedExecS1InEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_IN_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    public void testSubscriberAnalysisDetailedExecS1OutEvent_Raw() throws Exception {
        ...
        insertData(TEST_VALUE_IMSI_1, INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, Integer.parseInt(TEST_VALUE_EXCLUSIVE_TAC),
                DATETIME_ID_RAW, 2);
    ...
    private void assertResult(final List<LTEHandoverFailureSubscriberDetailedAnalysisSetupResult> results,
