 ...
 *
 */
public class LTEHFAENodeBDetailedAnalysisServiceRawTest extends
        BaseDataIntegrityTest<LTEHFAEnodeBDetailedAnalysisSetupResult> {
    ...
    public void testENodeBAnalysisDetailedPrepX2InEvent_Raw() throws Exception {
        ...
        final List<LTEHFAEnodeBDetailedAnalysisSetupResult> eventResult = rt.translateResult(json,
                LTEHFAEnodeBDetailedAnalysisSetupResult.class);
