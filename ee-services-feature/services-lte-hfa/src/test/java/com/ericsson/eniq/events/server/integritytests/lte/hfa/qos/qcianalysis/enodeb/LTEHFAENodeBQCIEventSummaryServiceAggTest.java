 ...
 *
 */
public class LTEHFAENodeBQCIEventSummaryServiceAggTest extends
    ...
    private void insertAggData(final String aggTable, final String dateTimeID) throws Exception {
        insertDataForAggTestWithEventID(CATEGORY_ID_2_PREP, EventIDConstants.INTERNAL_PROC_HO_PREP_X2_OUT_HFA, 2,
                dateTimeID, aggTable);
        insertDataForAggTestWithEventID(CATEGORY_ID_2_EXEC, EventIDConstants.INTERNAL_PROC_HO_EXEC_X2_IN_HFA, 2,
                dateTimeID, aggTable);
        insertDataForAggTestWithEventID(CATEGORY_ID_2_EXEC, EventIDConstants.INTERNAL_PROC_HO_EXEC_X2_OUT_HFA, 2,
                dateTimeID, aggTable);
        insertDataForAggTestWithEventID(CATEGORY_ID_2_PREP, EventIDConstants.INTERNAL_PROC_HO_PREP_S1_OUT_HFA, 2,
                dateTimeID, aggTable);
        insertDataForAggTestWithEventID(CATEGORY_ID_2_EXEC, EventIDConstants.INTERNAL_PROC_HO_EXEC_S1_IN_HFA, 2,
                dateTimeID, aggTable);
        insertDataForAggTestWithEventID(CATEGORY_ID_2_EXEC, EventIDConstants.INTERNAL_PROC_HO_EXEC_S1_OUT_HFA, 2,
                dateTimeID, aggTable);
    }
    ...
    public void testENodeBQCIEventSummary15MinAggPrep() throws Exception {
        ...
        final List<LTEHFAQOSENodeBQCIEventSummaryResult> eventResult = rt.translateResult(json,
