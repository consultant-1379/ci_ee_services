 ...
 *
 */
public class TerminalFailedEventAnalysisResult implements QueryResult {
    ...
    public void parseJSONObject(final JSONObject object) throws JSONException {
        ...
        crnc_id_serv_hsdsch_cell = object.getString(INDEX_OF_TWENTIETH_COLUMN_IN_JSON_RESULT);
        c_id_serv_hsdsch_cell = object.getString(INDEX_OF_TWENTY_FIRST_COLUMN_IN_JSON_RESULT);
