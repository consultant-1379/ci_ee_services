 ...
 *
 */
public class LTEHandoverFailureSubscriberDetailedAnalysisSetupResult implements QueryResult {
    ...
    private void parseJSONObjectExecS1Out(final JSONObject jsonObject) throws JSONException {
        ...
        mcc = jsonObject.getString(INDEX_OF_NINETEENTH_COLUMN_IN_JSON_RESULT);
        mnc = jsonObject.getString(INDEX_OF_TWENTIETH_COLUMN_IN_JSON_RESULT);
