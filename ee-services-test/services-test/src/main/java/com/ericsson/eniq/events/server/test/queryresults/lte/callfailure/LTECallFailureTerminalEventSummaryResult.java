 ...
 *
 */
public class LTECallFailureTerminalEventSummaryResult implements QueryResult {
    ...
    public void parseJSONObject(final JSONObject object) throws JSONException {
        tac = object.getString(INDEX_OF_FIRST_COLUMN_IN_JSON_RESULT);
        ...
        eventID = object.getString(INDEX_OF_FIFTH_COLUMN_IN_JSON_RESULT);
