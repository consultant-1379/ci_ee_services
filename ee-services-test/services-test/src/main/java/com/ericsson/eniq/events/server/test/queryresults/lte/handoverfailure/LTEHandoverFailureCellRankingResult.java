...
public class LTEHandoverFailureCellRankingResult implements QueryResult {
    ...
    public void parseJSONObject(final JSONObject jsonObject) throws JSONException {
        ...
        cell = jsonObject.getString(INDEX_OF_SIXTH_COLUMN_IN_JSON_RESULT);
        failures = jsonObject.getInt(INDEX_OF_SEVENTH_COLUMN_IN_JSON_RESULT);
        ratDesc = jsonObject.getString(INDEX_OF_EIGHTH_COLUMN_IN_JSON_RESULT);
