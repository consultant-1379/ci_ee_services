 ...
 *
 */
public class GSMCallFailureControllerSubCauseCodeAnalysisResult implements QueryResult {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof GSMCallFailureControllerSubCauseCodeAnalysisResult)) {
            return false;
        }
        final GSMCallFailureControllerSubCauseCodeAnalysisResult other = (GSMCallFailureControllerSubCauseCodeAnalysisResult) obj;
