 ...
 *
 */
public class CallFailureCauseCodeDEAResult implements QueryResult {
    ...
    public void parseJSONObject(final JSONObject object) throws JSONException {
        ...
        accessArea = object.getString(INDEX_OF_SIXTH_COLUMN_IN_JSON_RESULT);
        eventType = object.getString(INDEX_OF_SEVENTH_COLUMN_IN_JSON_RESULT);
        procedureIndicator = object.getString(INDEX_OF_EIGHTH_COLUMN_IN_JSON_RESULT);
        evaluationCase = object.getString(INDEX_OF_NINTH_COLUMN_IN_JSON_RESULT);
        exceptionClass = object.getString(INDEX_OF_TENTH_COLUMN_IN_JSON_RESULT);
        lac = object.getInt(INDEX_OF_ELEVENTH_COLUMN_IN_JSON_RESULT);
        rac = object.getInt(INDEX_OF_TWELFTH_COLUMN_IN_JSON_RESULT);
        vendor = object.getString(INDEX_OF_THIRTEENTH_COLUMN_IN_JSON_RESULT);
    }
