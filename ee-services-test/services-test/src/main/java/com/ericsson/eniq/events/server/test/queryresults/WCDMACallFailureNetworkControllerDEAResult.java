 ...
 *
 */
public class WCDMACallFailureNetworkControllerDEAResult implements QueryResult {
    ...
    public void parseJSONObject(final JSONObject object) throws JSONException {
        ...
        source_conf = object.getString(INDEX_OF_NINETEENTH_COLUMN_IN_JSON_RESULT);
        cpich_ec_no_cell_1 = object.getDouble(INDEX_OF_TWENTIETH_COLUMN_IN_JSON_RESULT);
        ul_int_cell1 = object.getDouble(INDEX_OF_TWENTY_FIRST_COLUMN_IN_JSON_RESULT);
        rscp_cell_1 = object.getDouble(INDEX_OF_TWENTY_SECOND_COLUMN_IN_JSON_RESULT);
        target_conf = object.getString(INDEX_OF_TWENTY_THIRD_COLUMN_IN_JSON_RESULT);
        crnc_id_serv_hsdsch_cell = object.getString(INDEX_OF_TWENTY_FOURTH_COLUMN_IN_JSON_RESULT);
        c_id_serv_hsdsch_cell = object.getString(INDEX_OF_TWENTY_FIFTH_COLUMN_IN_JSON_RESULT);
        rscp_cell_2 = object.getDouble(INDEX_OF_TWENTY_SIXTH_COLUMN_IN_JSON_RESULT);
        rscp_cell_3 = object.getDouble(INDEX_OF_TWENTY_SEVENTH_COLUMN_IN_JSON_RESULT);
        rscp_cell_4 = object.getDouble(INDEX_OF_TWENTY_EIGHT_COLUMN_IN_JSON_RESULT);
        cpich_ec_no_cell_2 = object.getDouble(INDEX_OF_TWENTY_NINTH_COLUMN_IN_JSON_RESULT);
        cpich_ec_no_cell_3 = object.getDouble(INDEX_OF_THIRTIETH_COLUMN_IN_JSON_RESULT);
        cpich_ec_no_cell_4 = object.getDouble(INDEX_OF_THIRTY_FIRST_COLUMN_IN_JSON_RESULT);
        ul_int_cell2 = object.getDouble(INDEX_OF_THIRTY_SECOND_COLUMN_IN_JSON_RESULT);
        ul_int_cell3 = object.getDouble(INDEX_OF_THIRTY_THIRD_COLUMN_IN_JSON_RESULT);
        ul_int_cell4 = object.getDouble(INDEX_OF_THIRTY_FOURTH_COLUMN_IN_JSON_RESULT);
        scrambling_code_cell_1 = object.getInt(INDEX_OF_THIRTY_FIFTH_COLUMN_IN_JSON_RESULT);
        scrambling_code_cell_2 = object.getInt(INDEX_OF_THIRTY_SIXTH_COLUMN_IN_JSON_RESULT);
        scrambling_code_cell_3 = object.getInt(INDEX_OF_THIRTY_SEVENTH_COLUMN_IN_JSON_RESULT);
        scrambling_code_cell_4 = object.getInt(INDEX_OF_THIRTY_EIGHT_COLUMN_IN_JSON_RESULT);
        gbr_ul = object.getInt(INDEX_OF_THIRTY_NINTH_COLUMN_IN_JSON_RESULT);
        gbr_dl = object.getInt(INDEX_OF_FOURTIETH_COLUMN_IN_JSON_RESULT);
        utran_ranap_cause = object.getString(INDEX_OF_FOURTY_FIRST_COLUMN_IN_JSON_RESULT);
        data_in_dl_rlc_buffers = object.getInt(INDEX_OF_FOURTY_SECOND_COLUMN_IN_JSON_RESULT);
