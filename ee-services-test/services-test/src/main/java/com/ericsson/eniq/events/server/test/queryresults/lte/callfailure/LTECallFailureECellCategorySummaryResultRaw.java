...
public class LTECallFailureECellCategorySummaryResultRaw implements QueryResult {
    ...
    public void parseJSONObject(final JSONObject jsonObject) throws JSONException {
        ...
        eCell = jsonObject.getString(INDEX_OF_FIFTH_COLUMN_IN_JSON_RESULT);
        categoryType = jsonObject.getString(INDEX_OF_SIXTH_COLUMN_IN_JSON_RESULT);
