 ...
 *
 */
public class GSMCallSetupFailureCountryRoamingDetailQueryResult implements QueryResult {
    ...
    public void parseJSONObject(final JSONObject object) throws JSONException {
        ...
        afcause = object.getString(INDEX_OF_EIGHTEENTH_COLUMN_IN_JSON_RESULT);
        channel = object.getString(INDEX_OF_NINETEENTH_COLUMN_IN_JSON_RESULT);
        vamos = object.getString(INDEX_OF_TWENTIETH_COLUMN_IN_JSON_RESULT);
        rsai = object.getString(INDEX_OF_TWENTY_FIRST_COLUMN_IN_JSON_RESULT);
