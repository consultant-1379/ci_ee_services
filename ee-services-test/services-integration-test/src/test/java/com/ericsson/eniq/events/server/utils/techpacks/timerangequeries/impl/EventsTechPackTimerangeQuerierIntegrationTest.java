...
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_GSN_DTPDP_RAW;
import static com.ericsson.eniq.events.server.common.TechPackData.EVENT_E_GSN_DT_RAW;
...
public class EventsTechPackTimerangeQuerierIntegrationTest extends DataServiceBaseTestCase {
    ...
    static {
        ...
        volumeBasedViews.add(EVENT_E_GSN_DTPDP_RAW);
        volumeBasedViews.add(EVENT_E_GSN_DT_RAW);

        timeBasedViews.add(DC_Z_ALARM_INFO_RAW);
    }

    /* (non-Javadoc)
     * @see com.ericsson.eniq.events.server.services.impl.DataServiceBeanIntegrationTest#onSetUp()
     */
    @Override
    ...
    public void testQueryVolumeBasedViewsForRawTableNames() {
        ...
        final FormattedDateTimeRange dateTimeRange = DateTimeRange.getDailyAggregationTimeRangebyLocalTime(ONE_WEEK, 0,
                0, 0);
