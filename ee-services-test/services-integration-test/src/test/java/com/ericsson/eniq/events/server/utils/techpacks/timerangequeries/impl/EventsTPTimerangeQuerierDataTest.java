...
/**
 * Class to test the SQL queries in the from end to end.
 * Class does not extend the usual BaseDataIntegrityTest or BaseServiceIntegrationTest as it is not testing a service
 *
 * @author eemecoy
 */
...
public class EventsTPTimerangeQuerierDataTest {
    ...
    private void populateRawTables(final String view, final String minDate, final String maxDate,
            final Connection connection, final List<String> rawTableNames) throws SQLException {
    ...
    public void testGetRawTablesForTimerange() throws Exception {
        ...
        populateRawTables(EVENT_E_LTE_ERR_RAW, DateTimeUtilities.getDateTimeMinus36Hours(),
                DateTimeUtilities.getDateTimeMinus25Minutes(), connection, rawTables);
    ...
    public void testGetLatestRawTables_EVENT_E_LTE_RAW() throws Exception {
        ...
        populateRawTables(EVENT_E_LTE_RAW, DateTimeUtilities.getDateTimeMinus36Hours(),
                DateTimeUtilities.getDateTimeMinus48Hours(), connection, rawTablesForOlderTimeRange);
        ...
        populateRawTables(EVENT_E_LTE_RAW, DateTimeUtilities.getDateTimeMinus25Minutes(),
                DateTimeUtilities.getDateTimeMinus30Minutes(), connection, rawTablesForLatestSucTimeRange);
        ...
        populateRawTables(EVENT_E_LTE_RAW, DateTimeUtilities.getDateTimeMinus55Minutes(),
                DateTimeUtilities.getDateTimeMinus55Minutes(), connection, rawTablesForLatestErrTimeRange);
    ...
    @Test
    public void testGetLatestRawTables_EVENT_E_GSN_DT_RAW() throws Exception {
        final Connection connection = setUpInterceptedDbConnectionManager();
        createRawTables(EVENT_E_GSN_DT_RAW, connection);
        final List<String> rawTablesForOlderTimeRange = new ArrayList<String>();
        rawTablesForOlderTimeRange.add("EVENT_E_GSN_DT_RAW_01");
        rawTablesForOlderTimeRange.add("EVENT_E_GSN_DT_RAW_01");
        populateRawTables(EVENT_E_GSN_DT_RAW, DateTimeUtilities.getDateTimeMinus36Hours(),
                DateTimeUtilities.getDateTimeMinus48Hours(), connection, rawTablesForOlderTimeRange);
        ...
        populateRawTables(EVENT_E_GSN_DT_RAW, DateTimeUtilities.getDateTimeMinus25Minutes(),
                DateTimeUtilities.getDateTimeMinus30Minutes(), connection, rawTablesForLatestTimeRange);
        final List<String> result = timerangeQuerier.getLatestTablesUsingQuery(EVENT_E_GSN_DT_RAW);
    ...
    public void testGetLatestRawTables_EVENT_E_SGEH_ERR_RAW() throws Exception {
        ...
        populateRawTables(EVENT_E_SGEH_ERR_RAW, DateTimeUtilities.getDateTimeMinus36Hours(),
                DateTimeUtilities.getDateTimeMinus48Hours(), connection, rawTablesForOlderTimeRange);
        final List<String> rawTablesForLatestTimeRange = new ArrayList<String>();
        rawTablesForLatestTimeRange.add("EVENT_E_SGEH_ERR_RAW_01");
        rawTablesForLatestTimeRange.add("EVENT_E_SGEH_ERR_RAW_02");
        populateRawTables(EVENT_E_SGEH_ERR_RAW, DateTimeUtilities.getDateTimeMinus25Minutes(),
                DateTimeUtilities.getDateTimeMinus30Minutes(), connection, rawTablesForLatestTimeRange);
    ...
    public void testGetLatestRawTables_EVENT_E_RAN_CFA_RAW() throws Exception {
        ...
        populateRawTables(EVENT_E_RAN_CFA_RAW, DateTimeUtilities.getDateTimeMinus36Hours(),
                DateTimeUtilities.getDateTimeMinus25Minutes(), connection, rawTablesForOlderTimeRange);
    ...
    public void testGetRawTables_DC_Z_ALARM_INFO_RAW() throws Exception {
        ...
        final String rawTable = "DC_Z_ALARM_INFO_RAW";
        final FormattedDateTimeRange dateTimeRange = DateTimeRange.getFormattedDateTimeRangeWithOutOffset(
                DateTimeUtilities.getDateTimeMinusDay(7), DateTimeUtilities.getDateTimeMinus35Minutes());
