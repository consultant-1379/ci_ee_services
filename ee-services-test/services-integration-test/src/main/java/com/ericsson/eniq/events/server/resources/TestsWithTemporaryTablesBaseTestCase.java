...
public class TestsWithTemporaryTablesBaseTestCase<T extends QueryResult> extends BaseDataIntegrityTest {
    ...
    protected String runGetDataQuery(final BaseResource baseResource,
            final MultivaluedMap<String, String> requestParameters) throws URISyntaxException {
    ...
    public void createTemporaryTableOnSpecificConnection(final Connection conn, final String table,
    ...
    protected void createTemporaryTableOnSpecificConnection(final Connection conn, final String tableName,
            final Map<String, String> columns) throws SQLException {
    ...
    /**
     * @param rmiEngineUtils the rmiEngineUtils to set
     */
