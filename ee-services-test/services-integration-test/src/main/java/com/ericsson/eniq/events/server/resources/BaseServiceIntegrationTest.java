...
/**
 * Base class for tests for the Service class implementations
 * This class will populate the dependencies for the Service class.
 *
 * @author eemecoy
 * 
 * 15/08/2011
 * @author ehaoswa
 * Updated with Spring 3 integration test framework
 */
...
public class BaseServiceIntegrationTest {
     ...
     *
     * @param servicePerformanceTraceLogger the servicePerformanceTraceLogger to set
     */
     ...
     *
     * @param queryUtils the new query utils
     */
     ...
     * @param displayParameter the display parameter
     */
     ...
     * @return the string
     */
    protected String runQueryAndAssertJsonSucceeds(final MultivaluedMap<String, String> requestParameters,
     ...
     *
     * @param techPackListFactory the new tech pack list factory
     */
     ...
     *
     * @param mediaTypeHandler the new media type handler
     */
     ...
     *
     * @param templateUtils the new template utils
     */
     ...
     *
     * @param csvResponseBuilder the new csv response builder
     */
     ...
     *
     * @param streamingDataService the new streaming data service
     */
